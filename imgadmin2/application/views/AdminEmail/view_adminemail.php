...
<section class="page-form-ele page">
   ...
   <section class="panel panel-default">
        ...
        <div class="space"></div>
            ...
            <a class="file-input-wrapper btn btn-default  btn-success" href="<?= base_url('adminemail/add_adminemail') ?>"><i class="fa fa-plus-circle"></i> Add Admin Email</a>
   ...
   <div class="row">
        ...
        <span class="glyphicon glyphicon-th"></span> View Admin Email</strong></div>
           ...
           <?php  
              ...
              ?>
                        <tr>
                            ...
                            <td>
                          <a href="<?= base_url('adminemail/edit_adminemail/'.$result['id']);?>">
                         <button type="button" value="" class="btn btn-info">Edit</button></a>
                         <a onClick="return confirm('Are you sure want to delete this entry.')" href="<?= base_url('adminemail/delete_adminemail/'.$result['id']);?>">
...
var table = 'admin_email';

$.ajax({
url:"<?= base_url('AdminEmail/mail_status'); ?>",
data:{
vopll:id,
table:table,
value:value
