...
<section class="page-form-ele page">
   ...
   <section class="panel panel-default">
        ...
        <div class="space"></div>
            ...
            <a class="file-input-wrapper btn btn-default  btn-success" href="<?= base_url('tagcloud/add_tagcloud') ?>"><i class="fa fa-plus-circle"></i> Add Tagcloud</a>
   ...
   <div class="row">
        ...
        <span class="glyphicon glyphicon-th"></span> View Tagcloud</strong></div>
                        ...
                        <tr>
                          <td><?php echo $s_no;?></td>
                           ...
                           <td> 
                            ...
                            <td>
                          <a href="<?= base_url('tagcloud/edit_tagcloud/'.$result['id']);?>">
                         <button type="button" value="" class="btn btn-info">Edit</button></a>
                         <a onClick="return confirm('Are you sure want to delete this entry.')" href="<?= base_url('tagcloud/delete_tagcloud/'.$result['id']);?>">
...
$.ajax({
url:"<?= base_url('tagcloud/tagcloud_status'); ?>",
data:{
vopll:id,
table:table,
value:value
