...
<section class="page-form-ele page">
   ...
   <section class="panel panel-default">
        ...
        <div class="space"></div>
            ...
            <a class="file-input-wrapper btn btn-default  btn-success" href="<?= base_url('footer/add_footerurl') ?>"><i class="fa fa-plus-circle"></i> Add Footer Url</a>
   ...
   <div class="row">
        ...
        <span class="glyphicon glyphicon-th"></span> View Footer Url</strong></div>
           ...
           <?php  
              ...
              ?>
                        <tr>
                            ...
                            <td>
                          <a href="<?= base_url('footer/edit_footerurl/'.$result['id']);?>">
                         <button type="button" value="" class="btn btn-info">Edit</button></a>
                         <a onClick="return confirm('Are you sure want to delete this entry.')" href="<?= base_url('footer/delete_footerurl/'.$result['id']);?>">
...
$.ajax({
url:"<?= base_url('footer/change_statusurl'); ?>",
data:{
vopll:id,
table:table,
value:value
