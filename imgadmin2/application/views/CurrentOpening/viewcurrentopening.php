...
<section class="page-form-ele page">
   ...
   <section class="panel panel-default">
        ...
        <div class="space"></div>
            ...
            <a class="file-input-wrapper btn btn-default  btn-success" href="<?= base_url('currentopening/addcurrentopening') ?>"><i class="fa fa-plus-circle"></i> Add Current Opening</a>
   ...
   <div class="row">
        ...
        <span class="glyphicon glyphicon-th"></span> View Current Opening</strong></div>
              ...
              ?>
                        <tr>
                            <td><?php echo $s_no;?></td>
                             ...
                             <td><?= $result['experiance']?></td>
                             <td><?= $result['qualification']?></td>
							 <td><?= $result['serial']?></td>
                             <td>
                              <img src="<?= base_url('images/currentopening/') ?><?= $result['image']; ?>" style ="width:100px" >
                            </td>
                            <td> 
                                <label class="switch">
                            ...
                            <td>
                          <a href="<?= base_url('currentopening/editcurrentopening/'.$result['id']);?>">
                         <button type="button" value="" class="btn btn-info">Edit</button></a>
                         <a onClick="return confirm('Are you sure want to delete this entry.')" href="<?= base_url('currentopening/deletecurrentopening/'.$result['id']);?>">
...
var table = 'current_opening';

$.ajax({
url:"<?= base_url('CurrentOpening/statuschange'); ?>",
data:{
vopll:id,
table:table,
value:value
