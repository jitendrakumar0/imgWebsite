...
<div class="row">
         ...
         <div class="col-lg-12">
            ...
            <section class="panel panel-default">
				...
				<span class="glyphicon glyphicon-th"></span>Add Image Link</strong></div>
                ...
                <div class="panel-body">
					...
					<div class="errorsinci">
					  ...
					  <form action="<?= base_url('blog/imagelinksubmit'); ?>" method="post" enctype="multipart/form-data">
            
        <div class="form-group">
            <label for="exampleInputEmail1">Image</label>
            <input type="file" name="userfile[]" multiple class="form-control" required placeholder="Image">
          </div>
