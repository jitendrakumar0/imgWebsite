...
<div class="row">
         ...
         <div class="col-lg-12">
            ...
            <section class="panel panel-default">
                ...
                <span class="glyphicon glyphicon-th"></span> Add Amount</strong></div>
                ...
                <div class="panel-body">
                    ...
                    <div class="errorsinci">
                     ...
                     <form action="<?= base_url('tax/taxsubmit');?>" method="post" enctype="multipart/form-data" name="f3" id="f3">
          <div class="form-group">
            <label for="exampleInputEmail1">Amount <span style="color:red" >*</span></label>
            <input type="text" required name="amount" placeholder="Amount*" value="" class="form-control"/>
          </div>

          <div class="form-group">
            <label for="exampleInputEmail1">Project Name <span style="color:red" >*</span></label>
