...
<section class="page-form-ele page">
   ...
   <section class="panel panel-default">
        ...
        <div class="space"></div>
            ...
            <a class="file-input-wrapper btn btn-default  btn-success" href="<?= base_url('webtype/add_webtype') ?>"><i class="fa fa-plus-circle"></i> Add Website Type</a>
   ...
   <div class="row">
        ...
        <span class="glyphicon glyphicon-th"></span> View Website Type</strong></div>
              ...
              ?>
                        <tr>
                            <td><?php echo $s_no;?></td>
                             ...
                             <td><?= $result['type']?></td>                            
                             <td>
                              <img src="<?= base_url('images/website/') ?><?= $result['image']; ?>" style ="width:100px" >
                            </td>
                            <td> 
                                <label class="switch">
                            ...
                            <td>
                          <a href="<?= base_url('webtype/edit_webtype/'.$result['id']);?>">
                         <button type="button" value="" class="btn btn-info">Edit</button></a>
                         <a onClick="return confirm('Are you sure want to delete this entry.')" href="<?= base_url('webtype/delete_webtype/'.$result['id']);?>">
...
var table = 'website_type';

$.ajax({
url:"<?= base_url('webtype/change_status'); ?>",
data:{
vopll:id,
table:table,
value:value
