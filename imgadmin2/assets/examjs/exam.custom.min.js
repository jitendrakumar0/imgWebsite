...
function checkAnswer(quesNo) {
    ...
    if (quesType == "M") {
		if ($('div[name=post_req-' + quesNo + '] input[name="option'+quesNo+'"]').is(":checked") || $('div[name=post_req-' + quesNo + '] input[name="option'+quesNo+'[]"]').is(":checked")) {
            return true;
        }
        else {
            return false;
...
function resetAnswer(quesNo) {
    var quesType = $('#questype' + quesNo).text();
    if (quesType == "M") {
		$('form[name=post_req-' + quesNo + '] input[name="option0"]').prop('checked', false);
        $('form[name=post_req-' + quesNo + '] input[name="option0[]"]').prop('checked', false);
    }
