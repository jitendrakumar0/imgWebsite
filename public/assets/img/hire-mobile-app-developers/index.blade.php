            ...
            <div class="col-md-12">
               <nav aria-label="breadcrumb">
                  <ol class="breadcrumb mb-0">
                     ...
                     <li class="breadcrumb-item active fw-600 fs-lg-16 fs-md-15 fs-14 text-dark" aria-current="page">Hire Android App Developers </li>
                  </ol>
               </nav>
            </div>
         </div>
               ...
               <div class="col-lg-5 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-center">
                        <div class="col-lg-10 col-md-5 col-12 position-relative leftside">
                           <img class="w-100 position-relative" src="{{GETFOLDERPATH()}}/hire-android-developer.webp" alt="Hire Android App Programmers with Years of Experience">
                        </div>
                     </div>
                  </div>
                <div class="col-lg-7">
                           ...
                           <div class="container">
                              <div class="row align-items-lg-end align-items-md-center justify-content-lg-end justify-content-md-center">
                                 <div class="col-xl-6 col-lg-6 col-md-12 ps-lg-5 ps-md-0">
                                    ...
                                    <div class="col-12 fw-900 fs-lg-32 fs-md-38 fs-sm-22 fs-22 text-white text-lg-start text-center ">Key Benefits of Hiring Android Developer</div>
                          ...
                          <div class="col-lg-12 col-md-12 col-12 p-0">
                              <div class="row fantasy-cricket-sldier owl-carousel">     
                                 <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-lg-0 mb-md-3 mb-3">
                                    <div class="box bg-white p-lg-3 p-md-3 p-3 h-100">
                                       <div class="col-12 text-lg-start mb-2">
                                          <img class="w-lg-25 w-md-30 w-20 position-relative" src="{{GETFOLDERPATH()}}/ios.webp" alt="Hire iOS Developer">
                                        </div>
                                 ...
                                 {{-- <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-lg-0 mb-md-3 mb-3">
                                    <div class="box bg-white p-lg-3 p-md-3 p-3 h-100">
                                       <div class="col-12 text-lg-start mb-2">
                                          <img class="w-lg-24 w-md-30 w-20 position-relative" src="{{GETFOLDERPATH()}}/android.webp" alt="Hire Android Developer">
                                        </div>
                                 ...
                                 <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-lg-0 mb-md-3 mb-3">
                                    <div class="box bg-white p-lg-3 p-md-3 p-3 h-100">
                                       <div class="col-12 text-lg-start mb-2">
                                          <img class="w-lg-26 w-md-30 w-20 position-relative" src="{{GETFOLDERPATH()}}/node-js.webp" alt="Hire Node.JS Developer">
                                        </div>
                                 ...
                                 {{-- <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-lg-0 mb-md-3 mb-3">
                                    <div class="box bg-white p-lg-3 p-md-3 p-3 h-100">
                                       <div class="col-12 text-lg-start mb-2">
                                          <img class="w-lg-25 w-md-30 w-20 position-relative" src="{{GETFOLDERPATH()}}/larval.webp" alt="Hire Laravel Developer">
                                        </div>
                                          <div class="col-12 fw-900 fs-lg-20 fs-md-19 fs-19 my-lg-3 my-md-3 my-1 text-capitalize text-laravel"> Hire Laravel Developer </div>
                                          <div class="col-lg-12 col-md-12 col-12">
                                            <a href="{{ asset('/') }}" class="fs-lg-17 fs-md-17 fs-14 fw-bold text-decoration-none text-laravel">
                                               <span class="text-black">See More <i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i></span>
                                          </a>
                                      </div>
                                    </div>
                                 ...
                                 <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-lg-0 mb-md-3 mb-3">
                                    <div class="box bg-white p-lg-3 p-md-3 p-3 h-100">
                                       <div class="col-12 text-lg-start mb-2">
                                          <img class="w-lg-25 w-md-30 w-20 position-relative" src="{{GETFOLDERPATH()}}/react-native.webp" alt="Hire React Native Developer">
                                        </div>
                                 ...
                                 <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-lg-0 mb-md-3 mb-3">
                                    <div class="box bg-white p-lg-3 p-md-3 p-3 h-100">
                                       <div class="col-12 text-lg-start mb-2">
                                          <img class="w-lg-24 w-md-30 w-20 position-relative" src="{{GETFOLDERPATH()}}/flutter.webp" alt="Hire Flutter Developer">
                                        </div>
                                 ...
                                 <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-lg-0 mb-md-3 mb-3">
                                    <div class="box bg-white p-lg-3 p-md-3 p-3 h-100">
                                       <div class="col-12 text-lg-start mb-2">
                                          <img class="w-lg-23 w-md-30 w-20 position-relative" src="{{GETFOLDERPATH()}}/react.webp" alt="Hire React.JS Developer">
                                        </div>
                                 ...
                                 <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-lg-0 mb-md-3 mb-3">
                                    <div class="box bg-white p-lg-3 p-md-3 p-3 h-100">
                                       <div class="col-12 text-lg-start mb-2">
                                          <img class="w-lg-25 w-md-30 w-20 position-relative" src="{{GETFOLDERPATH()}}/java.webp" alt="Hire Java Developer">
                                        </div>
                                 ...
                                 <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-lg-0 mb-md-3 mb-3">
                                    <div class="box bg-white p-lg-3 p-md-3 p-3 h-100">
                                       <div class="col-12 text-lg-start mb-2">
                                          <img class="w-lg-25 w-md-30 w-20 position-relative" src="{{GETFOLDERPATH()}}/php.webp" alt="Hire php Developer">
                                        </div>
                                 ...
                                 <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-lg-0 mb-md-3 mb-3">
                                    <div class="box bg-white p-lg-3 p-md-3 p-3 h-100">
                                       <div class="col-12 text-lg-start mb-2">
                                          <img class="w-lg-25 w-md-30 w-20 position-relative" src="{{GETFOLDERPATH()}}/webdesign.webp" alt="Hire Web Designer">
                                        </div>
                                 ...
                                 <div class="col-lg-12 col-md-12 col-sm-12 col-12 mb-lg-0 mb-md-3 mb-3">
                                    <div class="box bg-white p-lg-3 p-md-3 p-3 h-100">
                                       <div class="col-12 text-lg-start mb-2">
                                          <img class="w-lg-25 w-md-30 w-20 position-relative" src="{{GETFOLDERPATH()}}/angular.webp" alt="Hire Angular Developer">
                                        </div>
