            ...
            <div class="col-md-12">
               <nav aria-label="breadcrumb">
                  <ol class="breadcrumb mb-0">
                     ...
                     <li class="breadcrumb-item"><a class="fw-600 fs-lg-16 fs-md-15 fs-14 text-theme2 text-decoration-none" href="{{asset('/fantasy-football-app-development.php')}}">Fantasy Football App Development </a></li>
                     <li class="breadcrumb-item active fw-600 fs-lg-16 fs-md-15 fs-14 text-dark" aria-current="page">Fantasy Football</li>
                  </ol>
               </nav>
            </div>
         </div>
   ...
   <div class="container-fluid overflow-hidden why-choose-cms position-relative">
      <div class="container py-5 position-relative zi-2">
         <div class="row mx-0 pb-5">
            ...
            <div class="col-12 fw-600 fs-md-16 fs-sm-15 fs-14 text-muted mt-md-3 mt-4 justify text-center">Football without any doubt is the biggest earning game of the century. Now it’s time to take your share of the pie with the largest developers in the town, We join the online football league and play against your friends and strangers and earn from it. The players get a chance to be a manger for the best and top players in the football world and compete against each other in the online battle of Football Fantasy. We have years of experience to back them up in enduring such projects.
            </div>
            <div class="col-12 fw-600 fs-md-16 fs-sm-15 fs-14 text-muted mt-md-3 mt-4 justify text-center">The software and platforms developed by us automatically takes care of the following things:
            </div>
         </div>
         <div class="row justify-content-center">
            <div class="col-md-9">
                  ...
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        ...
                        <div class="col-12 p-2 fw-bold border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class="pb-2 mx-auto" src="{{GETFOLDERPATH()}}/Scoring-and-Points.webp" width="auto" height="58" alt="Scoring and Points"> <span class="fs-md-16 fs-sm-15 fs-14 fw-bold">Scoring and Points</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        ...
                        <div class="col-12 p-2 fw-bold border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class="pb-2 h-50px mx-auto" src="{{GETFOLDERPATH()}}/Points-Table.webp" width="auto" height="58" alt="Points Table"> <span class="fs-md-16 fs-sm-15 fs-14 fw-bold">Points Table</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        ...
                        <div class="col-12 p-2 fw-bold border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class="pb-2 h-50px mx-auto" src="{{GETFOLDERPATH()}}/Ranking.webp" width="auto" height="58" width="100" height="auto" alt="Ranking"> <span class="fs-md-16 fs-sm-15 fs-14 fw-bold">Ranking</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        ...
                        <div class="col-12 p-2 fw-bold border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class="pb-2 h-50px mx-auto" src="{{GETFOLDERPATH()}}/Player-Cards.webp" width="auto" height="58" alt="Player Cards"> <span class="fs-md-16 fs-sm-15 fs-14 fw-bold">Player Cards</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        ...
                        <div class="col-12 p-2 fw-bold border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class="pb-2 h-50px mx-auto" src="{{GETFOLDERPATH()}}/Match-Reports.webp" width="auto" height="58" alt="Tie / Draw management"> <span class="fs-md-16 fs-sm-15 fs-14 fw-bold">Tie / Draw management</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        ...
                        <div class="col-12 p-2 fw-bold border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class="pb-2 h-50px mx-auto" src="{{GETFOLDERPATH()}}/Winner-declaration.webp" width="auto" height="58" alt="Winner declaration"> <span class="fs-md-16 fs-sm-15 fs-14 fw-bold">Winner declaration</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        ...
                        <div class="col-12 p-2 fw-bold border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class="pb-2 h-50px mx-auto" src="{{GETFOLDERPATH()}}/Payments-to-the-wallets.webp" width="auto" height="58" alt="Payments to the wallets"> <span class="fs-md-16 fs-sm-15 fs-14 fw-bold">Payments to the wallets</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        ...
                        <div class="col-12 p-2 fw-bold border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class="pb-2 h-50px mx-auto" src="{{GETFOLDERPATH()}}/User-Reports.webp" width="auto" height="58" alt="User Reports"> <span class="fs-md-16 fs-sm-15 fs-14 fw-bold">User Reports</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        ...
                        <div class="col-12 p-2 fw-bold border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class="pb-2 h-50px mx-auto" src="{{GETFOLDERPATH()}}/Game-Reports.webp" width="auto" height="58" alt="Game Reports"> <span class="fs-md-16 fs-sm-15 fs-14 fw-bold">Game Reports</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        ...
                        <div class="col-12 p-2 fw-bold border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class="pb-2 h-50px mx-auto" src="{{GETFOLDERPATH()}}/Match-Reports.webp" width="auto" height="58" alt="Match Reports"> <span class="fs-md-16 fs-sm-15 fs-14 fw-bold">Match Reports</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        ...
                        <div class="col-12 p-2 fw-bold border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class="pb-2 h-50px mx-auto" src="{{GETFOLDERPATH()}}/Payment-Reports.webp" width="auto" height="58" alt="Payment Reports"> <span class="fs-md-16 fs-sm-15 fs-14 fw-bold">Payment Reports</span>
                        </div>
                     </div>
                  </div>
               </div>
