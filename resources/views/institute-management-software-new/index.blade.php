...
@push('meta')
<!--  Title -->
<title>institute Software in India, institute Management Software in India</title>

<!-- Required meta tags -->
<meta name="title" content="institute Software in India, institute Management Software in India" />
...
<meta name="keywords" content="institute Software in India, institute Management Software, institute Management Software in India, institute ERP Software, institute ERP Software India, institute Software, Online institute Software, institute Automation Software, institute ERP Solution, institute Timetable Software, institute Attendance Software, institute Library, Software, college ERP, college Campus Management Software, college Fees Management Software, college Library ERP, college Fees Online Payment Software, Online Fees Payment, college Transport Management, college Transport Management Solution, college Transport ERP, college Management ERP Software, college Management ERP, college Management System, college Administration Software, college Administration ERP, college Software Company in India, college ERP Solutions, college ERP India, college Software Company, college Software India, ERP for college, college Management ERP India" />

<!-- Twitter Meta -->
<meta name="twitter:title" content="institute Software in India, institute Management Software in India">
...
<meta name="twitter:image" content="{{asset('/public')}}/assets/img/institute-management-software/1.webp">

<!-- Facebook Meta -->
<meta property="og:url" content="{{asset('/')}}institute-management-software.php">
<meta property="og:title" content="institute Software in India, institute Management Software in India">
...
<meta property="og:image" content="{{asset('/public')}}/assets/img/institute-management-software/1.webp">
<meta property="og:image:secure_url" content="{{asset('/public')}}/assets/img/institute-management-software/1.webp">
...
<!-- SEO Headding -->
<h1 class="d-none"> Institute-management-software</h1>
   <!-- top banner section -->
                                 ...
                                 <div class="col-12 ">
                                    <div class="row mx-0 pb-2 justify-content-lg-start text-center justify-content-center">
                                       ...
                                       <div class="col-12 heading fs-md-14 fs-12 left text-white text-lg-start text-center">
                                             <span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Institute Management <b> Software</b></span>
                                       </div>
                                    </div>
                                 </div>
         ...
         <div class="image-layer"></div>
            <div class="container py-lg-5 py-md-3 py-4 zi-2 position-relative">
               <div class="col-12 mx-0 pb-md-4 pb-2 pb-lg-4 pb-md-4">
                  ...
                  <div class="col-12 heading fs-md-14 fs-20 center text-black"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> institute Management App Development:  <b> The Pivotal Feature </b></span></div>
      ...
      <div class="container-fluid moduleSection  py-lg-5 py-md-4 py-3">
         <div class="container">
            <div class="row">
               <div class="col-12 mx-0 pb-md-4 pb-2 pb-lg-4 pb-md-4">
                  <h3 class="d-none invisible">On-demand Grocery App Features</h3>
                  <div class="col-12 heading fs-md-14 fs-20 center text-black"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Module of institute Mangement  <b> System Software </b></span></div>
               </div>
               <div class="col-12">
                  <div class="col-12">
                     <div class="row g-3">
                        <div class="col-lg-3 col-md-6 col-12">
                           <div class="whyChossCard border-0 shadow-none h-100">
                              <div class="row h-100 gap-4">
                                 ...
                                 <div class="col-12 ">
                                    <div class="cardHeading text-center">institute Administrative</div>
   ...
   <div class="container-fluid py-lg-5 py-md-4 py-3 benefitsCardSection">
      <div class="container">
         <div class="row gap-3">
            <div class="col-12 mx-0 pb-md-4 pb-2 pb-lg-4 pb-md-4">
               <h3 class="d-none invisible">On-demand Grocery App Features</h3>
               <div class="col-12 heading fs-md-14 fs-20 center text-black"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Benefits Of Our  Institute  <b> Mangement Software </b></span></div>
               <div class="cpl-12 col-md-10 fw-l fs-md-16 fs-sm-15 fs-14 text-dark text-center mt-3 px-0 mx-auto">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit. Minus eos id quam sint aut illo repellendus porro soluta laborum tempore impedit, ut exercitationem dolorem, deserunt obcaecati reprehenderit, vitae praesentium labore.
               </div>
            </div>
