            ...
            <div class="col-md-12">
               <nav aria-label="breadcrumb">
                  <ol class="breadcrumb mb-0">
                     ...
                     <li class="breadcrumb-item"><a class="fw-600 fs-lg-16 fs-md-15 fs-14 text-theme2 text-decoration-none" href="{{asset('/fantasy-sports-app-development.php')}}">Fantasy Sports App Development </a></li>
                     <li class="breadcrumb-item active fw-600 fs-lg-16 fs-md-15 fs-14 text-dark" aria-current="page">Fantasy Movie</li>
                  </ol>
               </nav>
            </div>
         </div>
   ...
   <div class="container-fluid overflow-hidden why-choose-cms position-relative">
      <div class="container py-5 position-relative zi-2">
         <div class="row mx-0 pb-5">
            ...
            <div class="col-12 fw-600 fs-md-16 fs-sm-15 fs-14 text-muted mt-md-3 mt-4 justify text-center">The craze for movies is at the peak every new weekend. With people rushing to theatres catch early shows and tickets, the madness for movies has caught the generation in its grip. Now join the crazies and get your business a Fantasy Movie Platform, the latest in the trend of fantasy sports and have huge round of competitions of Movie Leagues. Make everyone come together in the greatest round up of Fantasy Movie League. The only place on the internet where your movie insights can win you lots of rewards and goodies. Compete against friends or a league of movie lovers to win movie tickets, swag, and more, as the box office collection climbs, so do you. It's easy to play, hard to master, and all for free!
            </div>
            <div class="col-12 fw-600 fs-md-16 fs-sm-15 fs-14 text-muted mt-md-3 mt-4 justify text-center">The Fantasy Movie League Portal Developed by us would become the hub for following among the fan circles of Movie Stars and Movie Themes.
            </div>
         </div>
         <div class="row justify-content-center">
            <div class="col-md-9">
               <div class="row justify-content-center">
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        ...
                        <div class="col-12 p-2 fw-bold border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class=" pb-2 h-50px mx-auto" src="{{GETFOLDERPATH()}}/Trailers-and-Sneak-Peeks.webp" width="auto" height="42" alt="Trailers and Sneak Peeks"> <span class="fs-md-15 fs-sm-15 fs-14 fw-bold">Trailers and Sneak Peeks</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        ...
                        <div class="col-12 p-2 fw-bold border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class=" pb-2 h-50px mx-auto" src="{{GETFOLDERPATH()}}/Get-Cashback-and-Other-Rewards.webp" width="auto" height="42" alt="Get Cashback and Other Rewards"> <span class="fs-md-15 fs-sm-15 fs-14 fw-bold">Get Cashback and Other Rewards</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        ...
                        <div class="col-12 p-2 fw-bold border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class=" pb-2 h-50px mx-auto" src="{{GETFOLDERPATH()}}/Earn-Best-Deals.webp" width="auto" height="42" alt="Earn Best Deals"> <span class="fs-md-15 fs-sm-15 fs-14 fw-bold">Earn Best Deals</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        ...
                        <div class="col-12 p-2 fw-bold border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class=" pb-2 h-50px mx-auto" src="{{GETFOLDERPATH()}}/Shop-for-Movies-Merchandise.webp" width="auto" height="42" alt="Shop for Movies Merchandise"> <span class="fs-md-15 fs-sm-15 fs-14 fw-bold">Shop for Movies Merchandise</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        ...
                        <div class="col-12 p-2 fw-bold border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class=" pb-2 h-50px mx-auto" src="{{GETFOLDERPATH()}}/Blogs.webp" width="auto" height="42" alt="Blogs"> <span class="fs-md-16 fs-sm-15 fs-14 fw-bold">Blogs</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        ...
                        <div class="col-12 p-2 fw-bold border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class=" pb-2 h-50px mx-auto" src="{{GETFOLDERPATH()}}/User-Profile-Management.webp" width="auto" height="42" alt="User Profile Management"> <span class="fs-md-15 fs-sm-15 fs-14 fw-bold">User Profile Management</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        ...
                        <div class="col-12 p-2 fw-bold border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class=" pb-2 h-50px mx-auto" src="{{GETFOLDERPATH()}}/Gifts-and-Reward-Distribution.webp" width="auto" height="42" alt="Gifts and Reward Distribution"> <span class="fs-md-16 fs-sm-15 fs-14 fw-bold">Gifts and Reward Distribution</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        ...
                        <div class="col-12 p-2 fw-bold border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class=" pb-2 h-50px mx-auto" src="{{GETFOLDERPATH()}}/User-Reports.webp" width="auto" height="42" alt="User Reports"> <span class="fs-md-15 fs-sm-15 fs-14 fw-bold">User Reports</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        ...
                        <div class="col-12 p-2 fw-bold border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class=" pb-2 h-50px mx-auto" src="{{GETFOLDERPATH()}}/Scoring-Management.webp" width="auto" height="42"alt="Scoring Management"> <span class="fs-md-15 fs-sm-15 fs-14 fw-bold">Scoring Management</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        ...
                        <div class="col-12 p-2 fw-bold border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class=" pb-2 h-50px mx-auto" src="{{GETFOLDERPATH()}}/Ranking-Management.webp" width="auto" height="42" alt="Ranking Management"> <span class="fs-md-15 fs-sm-15 fs-14 fw-bold">Ranking Management</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        ...
                        <div class="col-12 p-2 fw-bold border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class=" pb-2 h-50px mx-auto" src="{{GETFOLDERPATH()}}/Collecting-Fees-in-Secured-Manner.webp" width="auto" height="42" alt="Collecting Fees in Secured Manner"> <span class="fs-md-15 fs-sm-15 fs-14 fw-bold">Collecting Fees in Secured Manner</span>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-4 col-md-6 col-sm-6 col-12 p-2">
                     <div class="row mx-0">
                        ...
                        <div class="col-12 p-2 fw-bold border border-2 border-muted bg-white fs-14 justify-content-center d-grid">
                           <img class=" pb-2 h-50px mx-auto" src="{{GETFOLDERPATH()}}/Detailed-Timely-Reports.webp" width="auto" height="42" alt="Detailed Timely Reports"> <span class="fs-md-15 fs-sm-15 fs-14 fw-bold">Detailed Timely Reports</span>
                        </div>
                     </div>
                  </div>
               </div>
