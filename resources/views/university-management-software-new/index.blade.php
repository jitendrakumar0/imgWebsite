...
@push('meta')
<!--  Title -->
<title>university Software in India, university Management Software in India</title>

<!-- Required meta tags -->
<meta name="title" content="university Software in India, university Management Software in India" />
...
<meta name="twitter:image" content="{{asset('/public')}}/assets/img/university-management-software/1.webp">

<!-- Facebook Meta -->
<meta property="og:url" content="{{asset('/')}}university-management-software.php">
<meta property="og:title" content="university Software in India, university Management Software in India">
...
<meta property="og:image" content="{{asset('/public')}}/assets/img/university-management-software/1.webp">
<meta property="og:image:secure_url" content="{{asset('/public')}}/assets/img/university-management-software/1.webp">



<meta name="classification" content="university Software in India, university Management Software, university Management Software in India, university ERP Software, university ERP Software India, university Software, Online university Software, university Automation Software, university ERP Solution, university Timetable Software, university Attendance Software, university Library, Software, university ERP, university Campus Management Software, university Fees Management Software, university Library ERP, university Fees Online Payment Software, Online Fees Payment, university Transport Management, university Transport Management Solution, university Transport ERP, university Management ERP Software, university Management ERP, university Management System, university Administration Software, university Administration ERP, university Software Company in India, university ERP Solutions, university ERP India, university Software Company, university Software India, ERP for university, university Management ERP India" />
<link rel="canonical" href="{{asset('/')}}university-management-software.php" />
...
<!-- SEO Headding -->
<h1 class="d-none"> university -management-software</h1>
   <!-- top banner section -->
                     ...
                     <div class="row pt-3">
                        <div class="col-12">
                           <div class="row mx-0 pb-2">
                              <div class="col-12 heading fs-md-14 fs-12 left text-white"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> college Management new <b>Software</b></span></div>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="col-6 pe-5 top_banner-left-part">
                     <div class="row justify-content-end">
                        <div class="col-8 position-relative" style="transform-style: preserve-3d;" data-tilt data-tilt-max="3" data-tilt-speed="400" data-tilt-perspective="2500" data-tilt-reverse="true">
                          <img src="{{GETFOLDERPATH()}}/college-management-software1.webp" class="lazy-image w-100" data-src="{{GETFOLDERPATH()}}/college-management-software.webp"alt="college-management-software" width="100" height="auto">  
                    </div>
                     </div>
                  </div>
               </div>
                        ...
                        <div class="row pt-3 text-lg-start text-md-center text-center position-relative">
                                 ...
                                 <div class="col-12 ">
                                    <div class="row mx-0 pb-2 justify-content-lg-start text-center justify-content-center">
                                       ...
                                       <h1 class="d-none invisible">University Management Software </h1>
                                       <div class="col-12 heading fs-md-14 fs-12 left text-white text-lg-start text-center">
                                             <span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> University Management <b> Software</b></span>
                                       </div>
                                    </div>
                                 </div>
            ...
            <div class="col-md-12">
               <nav aria-label="breadcrumb">
                  <ol class="breadcrumb mb-0">
                     ...
                     <li class="breadcrumb-item active fw-l fs-lg-16 fs-md-15 fs-14 text-dark" aria-current="page">University Management Software</li>
                  </ol>
               </nav>
            </div>
         </div>
   ...
   <div class="container-fluid py-lg-5 py-md-4 py-3 aboutHotal">
      ...
      <div class="row align-items-center gap-lg-0 gap-3">
         <div class="col-lg-6 order-lg-1 order-2">
            ...
            <h2 class="d-none invisible"> University Management Software</h2>
            <div class="col-12 heading fs-md-14 fs-12 left "><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20">  University Management  <b> Software Development</b></span></div>
         </div>
            <div class="row">
            <div class="col-12">
               <div class="fw-l fs-lg-17 fs-md-16 fs-sm-15 fs-14 text-dark mt-3 mb-lg-3">Lorem ipsum dolor sit amet consectetur adipisicing elit. Tenetur culpa porro quos minus nostrum debitis vero fugit atque laborum! <b>University Management Software</b> Officia nisi natus blanditiis velit! Numquam tempore omnis quae tenetur atque officia, voluptate doloremque temporibus sint repudiandae vero, provident tempora soluta. Explicabo consectetur omnis accusamus minus nobis et, quae ad deleniti? Quasi repellendus nisi sapiente eius molestiae aspernatur tempore explicabo rem!</div>
            </div>
            </div>
         </div>
         <div class="col-lg-6 order-lg-2 order-1">
            <div class="imgAbout rounded-3 overflow-hidden">
               <img src="{{GETFOLDERPATH()}}/aboutsection.jpg" class="lazy-image w-100 h-100 rounded-3" data-src="{{GETFOLDERPATH()}}/aboutsection.jpg"alt="University Management Software Development Services" width="100" height="auto">   
            </div>
         </div>
         </div>
      </div>
   ...
   <div class="container-fluid app-features-section">
      ...
      <div class="container py-lg-5 py-md-3 py-4 zi-2 position-relative">
         <div class="col-12 mx-0 pb-md-4 pb-2 pb-lg-4 pb-md-4">
            ...
            <div class="col-12 heading fs-md-14 fs-20 center text-black"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> University Management App Development:  <b> The Pivotal Feature </b></span></div>
   ...
   <div class="container-fluid moduleSection  py-lg-5 py-md-4 py-3">
      <div class="container">
         <div class="row">
            <div class="col-12 mx-0 pb-md-4 pb-2 pb-lg-4 pb-md-4">
               <h3 class="d-none invisible">On-demand Grocery App Features</h3>
               <div class="col-12 heading fs-md-14 fs-20 center text-black"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Module of University Mangement  <b> System Software </b></span></div>
            </div>
            <div class="col-12">
               <div class="col-12">
                  <div class="row g-3">
                     <div class="col-lg-3 col-md-6 col-12">
                        <div class="whyChossCard border-0 shadow-none h-100">
                           <div class="row h-100 gap-4">
                              ...
                              <div class="col-12 ">
                                 <div class="cardHeading text-center">College Administrative</div>
         ...
         <div class="container">
            <div class="row">
               ...
               <div class="col-12 text-sm-start text-center fs-xxl-18 fs-xl-18 fs-lg-18 fs-md-18 fs-sm-15 fs-15 fw-l text-white mb-4">
                  Team up with us for University management system developemnt
               </div>
      ...
      <div class="container-fluid py-lg-5 py-md-4 py-3 benefitsCardSection">
         <div class="container">
            <div class="row gap-3">
               <div class="col-12 mx-0 pb-md-4 pb-2 pb-lg-4 pb-md-4">
                  <h3 class="d-none invisible">On-demand Grocery App Features</h3>
                  <div class="col-12 heading fs-md-14 fs-20 center text-black"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Benefits Of Our  University  <b> Mangement Software </b></span></div>
                  <div class="cpl-12 col-md-10 fw-l fs-md-16 fs-sm-15 fs-14 text-dark text-center mt-3 px-0 mx-auto">
                  Lorem ipsum, dolor sit amet consectetur adipisicing elit. Minus eos id quam sint aut illo repellendus porro soluta laborum tempore impedit, ut exercitationem dolorem, deserunt obcaecati reprehenderit, vitae praesentium labore.
                  </div>
               </div>
                  ...
                  <div class="row owl-carousel owl-theme benifitsOwl mx-0">
                     <div class="col-12 item px-0">
                           <div class=" benefitCard">
                              <div class="cardImg ">
                                 <img src="{{GETFOLDERPATH()}}/Data.svg" class="lazy-image w-100 h-100 rounded-3" data-src="{{GETFOLDERPATH()}}/Data.svg"alt="College Management Software Development Services" width="100" height="100">   
                              </div>
                     ...
                     <div class="col-12 item px-0">
                        <div class=" benefitCard">
                           <div class="cardImg bg-danger ">
                              <img src="{{GETFOLDERPATH()}}/atmcard.svg" class="lazy-image w-100 h-100 rounded-3" data-src="{{GETFOLDERPATH()}}/atmcard.svg"alt="College Management Software Development Services" width="100" height="100">   
                           </div>
