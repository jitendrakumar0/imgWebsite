            ...
            <div class="col-md-12">
               <nav aria-label="breadcrumb">
                  <ol class="breadcrumb mb-0">
                     ...
                     <li class="breadcrumb-item active fw-600 fs-lg-16 fs-md-15 fs-14 text-dark" aria-current="page">CMS Development</li>
                  </ol>
               </nav>
            </div>
         </div>
         ...
         <div class="row">
            <div class="col-lg-3 col-md-4 col-6 d-flex align-items-stretch mt-4 mb-4">
               <div class="why-choose-cms-box position-relative w-100 px-3 pt-5 pb-3">
                  ...
                  <div class="col why-choose-box-head fw-bold fs-xxl-16 fs-xl-16 fs-lg-15 fs-md-15 fs-14 ellipsis-1 text-center mt-2">
               ...
               <div class="accordion" id="accordionExample">
                  <div class="accordion-item mb-4 position-relative zi-2">
                     ...
                     <div id="collapseOne" class="position-relative accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionExample">
                        <div class="accordion-body fw-600 fs-lg-15 fs-md-14 text-theme1 fs-14">
                     ...
                     <div id="collapseTwo" class="position-relative accordion-collapse collapse" aria-labelledby="headingTwo" data-bs-parent="#accordionExample">
                        <div class="accordion-body fw-600 fs-lg-15 fs-md-14 text-theme1 fs-14">
                           ...
                           <ul class="list_count mt-2">
                              <li class="fs-lg-15 fs-md-14 fs-14 fw-600 text-theme3">SEO-friendly.</li>
                              <li class="fs-lg-15 fs-md-14 fs-14 fw-600 text-theme3">Ease of maintenance.</li>
                              <li class="fs-lg-15 fs-md-14 fs-14 fw-600 text-theme3">Quick development.</li>
                              <li class="fs-lg-15 fs-md-14 fs-14 fw-600 text-theme3">Cost-efficiency.</li>
                           </ul>
                        </div>
                     </div>
                  </div>
