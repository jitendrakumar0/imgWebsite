...
@push('meta')
   ...
   <meta name="description" content="IMG Global Infotech is a high-end responsive web design company in India that has been providing the top web design and development services to its clients all over the world." />
   ...
   <meta name="twitter:description" content="IMG Global Infotech is a high-end responsive web design company in India that has been providing the top web design and development services to its clients all over the world.">
   ...
   <meta property="og:description" content="IMG Global Infotech is a high-end responsive web design company in India that has been providing the top web design and development services to its clients all over the world.">
               ...
               <div class="row pt-4 align-items-center">
                  <div class="col-lg-6 py-lg-5 pt-md-5 pb-md-4 py-4 order-lg-0 order-md-1 order-1">
                     <div class="row pt-3 text-lg-start text-md-center text-center">
                        ...
                        <div class="col-12 fw-600 fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-white mt-3 mb-lg-3">Responsive Web design has become an essential tool for anyone with a digital presence. With the growth of smartphones, tablets and other mobile computing devices, more people are using smaller-screens to view web pages.</div>
            ...
            <div class="col-md-12">
               <nav aria-label="breadcrumb">
                  <ol class="breadcrumb mb-0">
                     ...
                     <li class="breadcrumb-item active fw-600 fs-lg-16 fs-md-15 fs-14 text-dark" aria-current="page">Responsive Website Design</li>
                  </ol>
               </nav>
            </div>
         </div>
               ...
               <div class="row align-items-center">
                  ...
                  <div class="col-lg-7">
                     <div class="row">
                        ...
                        <div class="col-12 fw-bold fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-muted text-lg-start text-center mt-3">With a substantial increase in smartphone users in past few years,</div>
                        <div class="col-12 fw-600 fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-muted text-lg-start text-center mt-3">There are hundreds of smartphones in the market with every smartphone carrying a different size. At the same time there are too many variations in desktop screen sizes as well. It is practically impossible to design different website for different screen sizes. IMG Global Infotech has a well-equipped and experienced team that can design such websites for your business that are responsive and flexible to every screen size. This way the customers don’t have to face accessibility issues to your website and your business remains robust. Choosing a responsive website would be a smarter choice for next generation.</div>
                        <div class="col-12 fw-600 fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-muted text-lg-start text-center mt-3">Responsive Web design has become an essential tool for anyone with a digital presence. With the growth of smartphones, tablets and other mobile computing devices, more people are using smaller-screens to view web pages. It is essential for your business’s website to be responsive and flexible as per the different screen sizes and types. IMG Global does this for your business and design responsive websites for any business.</div>
                     </div>
                  </div>
               </div>
            </div>
         ...
         <div class="row">
            <div class="col-lg-6">
               <div class="row mb-5">
                  ...
                  <div class="col-12 fw-600 fs-17 text-muted mt-2">Responsive Web design has become an essential tool for anyone with a digital presence. With the growth of smartphones, tablets and other mobile computing devices, more people are using smaller-screens to view web pages.</div>
               </div>
         ...
         <div class="row justify-content-center">
            <div class="col-md-4 d-flex align-items-stretch my-4">
               <div class="boxdiv w-100 px-3">
                  ...
                  <div class="col-12 fw-900 fs-16 lh-normal boxdiv-head text-uppercase">Adaptation To All Devices</div>
               </div>
            </div>
            <div class="col-md-4 d-flex align-items-stretch my-4">
               <div class="boxdiv w-100 px-3">
                  <h3 class="d-none invisible">Open Support For All Browsers</h3>
                  <div class="col-12 fw-900 fs-16 lh-normal boxdiv-head text-uppercase">Open Support For All Browsers</div>
               </div>
            </div>
            <div class="col-md-4 d-flex align-items-stretch my-4">
               <div class="boxdiv w-100 px-3">
                  <h3 class="d-none invisible">Perfection In Your SEO</h3>
                  <div class="col-12 fw-900 fs-16 lh-normal boxdiv-head text-uppercase">Perfection In Your SEO</div>
               </div>
            </div>
            <div class="col-md-4 d-flex align-items-stretch my-4">
               <div class="boxdiv w-100 px-3">
                  <h3 class="d-none invisible">Low Cost & Higher Maintenance</h3>
                  <div class="col-12 fw-900 fs-16 lh-normal boxdiv-head text-uppercase">Low Cost & Higher Maintenance</div>
               </div>
            </div>
            <div class="col-md-4 d-flex align-items-stretch my-4">
               <div class="boxdiv w-100 px-3">
                  <h3 class="d-none invisible">More Sale & Higher Conversation</h3>
                  <div class="col-12 fw-900 fs-16 lh-normal boxdiv-head text-uppercase">More Sale & Higher Conversation</div>
               </div>
            </div>
         </div>
      </div>
                                    ...
                                    <div class="form-floating">
                                          <select name="requirement" required="" class="form-control rounded-0 pt-2 fw-400">
                                             <option value="">Project Brief *</option>
                                                ...
                                                <option value="Website Design" checked="checked">Website Design</option>
