            ...
            <div class="col-md-12">
               <nav aria-label="breadcrumb">
                  <ol class="breadcrumb mb-0">
                     ...
                     <li class="breadcrumb-item active fw-600 fs-lg-16 fs-md-15 fs-14 text-dark" aria-current="page">Grocery App Development Company </li>
                  </ol>
               </nav>
            </div>
         </div>
               ...
               <div class="row develop-boxes mt-4">
                  <div class="col-lg-4 col-md-6 text-start d-flex align-items-stretch">
                     <div class="features_mobile_app_box mx-0 shadow row py-3 align-items-center px-2 even-bg">
                        ...
                        <div class="col">
                           ...
                           <div class="col-12 text-start fw-900 text-white fs-md-24 fs-sm-17 fs-16 lh-normal">User-Friendly</div>
                           <div class="col-12 text-start fw-600 fs-md-15 fs-sm-14 fs-13 text-white mt-2">It's easy to navigate the restaurants and foods of your choice on our app.</div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-lg-4 col-md-6 text-start d-flex align-items-stretch">
                     <div class="features_mobile_app_box mx-0 shadow row py-3 align-items-center px-2 odd-bg">
                        ...
                        <div class="col">
                           ...
                           <div class="col-12 text-start fw-900 text-dark fs-md-24 fs-sm-17 fs-16 lh-normal">Online Payment</div>
                           <div class="col-12 text-start fw-600 fs-md-15 fs-sm-14 fs-13 text-dark mt-2">Make your payment in a few easy steps.</div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-lg-4 col-md-6 text-start d-flex align-items-stretch">
                     <div class="features_mobile_app_box mx-0 shadow row py-3 align-items-center px-2 even-bg">
                        ...
                        <div class="col">
                           ...
                           <div class="col-12 text-start fw-900 text-white fs-md-24 fs-sm-17 fs-16 lh-normal">In-App Chat</div>
                           <div class="col-12 text-start fw-600 fs-md-15 fs-sm-14 fs-13 text-white mt-2">Connect with us for any query or complaint.</div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-lg-4 col-md-6 text-start d-flex align-items-stretch">
                     <div class="features_mobile_app_box mx-0 shadow row py-3 align-items-center px-2 odd-bg">
                        ...
                        <div class="col">
                           ...
                           <div class="col-12 text-start fw-900 text-dark fs-md-24 fs-sm-17 fs-16 lh-normal">Deals & Rewards</div>
                           <div class="col-12 text-start fw-600 fs-md-15 fs-sm-14 fs-13 text-dark mt-2">Get assured deals and rewards on your orders.</div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-lg-4 col-md-6 text-start d-flex align-items-stretch">
                     <div class="features_mobile_app_box mx-0 shadow row py-3 align-items-center px-2 even-bg">
                        ...
                        <div class="col">
                           <h3 class="d-none invisible">Deals & Rewards</h3>
                           <div class="col-12 text-start fw-900 text-white fs-md-24 fs-sm-17 fs-16 lh-normal">Product Review</div>
                           <div class="col-12 text-start fw-600 fs-md-15 fs-sm-14 fs-13 text-white mt-2">Read reviews and rate our app before ordering.</div>
                        </div>
                     </div>
                  </div>
               ...
               <div class="col-lg-4 col-md-6 text-start d-flex align-items-stretch">
                     <div class="features_mobile_app_box mx-0 shadow row py-3 align-items-center px-2 odd-bg">
                        ...
                        <div class="col">
                           ...
                           <div class="col-12 text-start fw-900 text-dark fs-md-24 fs-sm-17 fs-16 lh-normal">On Food App</div>
                           <div class="col-12 text-start fw-600 fs-md-15 fs-sm-14 fs-13 text-dark mt-2">Install the app on both your Android and iOS devices</div>
                        </div>
                     </div>
                  </div>
                </div>
     ...
     <div class="image-layer"></div>
      <div class="container py-lg-5 py-md-3 py-4 zi-2 position-relative">
         <div class="col-12 mx-0 pb-md-4 pb-2 pb-lg-4 pb-md-4">
            ...
            <div class="cpl-12 col-md-10 fw-600 fs-md-16 fs-sm-15 fs-14 text-dark text-center mt-3 px-0 mx-auto">IMG Global Infotech presents you with customized Food Delivery App Development. Hire our skilled designers and help us build your food delivery app for iPhone and Android devices.
            </div>
         </div>
            <div class="row d-flex align-items-center ">
                <div class="col-lg-8 col-md-12 col-12 useradmin pt-0 pt-lg-0 pt-md-0 mb-lg-4 d-flex justify-content-center mx-auto p-0">   
                     <ul class="nav nav-tabs border-0">
                           <li class="nav-item">
                              <a class="nav-link active btn text-black fs-lg-19 fs-md-19 fs-13 fw-bold my-3 py-2 pe-lg-4 pe-md-4 pe-2 ps-lg-4 ps-md-4 ps-2" data-bs-toggle="tab" href="#home"> Customer App</a>
                           </li>
                           <li class="nav-item">
                              <a class="nav-link btn text-black fs-lg-19 fs-md-19 fs-13  fw-bold my-3 py-2 mx-1 p-lg-2 p-md-2 p-3" data-bs-toggle="tab" href="#menu1">Driver App</a>
                           </li>
                           <li class="nav-item">
                                 ...
                                 <div class="col-lg-3 col-md-3 col-6 mb-3">             
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Nearby Restaurants</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">          
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Restaurant Menu</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">    
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Push Notifications</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">       
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Coupon Management</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">         
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">inApp Payments</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">      
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Ratings & Reviews</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">            
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Social Media Login</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">            
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Order Tracking</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">    
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Manage Orders</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">       
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Order History</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">          
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Realtime Tracking</div>
                                          </div>
                                    </div>
                              </div>
                                 ...
                                 <div class="col-lg-3 col-md-3 col-6 mb-3">           
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Realtime Requests</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">       
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Availability Settings</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">         
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Delivery Information</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">      
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Payment History</div>
                                          </div>
                                    </div>
                              </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-6 mb-3">     
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Customer Management</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">         
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Restaurants Management</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">                
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Driver Management</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">                  
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Payment & Commission Management</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">               
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Menu & Timing</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">        
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Delivery zone Management</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">     
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Analyzing & Reporting</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">      
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Promo codes</div>
                                          </div>
                                    </div>
                              </div>
                     ...
                     <div class="row align-items-center mx-lg-5 mx-md-2 mx-0">
                        <div class="col-lg-12 col-md-12 col-12">
                         <h3 class="d-none invisible">Want to Build Food Delivery Application Development?</h3>
                           <div class="col-12 fw-600 fs-md-33 fs-lg-33 fs-24 text-white fw-900 text-center mb-3"> Want to Build Food Delivery Application Development?</div>
                           <div class="col-12 fw-600 fs-md-18 fs-lg-18 fs-16 text-white text-center"> Building a food delivery application can be a great business opportunity in this fast-paced world. To develop a successful food delivery application, connect with us. </div>
                        </div>
                           <div class="col-lg-12 col-md-12 col-12 d-flex justify-content-center py-3">
                               <a href="{{asset('/food-delivery-app-development-company-1.php#contactWithUss')}}" class="btn expert-btn fs-lg-15 fs-md-15 fs-14 fw-bold py-3 px-md-4 px-4 bg-white">
         ...
         <div class="row py-lg-4 py-3 items fantasy-cricket-sldier owl-carousel">
               ...
               <div class="box h-100 flex-column d-flex px-lg-3 px-md-3 px-3 py-lg-4 py-md-4 py-4">
                  <figure>
                     <picture class="d-flex justify-content-center">
                        <img src="{{GETFOLDERPATH()}}/grocery-app.png" class="w-lg-80 w-md-50 w-50" alt="grocery app">
                     </picture>
                  </figure>
            ...
            {{--   <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mb-lg-0 item">
               <div class="box h-100 flex-column d-flex px-3 py-4" >
                  <figure>
                     <picture class="d-flex justify-content-center">
                        <img src="{{GETFOLDERPATH()}}/food-delivery-app.png" class="w-lg-75 w-md-50 w-50" alt="">
                     </picture>
                  </figure>
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-19 fs-md-20 fs-18 lh-normal fw-900 mb-1 text-white">Food Delivery App Development</div>
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-15 flex-fill fs-15 lh-normal text-white">IMG is the best Food delivery app development company holding years of experience serving all types of business models.</div>
                        <div class="col-lg-12 col-md-12 col-12 d-flex justify-content-lg-start justify-content-md-start justify-content-start pt-3">
