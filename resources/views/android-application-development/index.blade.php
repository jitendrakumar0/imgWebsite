...
@push('meta')
   <!--  Title -->
   <title>Android App Development Company | Hire Android Developers</title>

   <!-- Required meta tags -->
   <meta name="title" content="Android App Development Company | Hire Android Developers" />
   <meta name="description" content="Trusted android app development company in India, create custom apps using its team of best Indian android app developers for software companies and start-ups." />
   <meta name="keywords" content="" /> 

   <!-- Twitter Meta -->
   <meta name="twitter:title" content="Android App Development Company | Hire Android Developers">
   <meta name="twitter:description" content="Trusted android app development company in India, create custom apps using its team of best Indian android app developers for software companies and start-ups.">
   ...
   <meta property="og:title" content="Android App Development Company | Hire Android Developers">
   <meta property="og:description" content="Trusted android app development company in India, create custom apps using its team of best Indian android app developers for software companies and start-ups.">
            ...
            <div class="col-md-12">
               <nav aria-label="breadcrumb">
                  <ol class="breadcrumb mb-0">
                     ...
                     <li class="breadcrumb-item active fw-600 fs-lg-16 fs-md-15 fs-14 text-dark" aria-current="page">Android App Development</li>
                  </ol>
               </nav>
            </div>
         </div>
   ...
   <div class="container-fluid hire-developers-section py-md-1 py-4 position-relative">
      <div class="container">
         <div class="row mx-0 align-items-center">
            ...
            <div class="col-12 fs-lg-30 fs-md-30 fs-20 text-white text-center text-md-start">  <span class="fw-900"> Ready to start your dream project?</span></div>
               <div class="col-12 heading2 fs-lg-40 fs-md-30 fs-25 text-white text-center text-md-start">  <span class="fw-900"> We have a TEAM to get you there.</span></div>
               </div> 
              <div class="col-lg-4 col-md-4 col-12 text-center py-2">
                  ...
                  <img class="w-50 position-absolute right-5 top-10" src="{{GETFOLDERPATH()}}/arrow.webp" alt="Arrow">
                     <div class="col-12 fs-md-20 fs-16 text-dark pb-2 fw-900"> Quick Support </div>
                     <div class="col-12">
                        <a href="{{asset('/android-application-development.php#contactWithUss')}}" class="btn expert-btn fs-md-14 fs-12 fw-bold py-1 px-md-2 px-2 text-capitalize">
       ...
       <div class="container pt-md-5 py-5 pb-md-2 position-relative zi-9">
         <div class="row mx-0 pb-5">
            <h2 class="d-none invisible">Android App Development Services</h2>
              ...
              <div class="col-md-7 col-12 fs-lg-28 fs-md-21 fs-16 text-dark mt-md-0 mt-3 text-md-start text-center"> <span class="fw-900">  Next-Gen </span>Android App Development Beside <span class="fw-900">   Professional Excellence  </span></div>
         </div>
         <div class="row">
            <div class="col-12 col-sm-6 col-lg-3 col-md-4 mb-4 d-flex align-items-stretch">
                <div class="model-card position-relative w-100">
                    ...
                    <div class="model-card-title fw-900 text-dark fs-md-16 fs-sm-15 fs-17 lh-normal">Enterprise Android App  <span class="d-block">Development</span></div>
            ...
            <div class="col-12 col-sm-6 col-lg-3 col-md-4 mb-4 d-flex align-items-stretch">
                <div class="model-card position-relative w-100">
                    ...
                    <div class="model-card-title fw-900 text-dark fs-md-16 fs-sm-15 fs-17 lh-normal">Android Full-cycle App    <span class="d-block">development</span></div>
            ...
            <div class="col-12 col-sm-6 col-lg-3 col-md-4 mb-4 d-flex align-items-stretch">
                <div class="model-card position-relative w-100">
                    ...
                    <div class="model-card-title fw-900 text-dark fs-md-16 fs-sm-15 fs-17 lh-normal">Android App  <span class="d-block">Migration</span></div>
                    <div class="col-12 model-card-text">
            ...
            <div class="col-12 col-sm-6 col-lg-3 col-md-4 mb-4 d-flex align-items-stretch">
                <div class="model-card position-relative w-100">
                    ...
                    <div class="model-card-title fw-900 text-dark fs-md-16 fs-sm-15 fs-17 lh-normal">App   <span class="d-block">Testing</span></div>
                    <div class="col-12 model-card-text">
            ...
            <div class="col-12 col-sm-6 col-lg-3 col-md-4 mb-4 d-flex align-items-stretch">
                <div class="model-card position-relative w-100">
                    ...
                    <div class="model-card-title fw-900 text-dark fs-md-16 fs-sm-15 fs-17 lh-normal">Maintenance <span class="d-block"> & Support</span></div>
                    <div class="col-12 model-card-text">
            ...
            <div class="col-12 col-sm-6 col-lg-3 col-md-4 mb-4 d-flex align-items-stretch">
                <div class="model-card position-relative w-100">
                    ...
                    <div class="model-card-title fw-900 text-dark fs-md-16 fs-sm-15 fs-17 lh-normal">UI/UX App  <span class="d-block">Design</span></div>
                    <div class="col-12 model-card-text">
            ...
            <div class="col-12 col-sm-6 col-lg-3 col-md-4 mb-4 d-flex align-items-stretch">
                <div class="model-card position-relative w-100">
                    ...
                    <div class="model-card-title fw-900 text-dark fs-md-16 fs-sm-15 fs-17 lh-normal">Android App API  <span class="d-block">Integrations</span></div>
                    <div class="col-12 model-card-text">
            ...
            <div class="col-12 col-sm-6 col-lg-3 col-md-4 mb-4 d-flex align-items-stretch">
                <div class="model-card position-relative w-100">
                    ...
                    <div class="model-card-title fw-900 text-dark fs-md-16 fs-sm-15 fs-17 lh-normal">Android M-commerce  <span class="d-block">Applications</span></div>
                    <div class="col-12 model-card-text">
        ...
        <div class="container-fluid hire-expert py-lg-5 py-md-3 py-4">
            <div class="container overflow-hidden position-relative ">
               ...
               <div class="col-lg-6 col-md-8 col-12">
                     <div class="col-12 pt-2 text-md-start text-lg-start text-center fs-xl-30 fs-lg-30 fs-md-24 fs-20 fw-900 ">
                      ...
                      With the help of our Android app development services, bring your concept to life. 
                        ...
                        <div class="col-12 text-lg-start text-md-start text-center py-lg-4 py-md-3 mt-lg-0 mb-md-2 mt-md-1 mt-4 mb-4">
                              <a href="{{asset('hire-android-app-developers.php')}}" class="btn btn-theme2 fs-md-14 fs-13 fw-bold py-2 px-md-4 px-3 text-capitalize">
                            ...
                            <div class="row mx-0 align-items-center pt-3 justify-content-center align-items-stretch">
                               <div class="col-lg-3 col-md-4 col-6 align-self-stretch">
                                    <div class="row py-3 mx-0 h-100">
                                        ...
                                        <div class="col-12 text-white fw-900 fs-xl-16 fs-lg-16 fs-14 text-center pt-md-4 pt-2">Efficient Project Management</div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-4 col-6 align-self-stretch">
                                    <div class="row py-3 mx-0 h-100">
                                        ...
                                        <div class="col-12 text-white fw-900 fs-xl-16 fs-lg-16 fs-14 text-center pt-md-4 pt-2">Cost effective Service</div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-4 col-6 align-self-stretch">
                                    <div class="row py-3 mx-0 h-100">
                                        ...
                                        <div class="col-12 text-white fw-900 fs-xl-16 fs-lg-16 text-center pt-md-4 pt-2">Cutting Edge Technology</div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-4 col-6 align-self-stretch">
                                    <div class="row py-3 mx-0 h-100">
                                        ...
                                        <div class="col-12 text-white fw-900 fs-xl-16 fs-lg-16 text-center pt-md-4 pt-2">Dedicated Developers </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-4 col-6 align-self-stretch">
                                    <div class="row py-3 mx-0 h-100">
                                        ...
                                        <div class="col-12 text-white fw-900 fs-xl-16 fs-lg-16 text-center py-md-2 py-2">Proven Method   </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-4 col-6 align-self-stretch">
                                    <div class="row py-3 mx-0 h-100">
                                        ...
                                        <div class="col-12 text-white fw-900 fs-xl-16 fs-lg-16 text-center py-md-2 py-2">Consistent Delivery   </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-3 col-md-4 col-6 align-self-stretch">
                                    <div class="row py-3 mx-0 h-100">
                                        ...
                                        <div class="col-12 text-white fw-900 fs-xl-16 fs-lg-16 text-center py-md-2 py-2">Highest Coincidentally  </div>
                                    </div>
                                </div>
                               ...
                               <div class="col-lg-3 col-md-4 col-6 align-self-stretch">
                                    <div class="row py-3 mx-0 h-100">
                                        ...
                                        <div class="col-12 text-white fw-900 fs-xl-16 fs-lg-16 text-center py-md-2 py-2">Enhanced RIO   </div>
                                    </div>
                                </div>
                           </div>
                        </div>
              ...
              <div class="caccordion-item mb-4 position-relative zi-2">
                 ...
                 <div class="accordion-item mb-4 position-relative zi-2">
                     <div class="accordion-header" id="headingOnes">
                        <button class="accordion-button fs-lg-14 fs-md-13 fs-13 fs-lg-14 fs-md-13 fs-13 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOnes" aria-expanded="false" aria-controls="collapseOnes">
