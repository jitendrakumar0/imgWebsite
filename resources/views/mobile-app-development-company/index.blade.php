...
<script type="application/ld+json">{
    ...
    <!-- Facebook Meta -->
    <meta property="og:url" content="{{asset('/mobile-app-development-company.php')}}">
    ...
    <link rel="canonical" href="{{asset('/mobile-app-development-company.php')}}" />
    ...
    <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/do-not-edit/css/mobile-app-development-company-1.min.css" />
</head>
<body>
    <main class="main-scrollbar ">
        <div class="container-fluid header-sec position-relative h-auto">
            <div class="container py-lg-0 py-md-0">
                ...
                <div class="offcanvas offcanvas-start sidebar" tabindex="-1" id="offcanvasExample" aria-labelledby="offcanvasExampleLabel">
                    ...
                    <div class="offcanvas-body">
                        ...
                        <div class="row align-items-md-center justify-content-around pt-5">
                            <div class="col-lg-6 col-md-12 hero_text-section order-md-1 order-1">
                                <div class="row">
                                    <div class="col text-center d-xl-none d-lg-none d-sm-none d-none">
                                        <img class="w-md-70 w-sm-70 w-70" src="{{asset('/public')}}/assets/img/hero-section/slide2/fantasy-sports-app.webp" alt="fantasy-sports-app" width="" height="">
                                        </div>
                                            ...
                                            <div class="col-auto mt-xl-0 mt-lg-0 mt-md-0 mt-0 mt-sm-0">
                                                <div class="row justify-content-lg-start justify-content-md-center justify-content-center mt-xl-0 mt-lg-0 mt-md-0 mt-sm-0 mt-0">
                                                    ...
                                                    <div class="col-12 px-0 py-md-4 pt-3 pb-0">
                                                        <div class="row countBoxOuter mx-0 g-3 me-lg-n4">
                                                            <div class="col-md-3 col-6 py-sm-0 py-2">
                                                                <div class="row countBox mx-0" style="--d: 0s">
                                                            ...
                                                            <div class="col-md-3 col-6 py-sm-0 py-2">
                                                                <div class="row countBox mx-0" style="--d: 2s">
                                                                    <div class="col-12 text-xl-start text-center mb-3">
                                                            ...
                                                            <div class="col-md-3 col-6 py-sm-0 py-2">
                                                                <div class="row countBox mx-0" style="--d: 3s">
                                                                    <div class="col-12 text-xl-start text-center mb-3">
                                                            ...
                                                            <div class="col-md-3 col-6 py-sm-0 py-2">
                                                                <div class="row countBox mx-0" style="--d: 4s">
                                                                    <div class="col-12 text-xl-start text-center mb-3">
                            ...
                            <div class="col-lg-6 col-md-12 hero_logo_section position-relative order-md-2 order-1 d-xl-block d-lg-block d-md-block d-sm-none d-none py-5 my-4">
                                <div class="row hero_image_toggles2 align-items-center justify-content-end">
                                    <div class="col-xxl-9 col-lg-10 col-md-10 col-sm-12 col-12 hero_img_toggles2_inner px-0">
                                                ...
                                                <h5 class="col-12 fw-m">
                                                    <div class="col-lg-12 col-md-12 col-12 mb-lg-0 mb-md-0 pb-md-1 px-4">
                                                        <div class="row align-items-center">
                                                            ...
                                                            <div class="col heading fs-md-14 fs-12 center text-dark"><span class="fs-xl-20 fs-lg-19 fs-md-18 fs-sm-17 fs-16">Connect With <b> Our Experts</b></span></div>
                                                        </div>
                                                    </div>
                                                </h5>
                                                </div>
                            ...
                            <div class="row mx-2">
                                ...
                                <div class="row hero_image_toggles2 align-items-center justify-content-center mt-xl-4 mt-lg-4 mt-md-4 pt-0">
                                    ...
                                    <div class="container contact-with-us-section position-relative zi-1 p-0">
                                        <div class="row align-items-center p-lg-3 p-md-4 pt-4 align-items-center py-4">
                                            ...
                                            <div class="container-fluid overflow-hidden best-app-development bg-white position-relative">
                                                <div class="container pt-lg-5 pt-md-4 pb-4 pt-0 position-relative zi-2">
                                                   <div class="row">
                                                      <div class="col-12">
                                                         <div class="row align-items-center">
                                                            ...
                                                            <div class="col-lg-5 pe-lg-5 top_banner-left-part">
                                                                <div class="row justify-content-center">
                                                                   <div class="col-lg-10 col-md-5 col-7 position-relative leftside">
                                                                     <img src="{{asset('/public')}}/assets/img/mobile-app-development-company/mobile-app-development-images.png" class="w-100" alt="leading-mobile-application-development-company" width="100" height="100%">
                                                                   </div>
                                                                </div>
                                                             </div>
                                                            <div class="col-lg-7">
                                   ...
                                   <div class="container-fluid overflow-hidden fantasysports-sec benifits position-relative p-0">
                                       <div class="container py-md-5 py-2 position-relative zi-2">
                                           <div class="row mt-lg-3 justify-content-center align-items-center">
                                                 <div class="col-lg-5 col-md-12 col-12">
                                                   <div class="col-12">
                                                          <div class="row mx-0 pt-lg-0">
                                                                <div class="col-12 p-0">
                                                                    <div class="row mx-0">
                                                                        <div class="col-12 heading2 fs-md-14 fs-12 left text-dark">
                                                   ...
                                                   <div class="col-lg-7 col-md-12 col-12">
                                                    <div class="row Mobile_App_Development_Expertise justify-content-center align-items-center g-4">
                                                                    
                                                                    <a href="{{asset('')}}android-application-development.php" class="col-md-6 box text-decoration-none">
                                                                            <div class="row box-body mx-0 h-100 p-3 12 text-center">
                                                                                <div class="col-12 py-md-4 py-3 icon">
                                                                                <div class="row">
                                                                    ...
                                                                    <a href="{{asset('')}}ios-app-development.php" class="col-md-6 box text-decoration-none">
                                                                        <div class="row box-body mx-0 h-100 p-3 text-center">
                                                                            <div class="col-12 py-md-4 py-3">
                                                                            <div class="row">
                                                                    ...
                                                                    <a href="{{asset('')}}flutter-app-development.php" class="col-md-6 box text-decoration-none">
                                                                        <div class="row box-body mx-0 h-100 p-3 12 text-center">
                                                                            <div class="col-12 py-md-4 py-3">
                                                                            <div class="row">
                                                                                <div class="col-12 text-center icon">
                                                        ...
                                                        <div class="container position-relative pt-md-3 pb-md-2">
                                                           <div class="row">
                                                                 <div class="row mx-0 mb-lg-4 mb-md-4 mb-3">
                                                                    <div class="col-12 heading fs-md-14 fs-12"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-16">Top Mobile App Development Company, <b> Accredited By</b> </span></div>
                                                                 </div>
                                                              </div>
                                                              <div class="row d-flex align-items-center justify-content-center">
                                                                <div class="col-lg-11 col-md-11 col-12">
                                                                    <div class="row">     
                                                                       <div class="col-lg-3 col-md-6 col-sm-6 col-12 p-3 review">
                                                                          <div class="box">
                                                                             <div class="col-12 text-center mb-4">
                                                                                <img class="w-22 position-relative" src="{{asset('/public')}}/assets/img/mobile-app-development/google.webp" alt="google">
                                                                             </div>
                                                                             <div class="col-12 text-center">
                                                                       ...
                                                                       <div class="col-lg-3 col-md-6 col-sm-6 col-12 p-3 review">
                                                                          <div class="box">
                                                                             <div class="col-12 text-center mb-4">
                                                                                <img class="w-40 position-relative" src="{{asset('/public')}}/assets/img/mobile-app-development/clutch.webp" alt="clutch">
                                                                             </div>
                                                                             <div class="col-12 text-center">
                                                                                   <i class="imgs img-star text-theme3"></i>
                                                                                   <i class="imgs img-star text-theme3"></i>
                                                                       ...
                                                                       <div class="col-lg-3 col-md-6 col-sm-6 col-12 p-3  review">
                                                                          <div class="box ">
                                                                             <div class="col-12 text-center mb-4">
                                                                                <img class="w-80 position-relative" src="{{asset('/public')}}/assets/img/mobile-app-development/extract.webp" alt="extract">
                                                                             </div>
                                                                             <div class="col-12 text-center">
                                                                                   <i class="imgs img-star text-theme3"></i>
                                                                                   <i class="imgs img-star text-theme3"></i>
                                                                       ...
                                                                       <div class="col-lg-3 col-md-6 col-sm-6 col-12 p-3 review">
                                                                          <div class="box">
                                                                             <div class="col-12 text-center mb-4">
                                                                                <img class="w-80 position-relative" src="{{asset('/public')}}/assets/img/mobile-app-development/glassdoor.webp" alt="glassdoor">
                                                                             </div>
                                                                             <div class="col-12 text-center">
                                                                                   <i class="imgs img-star text-theme3"></i>
                                                                                   <i class="imgs img-star text-theme3"></i>
                                                                        ...
                                                                        <div class="col-md col-sm-7 col-auto">
                                                                            <a href="javascript:;" class="card">
                                                                                ...
                                                                                <div class="card-body body2 row mx-0">
                                                                                    ...
                                                                                    <div class="col-12 fs-12 pt-2 text-white text-center">
                                                                                        We design mobile applications that enable users to order food from local restaurants.
                                                                                    </div>
                                                                                </div>
                                                                            </a>
                                                                        </div>
                                                                        <div class="col-md col-sm-7 col-auto">
                                                                            <a href="javascript:;" class="card">
                                                                                ...
                                                                                <div class="card-body body2 row mx-0">
                                                                                    ...
                                                                                    <div class="col-12 fs-12 pt-2 text-white text-center">
                                                                                        One exciting app that resembles the doctor-on-demand mechanics is Visitry.
                                                                                    </div>
                                                                                </div>
                                                                            </a>
                                                                        </div>
                                                                        <div class="col-md col-sm-7 col-auto">
                                                                            <a href="javascript:;" class="card">
                                                                                ...
                                                                                <div class="card-body body2 row mx-0">
                                                                                    ...
                                                                                    <div class="col-12 fs-12 pt-2 text-white text-center">
                                                                                        Get user-friendly, feature-rich Uber like Taxi Booking Apps with 100% customization.
                                                                                    </div>
                                                                                </div>
                                                                            </a>
                                                                        </div>
                                                                        <div class="col-md col-sm-7 col-auto">
                                                                            <a href="javascript:;" class="card">
                                                                                ...
                                                                                <div class="card-body body2 row mx-0">
                                                                                    ...
                                                                                    <div class="col-12 fs-12 pt-2 text-white text-center">
                                                                                        eLearning solutions that redefine the way how education is imparted
                                                                                    </div>
                                                                                </div>
                                                                            </a>
                                                                        </div>
                                                                        <div class="col-md col-sm-7 col-auto">
                                                                            <a href="javascript:;" class="card">
                                                                                ...
                                                                                <div class="card-body body2 row mx-0">
                                                                                    ...
                                                                                    <div class="col-12 fs-12 pt-2 text-white text-center">
                                                                                        Taking Online Examination to the Next Level with Customized App Solutions
                                                                                    </div>
                                                                                </div>
                                                                            </a>
                                                                        </div>
                                                                        <div class="col-md col-sm-7 col-auto">
                                                                            <a href="javascript:;" class="card">
                                                                                ...
                                                                                <div class="card-body body2 row mx-0">
                                                                                    ...
                                                                                    <div class="col-12 fs-12 pt-2 text-white text-center">
                                                                                        Get the best pharmacy delivery app and evaluate your business to a height.
                                                                                    </div>
                                                                                </div>
                                                                            </a>
                                                                        </div>
                                                                        <div class="col-md col-sm-7 col-auto">
                                                                            <a href="javascript:;" class="card">
                                                                                ...
                                                                                <div class="card-body body2 row mx-0">
                                                                                    ...
                                                                                    <div class="col-12 fs-12 pt-2 text-white text-center">
                                                                                        Delivering Cutting Edge Fashion App Development Services.
                                                                                    </div>
                                                                                </div>
                                                                            </a>
                                                                        </div>
                                ...
                                <div class="container banner-cta1 py-lg-4 py-md-4 py-4 zi-2 position-relative mt-lg-5 mt-md-5 mt-4 mt-lg-3 mb-lg-1 mb-md-5 mb-2">
                                ...
                                <div class="container-fluid overflow-hidden why-hire-developers-img py-xl-5 py-lg-5 py-md-5 py-4 position-relative">
                                    <div class="container">
                                       <div class="row align-content-center align-items-center position-relative">
                                             <div class="col-lg-7 col-md-12">
                                                ...
                                                <div class="col-lg-5 col-md-12 col-12 p-0 leftside">
                                                  <img class="w-100 position-relative" src="{{asset('/public')}}/assets/img/hire-android-app-developers/android-team.webp" alt="android-team">
                                                 </div>
                                              </div>
                                           </div>
                                        </div>
                        ...
                        <div class="container-fluid overflow-hidden bg-white new-portfolio position-relative" id="portfolio">
                                <div class="container pt-md-5 py-4 position-relative ">
                                    <div class="row">
                                        <div class="row mx-0">
                                            <h2 class="col-12 heading2 fs-md-14 fs-12"><span class="fs-xl-30 fs-lg-30 fs-md-30 fs-16">App-Driven  <b> Success Stories </b> </span></h2>
                                        </div>
                                        <div class="col-12 fs-lg-18 fs-md-18 fs-sm-16 fs-13 text-dark my-2 text-md-center text-center text-lg-center text-md-center mb-3">Get access to our portfolio representing our experts work</div>
                                    </div>
   ...
   <div class="container-fluid overflow-hidden bg-white faq_section position-relative pt-md-1">
      <div class="container position-relative zi-2 py-lg-4 py-4">
         <div class="row mx-0 pb-5">
            ...
            <div class="col-12 heading2 fs-md-14 fs-12 center"><span class="fs-xl-30 fs-lg-30 fs-md-30 fs-16"> Frequently Asked <b> Questions </b></span></div>
         </div>
         <div class="row justify-content-center">
            <div class="col-md-10">
  ...
  <div class="container-fluid contact-with-us-section position-relative overflow-hidden footer-part-main" id="contact-with-us-section">
      <div class="container position-relative zi-1 pt-5">
         <div class="row align-items-center border border-5 rounded p-3 border-white">
            <div class="col-lg-6">
               <div class="row align-items-center">
                  <h2 class="d-none invisible">Get Free Quotes Now ! </h2>
            ...
            <div class="col-lg-6 pt-lg-0 pt-4 px-lg-2 px-0">
               ...
               <form method="post" id="connectFormLast" name="connectFormLast" class="row gx-3 gy-md-3 gy-3 homeconnectFormValidation cricketApp" novalidate>
                  ...
                  <div class="col-md-7">
                         <div class="row">
                            <div class="col-4 pe-0">
                                <select class="form-select rounded-0 rounded-start form-control fs-13 " name="phonecode" aria-label="Default select example" style="padding: 0.375rem 0.25rem 0.375rem 0.75rem !important;" required>
                                   <option value="IN +91" selected="selected"> IN +91</option>
                                   <option value="IR +98">IR +98</option>
                                   <option value="IQ +964">IQ +964</option>
                                   <option value="IL +972">IL +972</option>
