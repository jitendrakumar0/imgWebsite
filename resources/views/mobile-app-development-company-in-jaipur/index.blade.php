...
@push('meta')
   <!--  Title -->
   <title>Mobile App Development Company in jaipur | IMG Global Infotech</title>

   <!-- Required meta tags -->
   <meta name="title" content="Mobile App Development Company in jaipur | IMG Global Infotech" />
   <meta name="description" content="IMG Global Infotech is a leading mobile app development company in jaipur, we build high-quality & user-friendly mobile apps for Android & iOS devices." />

   <!-- Twitter Meta -->
   <meta name="twitter:title" content="Mobile App Development Company in jaipur | IMG Global Infotech">
   <meta name="twitter:description" content="IMG Global Infotech is a leading mobile app development company in jaipur, we build high-quality & user-friendly mobile apps for Android & iOS devices.
">
   <meta name="twitter:image" content="{{asset('/public')}}/assets/img/mobile-app-development-company-in-jaipur/mobile-app-development-company-jaipur.webp">

   <!-- Facebook Meta -->
   <meta property="og:url" content="{{asset('/')}}mobile-app-development-company-in-jaipur.php">
   <meta property="og:title" content="Mobile App Development Company in jaipur | IMG Global Infotech">
   <meta property="og:description" content="IMG Global Infotech is a leading mobile app development company in jaipur, we build high-quality & user-friendly mobile apps for Android & iOS devices.">
   <meta property="og:image" content="{{asset('/public')}}/assets/img/mobile-app-development-company-in-jaipur/mobile-app-development-company-jaipur.webp">
   <meta property="og:image:secure_url" content="{{asset('/public')}}/assets/img/mobile-app-development-company-in-jaipur/mobile-app-development-company-jaipur.webp">
   ...
   <link rel="canonical" href="{{asset('/')}}mobile-app-development-company-in-jaipur.php" />
   <meta name="robots" content="index, follow" />
@endpush
@push('styles')
   <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/owl/owl.carousel.min.css">
   <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/do-not-edit/css/mobile-app-development-company-in-jaipur.min.css">
@endpush
@section('content')
                     ...
                     <div class="row pt-3 text-lg-start text-md-center text-center">
                        <div class="col-12">
                           <div class="row mx-0 pb-2">
                              <h1 class="d-none invisible">Mobile App Development Company in Jaipur</h1>
                              <div class="col-12 heading fs-md-14 fs-12 left text-white">
							  <span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Mobile App Development <b>Company in Jaipur</b></span>
                              </div>
                           </div>
                        </div>
                        <div class="col-12 fw-l fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-white mb-3 mt-3">We are committed to build enhanced user-friendly mobile apps and provide end to end support. Cost-effective and Responsive Mobile app development services. </div>
                  ...
                  <div class="col-lg-6 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-lg-end justify-content-md-center justify-content-center">
                        <div class="col-lg-8 col-md-5 col-7 position-relative">
                           <img class="w-100 position-relative tz" style="--tz:90px;" src="{{GETFOLDERPATH()}}/mobile-app-development-company-jaipur.webp" alt="Mobile App Development Company in Jaipur">
            ...
            <div class="col-md-12">
               <nav aria-label="breadcrumb">
                  <ol class="breadcrumb mb-0">
                     ...
                     <li class="breadcrumb-item active fw-l fs-lg-16 fs-md-15 fs-14 text-dark" aria-current="page">Mobile App Development Company In Jaipur</li>
                  </ol>
               </nav>
            </div>
         </div>
               ...
               <div class="row align-items-center">
                  <div class="col-lg-5 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-center">
                        ...
                        <img class="w-100 position-relative" src="{{GETFOLDERPATH()}}/trusted-mobile-app-development-company.webp" alt="Trusted Mobile App Development Company Based India">
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-7">
                     <div class="row">
                        <div class="col-12">
                           <div class="row mx-0 pb-3 pt-lg-0 pt-4">
                              <h2 class="d-none invisible">Trusted Mobile App Development Company Based India</h2>
                              <div class="col-12 heading fs-md-14 fs-12 text-center text-lg-start left"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20">Trusted Mobile App Development <b>Company Based India</b></span></div>
                           </div>
                        </div>
                        
                        <div class="col-12 fw-l fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-muted text-lg-start text-center mt-3">IMG being a top-notch mobile app development company has a team of skilled developers who expertly write codes. We work with the vision of creating the best-in-all mobile app with a highly cost-effective margin. Utilising the skills and knowledge to build responsive and robust mobile apps. </div>
                        <div class="col-12 fw-l fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-muted text-lg-start text-center mt-3">We are one of the leading mobile app development companies in Jaipur. We have assisted start-up to giant ventures in building the best mobile app for the business they can ever have. We take responsibility for every mobile app development process starting from analysing, and designing the user interface and studying to integrating and the whole process of back-end development. We possess the best team of Mobile app developers who have the required knowledge to convert the app to highly mobile-friendly and bring innovativeness to it. </div>
                        <div class="col-12 fw-l fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-muted text-lg-start text-center mt-3">We can proudly convey ourselves as a modern generation mobile app development company and a most reputed technical consulting firm. We have a skilled team of developers who use the latest technologies to build an engaging and responsive mobile app in real-time. We believe in delivering customised solutions having interactive UI/UX design and security-integrated apps. </div>
                     </div>
                     </div>
                  </div>
               </div>
   ...
   <div class="container-fluid features_mobile_app position-relative">
      <div class="container py-5 zi-2 position-relative">
         <div class="row mx-0 pb-5">
            ...
            <div class="col-12 heading fs-md-14 fs-12"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Our Mobile App <b>Development Services</b></span></div>
         </div>
         <div class="row develop-boxes">
            <div class="col-lg-4 col-md-6 text-center d-flex align-items-stretch ">
               <div class="features_mobile_app_box w-100 shadow mobile-sec">
                  <span class="d-flex align-items-center justify-content-center h-50px w-50px rounded-pill border mx-auto mb-3 fs-22 text-theme3 bg-white tz" style="--tz:30px;">
                     <i class="imgb img-android"></i>
                  </span>
                  <h3 class="d-none invisible">Android App Development</h3>
                  <div class="col-12 fw-m text-theme3 fs-md-22 fs-sm-17 fs-16 lh-normal tz" style="--tz:30px;">Android App Development</div>
                  <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 text-muted mt-3 tz" style="--tz:30px;">We have a team of developers who have specialised skills in building highly mobile responsive and scalable mobile apps for the Android platform. They work to influence the specific device features and create innovative functionality in your mobile app which will be more engaging and user-friendly. Our mobile app developers mainly use upskill technologies that are high in market demand such as Java and kotlin and we also use react native.</div>
                  <div class="col-12 text-center pt-3">
                     <a href="{{asset('/android-application-development.php')}}" class="btn btn-theme1 fs-14 fw-m py-2 px-4" style="transform-style: preserve-3d;" data-tilt data-tilt-max="3" data-tilt-speed="400" data-tilt-perspective="2500">
            ...
            <div class="col-lg-4 col-md-6 text-center d-flex align-items-stretch">
               <div class="features_mobile_app_box w-100 shadow mobile-sec">
                  <span class="d-flex align-items-center justify-content-center h-50px w-50px rounded-pill border mx-auto mb-3 fs-22 text-theme3 bg-white tz" style="--tz:30px;">
                  <i class="imgb img-app-store-ios"></i>
                  </span>
                  <h3 class="d-none invisible">ioS Development</h3>
                  <div class="col-12 fw-m text-theme3 fs-md-22 fs-sm-17 fs-16 lh-normal tz" style="--tz:30px;">iOS Development</div>
                  <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 text-muted mt-3 tz" style="--tz:30px;"> We also provide native iOS applications for all iOS platforms such as iPhone, iPad and Mac. We build scalable mobile applications at a cost-effective rate while we use flutter and iOS as working languages. We also deliver features like facetime and Apple Play to our customers. If you are planning to make a mobile app then you don’t need to worry about its budget factor.</div>
                  <div class="col-12 text-center pt-3">
                     <a href="{{asset('/ios-app-development.php')}}" class="btn btn-theme1 fs-14 fw-m py-2 px-4" style="transform-style: preserve-3d;" data-tilt data-tilt-max="3" data-tilt-speed="400" data-tilt-perspective="2500">
                        <span class="d-block"><span>Read More</span> <i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i></span>
                     </a>
                  </div>
               </div>
            ...
            <div class="col-lg-4 col-md-6 text-center d-flex align-items-stretch">
               <div class="features_mobile_app_box w-100 shadow mobile-sec">
                  <span class="d-flex align-items-center justify-content-center h-50px w-50px rounded-pill border mx-auto mb-3 fs-22 text-theme3 bg-white tz" style="--tz:30px;">
                     <i class="imgl img-laptop"></i>
                  </span>
                  <h3 class="d-none invisible">Flutter Development</h3>
                  <div class="col-12 fw-m text-theme3 fs-md-22 fs-sm-17 fs-16 lh-normal tz" style="--tz:30px;">Flutter Development</div>
                  <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 text-muted mt-3 tz" style="--tz:30px;">Flutter enables our team to shape your idea into an excellent approach to reality so stunning flutter app development can take place. We are experts in building high performance cross platform apps using flutter technology delivering results on budget and on-time delivery of apps.</div>
                  <div class="col-12 text-center pt-3">
                     <a href="{{asset('/ionic-app-development.php')}}" class="btn btn-theme1 fs-14 fw-m py-2 px-4" style="transform-style: preserve-3d;" data-tilt data-tilt-max="3" data-tilt-speed="400" data-tilt-perspective="2500">
                        <span class="d-block"><span>Read More</span> <i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i></span>
                     </a>
                  </div>
               </div>
   ...
   <div class="container-fluid Development_Process position-relative">
      <div class="container py-5 zi-2 position-relative">
         <div class="row mx-0 pb-5">
            <h2 class="d-none invisible">Mobile app development process followed by our experts</h2>
            <div class="col-12 heading fs-md-14 fs-12"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Mobile app development process <b>followed by our experts</b></span></div>
            <div class="col-12 pt-3 fs-md-16 fs-sm-15 fs-14 text-muted text-center">Our skilled professionals follow the below mobile app development process for delivering the best mobile app to the clients.</div>
         </div>
         <div class="row develop-boxes justify-content-center">

            <div class="col-lg-4 col-md-6 text-center d-flex align-items-stretch">
               <div class="Development_Process_box w-100 shadow">
                  <span class="d-flex align-items-center justify-content-center h-70px w-70px rounded-pill border mx-auto mb-3 fs-md-24 fs-sm-22 fs-20 text-theme3 bg-white fw-m tz num" style="--tz:30px;">
                     1
                  </span>
                  <h3 class="d-none invisible">Understanding the requirements</h3>
                  <div class="col-12 fw-m text-theme1 fs-md-18 fs-sm-17 fs-16 lh-normal tz" style="--tz:30px;">Understanding the requirements
</div>
                  <div class="col-12 mt-3 tz" style="--tz:30px;">
                     <ul class="list_icons list-unstyled ">
                        <li class="fw-l fs-md-16 fs-sm-15 fs-14 text-muted "><span class="fw-m"></span> We plan a meeting with the client</li>
                        <li class="fw-l fs-md-16 fs-sm-15 fs-14 text-muted"><span class="fw-m"></span> Understanding their perspective requirement</li>
                        <li class="fw-l fs-md-16 fs-sm-15 fs-14 text-muted"><span class="fw-m"></span> Providing them with innovative solution</li>
                     </ul>
                  </div>
               </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 text-center d-flex align-items-stretch">
               <div class="Development_Process_box w-100 shadow">
                  ...
                  <h3 class="d-none invisible">Wireframing and Designing</h3>
                  <div class="col-12 fw-m text-theme1 fs-md-18 fs-sm-17 fs-16 lh-normal tz" style="--tz:30px;">Wireframing and Designing</div>
                  <div class="col-12 mt-3 tz" style="--tz:30px;">
                     <ul class="list_icons list-unstyled">
                        <li class="fw-l fs-md-16 fs-sm-15 fs-14 text-muted"><span class="fw-m"></span>Making a blueprint</li>
                        <li class="fw-l fs-md-16 fs-sm-15 fs-14 text-muted"><span class="fw-m"></span>Wireframing the structure of each screen</li>
                        <li class="fw-l fs-md-16 fs-sm-15 fs-14 text-muted"><span class="fw-m"></span>Designing the app</li>
                     </ul>
                  </div>
               </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 text-center d-flex align-items-stretch">
               <div class="Development_Process_box w-100 shadow">
                  ...
                  <div class="col-12 fw-m text-theme1 fs-md-18 fs-sm-17 fs-16 lh-normal tz" style="--tz:30px;">Development</div>
                  <div class="col-12 mt-3 tz" style="--tz:30px;">
                     <ul class="list_icons list-unstyled">
                        <li class="fw-l fs-md-16 fs-sm-15 fs-14 text-muted"><span class="fw-m"></span>Starting the process of coding</li>
                        <li class="fw-l fs-md-16 fs-sm-15 fs-14 text-muted"><span class="fw-m"></span>Layouting the main sections</li>
                        <li class="fw-l fs-md-16 fs-sm-15 fs-14 text-muted"><span class="fw-m"></span>Taking client feedback</li>
                     </ul>
                  </div>
               </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 text-center d-flex align-items-stretch">
               <div class="Development_Process_box w-100 shadow">
                  ...
                  <div class="col-12 fw-m text-theme1 fs-md-18 fs-sm-17 fs-16 lh-normal tz" style="--tz:30px;">Testing</div>
                  <div class="col-12 mt-3 tz" style="--tz:30px;">
                     <ul class="list_icons list-unstyled">
                        <li class="fw-l fs-md-16 fs-sm-15 fs-14 text-muted"><span class="fw-m"></span>Testing the code</li>
                        <li class="fw-l fs-md-16 fs-sm-15 fs-14 text-muted"><span class="fw-m"></span>Checking for bugs</li>
                        <li class="fw-l fs-md-16 fs-sm-15 fs-14 text-muted"><span class="fw-m"></span>Getting final approval for 100% bug-free</li>
                     </ul>
                  </div>
               </div>
            </div>
            ...
            <div class="col-lg-4 col-md-6 text-center d-flex align-items-stretch">
               <div class="Development_Process_box w-100 shadow">
                  ...
                  <h3 class="d-none invisible">Deployment</h3>
                  <div class="col-12 fw-m text-theme1 fs-md-18 fs-sm-17 fs-16 lh-normal tz" style="--tz:30px;">Deployment</div>
                  <div class="col-12 mt-3 tz" style="--tz:30px;">
                     <ul class="list_icons list-unstyled">
                        <li class="fw-l fs-md-16 fs-sm-15 fs-14 text-muted"><span class="fw-m"></span>Deploying it to the app store</li>
                        <li class="fw-l fs-md-16 fs-sm-15 fs-14 text-muted"><span class="fw-m"></span>Deploying it to the client-server</li>
                        <li class="fw-l fs-md-16 fs-sm-15 fs-14 text-muted"><span class="fw-m"></span>The app is available to users for its use</li>
                     </ul>
                  </div>
               </div>
             </div>
   ...
   <div class="container-fluid overflow-hidden get-porposal position-relative web-design-services-section-5">
      <div class="container zi-2 py-5 position-relative">
         <div class="row f-flex align-items-center justify-content-center">
            <div class="col-12">
               <div class="row mx-0 pb-4">
                  <h2 class="d-none invisible">Building a mobile app for various industries</h2>
                  <div class="col-12 heading fs-md-14 fs-12 center text-white"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Building a mobile app <b>for various industries </b></span></div>
               </div>
            </div>
            <div class="row">
               <div class="col-12 col-md-4">
                  <ul class="fw-m fs-16 text-white list-unstyled text-capitalize">
                     <li class="mb-2 rounded d-flex"><span><i class="imgr img-angle-double-right text-white me-2"></i></span><span>Healthcare</span></li>
                     <li class="mb-2 rounded d-flex"><span><i class="imgr img-angle-double-right text-white me-2"></i></span><span>Education / e-Learning</span></li>
                     <li class="mb-2 rounded d-flex"><span><i class="imgr img-angle-double-right text-white me-2"></i></span><span>Media & Entertainment</span></li>
                     <li class="mb-2 rounded d-flex"><span><i class="imgr img-angle-double-right text-white me-2"></i></span><span>E-commerce</span></li>
                  
                  </ul>
               </div>
               <div class="col-12 col-md-4">
                  <ul class="fw-m fs-16 text-white list-unstyled text-capitalize">
                     <li class="mb-2 rounded d-flex"><span><i class="imgr img-angle-double-right text-white me-2"></i></span><span>Food & Restaurant</span></li>
                     <li class="mb-2 rounded d-flex"><span><i class="imgr img-angle-double-right text-white me-2"></i></span><span>Social Networking</span></li>
                     <li class="mb-2 rounded d-flex"><span><i class="imgr img-angle-double-right text-white me-2"></i></span><span>Banking & Finance</span></li>
                     <li class="mb-2 rounded d-flex"><span><i class="imgr img-angle-double-right text-white me-2"></i></span><span>Tour and Travels</span></li>

                  </ul>
               </div>
               <div class="col-12 col-md-4">
                  <ul class="fw-m fs-16 text-white list-unstyled text-capitalize">
                     <li class="mb-2 rounded d-flex"><span><i class="imgr img-angle-double-right text-white me-2"></i></span><span>Real Estate Website</span></li>
                     <li class="mb-2 rounded d-flex"><span><i class="imgr img-angle-double-right text-white me-2"></i></span><span>Sports</span></li>
                     <li class="mb-2 rounded d-flex"><span><i class="imgr img-angle-double-right text-white me-2"></i></span><span>Blog Website</span></li>
                     <li class="mb-2 rounded d-flex"><span><i class="imgr img-angle-double-right text-white me-2"></i></span><span>Tours & Travels</span></li>
                  </ul>
               </div>
            </div>

            <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 text-light mt-3 text-center">If you are looking out for a company that delivers innovative solutions for your mobile app development requirement then your search ends with us. We are one of the leading mobile app development company that provide mobile apps from scratch based on your customer's requirements. Some of the industries that we worked with are news, social networking, education, travelling, socialising, shopping, Retail Industry and many others.</div>
            <div class="col-12 pt-4 text-center">
               <a href="{{asset('/contact-us.php')}}" class="btn btn-theme3 fs-14 fw-m py-2 px-4" style="transform-style: preserve-3d;" data-tilt data-tilt-max="3" data-tilt-speed="400" data-tilt-perspective="2500">
                  <span class="d-block"><span>Contact Us Now</span> <i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i></span>
               </a>
            </div>
         </div>
      </div>
   ...
   <!-- why we are section -->
   <div class="container-fluid overflow-hidden why-we-are-section bg-white position-relative">
      <div class="container py-5 position-relative zi-2">
         <div class="row">
            <div class="col-12">
               <div class="row align-items-center">
                  <div class="col-lg-5 pe-lg-5 top_banner-left-part order-lg-2 order-1">
                     <div class="row justify-content-center">
                        <div class="col-lg-10 col-md-5 col-7 position-relative">
                           <img class="w-100 position-relative tz" style="--tz:90px;" src="{{GETFOLDERPATH()}}/why-choose-us.webp" alt="Why choose IMG Global Infotech as the best mobile app development company?">
                       </div>
                     </div>
                  </div>
                     ...
                     <div class="row">
                        <div class="col-12">
                           <div class="row mx-0 pb-4 pt-lg-0 pt-4">
                              <h2 class="d-none invisible">Why choose IMG Global Infotech as the best mobile app development company?</h2>
                              <div class="col-12 heading fs-md-14 fs-12 left"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20">Why choose IMG Global Infotech as the best <b>mobile app development company? </b></span></div>
                           </div>
                        </div>
                        <div class="col-12 fw-l fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-muted text-lg-start text-center mt-3">Being a leading mobile app development company possess expert developers who believe in working with creativity and innovation. They use the latest technology to build mobile apps which will fulfil the needs of your business. We are available 24/7 for your assistant based on the project requirement and you can take the update daily.</div>
                        <div class="col-12">
                           <div class="row">
                              <div class="col-auto p-2">
                                 <div class="row mx-0">
                                    <div class="boxs col-auto text-white fs-md-16 fs-sm-15 fs-14 py-1 ">100% Transparent</div>
                                 </div>
                              </div>
                              <div class="col-auto p-2">
                                 <div class="row mx-0">
                                    <div class="boxs col-auto text-white fs-md-16 fs-sm-15 fs-14 py-1 "> Innovative approach</div>
                                 </div>
                              </div>
                              <div class="col-auto p-2">
                                 <div class="row mx-0">
                                    <div class="boxs col-auto text-white fs-md-16 fs-sm-15 fs-14 py-1 ">Customer-centric flexible solutions</div>
                                 </div>
                              </div>
                              <div class="col-auto p-2">
                                 <div class="row mx-0">
                                    <div class="boxs col-auto text-white fs-md-16 fs-sm-15 fs-14 py-1 "> Flexible engagement model</div>
                                 </div>
                              </div>
                              <div class="col-auto p-2">
                                 <div class="row mx-0">
                                    <div class="boxs col-auto text-white fs-md-16 fs-sm-15 fs-14 py-1 ">24/7 support, </div>
                                 </div>
                              </div>
                              <div class="col-auto p-2">
                                 <div class="row mx-0">
                                    <div class="boxs col-auto text-white fs-md-16 fs-sm-15 fs-14 py-1 ">Deliver scalable results
                                    </div>
                                 </div>
                              </div>
                           </div>
     ...
     <!-- Portfolio Section -->
     <div class="container-fluid overflow-hidden new-portfolio position-relative">
         <div class="container py-md-5 py-4 position-relative ">
             ...
             <div class="row align-items-center justify-content-center owl-portfolio-slider owl-carousel mx-0">
                <div class="col-lg-12 col-md-12">
                    <div class="portfolioBox ">
                        <img src="{{asset('/public')}}/assets/img/portfolio-section/beliver11.webp" class="img-fluid w-100 rounded-5 border border-1 p-2" alt="Beliver11"  >
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="portfolioBox ">
                        <img src="{{asset('/public')}}/assets/img/portfolio-section/myfab11.webp" class="img-fluid w-100 rounded-2 border border-1 p-1" alt="MyFab11" >
                             <div class="portfolioBoxContent">
                            <h4>MyFab11 App </h4>
                            <p>Fantasy Sports App</p>
                        </div>
            ...
            <div class="col-lg-12 col-md-12">
                    <div class="portfolioBox ">
                        <img src="{{asset('/public')}}/assets/img/portfolio-section/royal11-project.webp" class="img-fluid w-100 rounded-2 border border-1 p-1" alt="Royal11" >
                             <div class="portfolioBoxContent">
                            <h4>Royal 11 </h4>
                            <p>Fantasy Sports App</p>
                        </div>
                ...
                <div class="col-lg-12 col-md-12">
                    <div class="portfolioBox">
                        <img src="{{asset('/public')}}/assets/img/portfolio-section/My-Pitch.webp" class="img-fluid w-100 rounded-2 border border-1 p-1" alt="My Pitch" >
                             <div class="portfolioBoxContent">
                            <h4>My Pitch </h4>
                            <p>Fantasy Sports App</p>
                        </div>
      ...
      <div class="modal-dialog modal-dialog-scrollable modal-dialog-centered mt-md-5 mt-1 mb-5">
         <form method="post" id="connectForm" name="connectForm" class="modal-content cricketApp" novalidate>
            ...
            <div class="modal-header align-items-start">
               <h5 class="modal-title fw-l" id="exampleModalLabel">
...
@push('scripts')
   ...
   <script src="{{asset('/public')}}/assets/js/mobile-app-development-company-in-jaipur.min.js"></script>
