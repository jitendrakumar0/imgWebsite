...
@push('meta')
   <!--  Title -->
   <title>Web Development Company in India, Web Development Services - IMG Global Infotech</title>

   <!-- Required meta tags -->
   <meta name="title" content="Web Development Company in India, Web Development Services - IMG Global Infotech" />
   <meta name="description" content="IMG Global Infotech is a reliable Web Development Company in India. We offer top class custom website development services like eCommerce, CMS development at affordable rates." />
   ...
   <!-- Twitter Meta -->
   <meta name="twitter:title" content="Web Development Company in India, Web Development Services - IMG Global Infotech">
   <meta name="twitter:description" content="IMG Global Infotech is a reliable Web Development Company in India. We offer top class custom website development services like eCommerce, CMS development at affordable rates.">
   ...
   <meta property="og:title" content="Web Development Company in India, Web Development Services - IMG Global Infotech">
   <meta property="og:description" content="IMG Global Infotech is a reliable Web Development Company in India. We offer top class custom website development services like eCommerce, CMS development at affordable rates.">
            ...
            <div class="col-md-12">
               <nav aria-label="breadcrumb">
                  <ol class="breadcrumb mb-0">
                     ...
                     <li class="breadcrumb-item active fw-600 fs-lg-16 fs-md-15 fs-14 text-dark" aria-current="page">Web Development</li>
                  </ol>
               </nav>
            </div>
         </div>
         ...
         <div class="col-lg-6 col-md-12 col-xs-12 d-flex align-items-stretch px-0">
            <div class="item-holder w-100">
               <div class="text text-end row py-5">
                  ...
                  <div class="col-12 fw-600 fs-md-17 fs-sm-15 fs-14 text-white mt-2">Before web development processes, we follow a few mandatory steps and explore the best way to develop the business web solutions using the top-class technology sets at the desired timeframe.</div>
               ...
               <div class="row">
                  <div class="col-md-6 col-sm-6 col-xs-12">
                     <div class="icon-area">
                        ...
                        <div class="col-12 fw-900 text-white fs-md-19 fs-sm-18 fs-17 lh-normal">Consulting</div>
                        <div class="col-12 fw-600 fs-sm-15 fs-14 text-white mt-2 ellipsis-2">We have a set of talented web developers with good years of experience in the field to analyze the client's business requirements and choose the best available technologies to implement to deliver successful results.</div>
                     </div>
                  </div>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                     <div class="icon-area">
                        ...
                        <div class="col-12 fw-900 text-white fs-md-19 fs-sm-18 fs-17 lh-normal">Explore and Plan</div>
                        <div class="col-12 fw-600 fs-sm-15 fs-14 text-white mt-2 ellipsis-2">Our intuitive web developers come up with the right project roadmap, know the business's complete needs, and then make a comprehensive documentation of the project to make sure that the web development we make matches the clients business.</div>
                     </div>
                  </div>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                     <div class="icon-area">
                        ...
                        <div class="col-12 fw-900 text-white fs-md-19 fs-sm-18 fs-17 lh-normal">Software Prototyping</div>
                        <div class="col-12 fw-600 fs-sm-15 fs-14 text-white mt-2 ellipsis-2">Our experienced web development team discusses and then develops a proof of concept to evaluate the long-lasting web application potential in real-time and assess your idea feasibility for implementing them in real-time.</div>
                     </div>
                  </div>
                  <div class="col-md-6 col-sm-6 col-xs-12">
                     <div class="icon-area">
         ...
         <div class="row justify-content-center">
            ...
            <div class="col-md-4 col-xs-6 text-center d-flex align-items-stretch mb-md-5 mb-4">
               <div class="development_services_box w-100 shadow">
                  ...
                  <div class="col-12 fw-900 text-theme1 fs-19 lh-normal tz" style="--tz:30px;">Technology Consulting Services</div>
                  <div class="col-12 fw-600 fs-md-16 fs-sm-15 fs-14 text-muted mt-3 tz" style="--tz:30px;">The functional domain expertise and resource experience of IMG Global Infotech web developers help you gain growth-centric ROI from your web development project. We offer technology and platform consulting, software upgradation consulting, and server & OS migration as a part of the technology consulting services.</div>
               </div>
            </div>
            <div class="col-md-4 col-xs-6 text-center d-flex align-items-stretch mb-md-5 mb-4">
               <div class="development_services_box w-100 shadow">
                  ...
                  <div class="col-12 fw-900 text-theme1 fs-19 lh-normal tz" style="--tz:30px;">Web Portal Development</div>
                  <div class="col-12 fw-600 fs-md-16 fs-sm-15 fs-14 text-muted mt-3 tz" style="--tz:30px;">We develop platforms that are user-friendly for your customers. The web development of us evaluates the objectives and requirements of the online business. We offer shopping portal development, Business (B2C and B2B) portal development, mailing, matrimony, and job portals as a part of the web portal development services.</div>
               </div>
            </div>
            <div class="col-md-4 col-xs-6 text-center d-flex align-items-stretch mb-md-5 mb-4">
               <div class="development_services_box w-100 shadow">
                  ...
                  <div class="col-12 fw-900 text-theme1 fs-19 lh-normal tz" style="--tz:30px;">Chatbots, ML, and Blockchain</div>
                  <div class="col-12 fw-600 fs-md-16 fs-sm-15 fs-14 text-muted mt-3 tz" style="--tz:30px;">We develop real-time and advanced chatbots with the help of the latest Machine Learning techniques, which help in business understanding and have a knowledge update. We offer Facebook based service chatbots, customer service website chatbots, and personalized chatbots for training purposes as a part of these services.</div>
               </div>
            </div>
            <div class="col-md-4 col-xs-6 text-center d-flex align-items-stretch mb-md-5 mb-4">
               <div class="development_services_box w-100 shadow">
                  ...
                  <div class="col-12 fw-900 text-theme1 fs-19 lh-normal tz" style="--tz:30px;">Product Re-Engineering</div>
                  <div class="col-12 fw-600 fs-md-16 fs-sm-15 fs-14 text-muted mt-3 tz" style="--tz:30px;">MG Global Infotech re-engineering and application integration services depend on the design, development, integration, deployment, and testing requirements to integrate unique data and functionality with modern platforms & architectures. We offer API Integration, Chrome extension, Plugin, data migration, legacy app, server integration, and Add-on as a part of the produce re-engineering services</div>
               </div>
            </div>
         </div>
      </div>
                  ...
                  <ul class="info-list mb-0 position-relative list-unstyled">
                     ...
                     <li>
                        ...
                        <div class="col-12 fw-normal fs-md-16 fs-sm-15 fs-14 text-muted mt-3">
                           ...
                           <strong class="d-block fw-bold text-theme1">Full-stack and Web :</strong> Symfony, Laravel, HTML 5, .NET, Java, Cake PHP, and PHP.
                        </div>
                     </li>
                     <li>
                        <span class="icon imgd img-star"></span>
                        <div class="col-12 fw-normal fs-md-16 fs-sm-15 fs-14 text-muted mt-3">
                           ...
                           <strong class="d-block fw-bold text-theme1">AI and Blockchain :</strong> Ethereum, Smart contract, Chatbot, Blockchain, Hyperledger, Machine Learning, and ERC 720/721
                        </div>
                     </li>
                  </ul>
               </div>
               ...
               <div class="row">
                  ...
                  <div class="col-12 mt-4">
                     <div class="row align-items-center">
                        ...
                        <div class="col fw-bold fs-md-18 fs-sm-17 fs-16 text-theme3 bg-white ms-n5 py-2 zi-0 rounded-pill ps-5 position-relative border-top border-theme3 border-4 border-bottom border-theme3 border-3">Motivated and highly creative teams</div>
                     </div>
                  </div>
                  <div class="col-12 mt-4">
                     <div class="row align-items-center">
                        ...
                        <div class="col fw-bold fs-md-18 fs-sm-17 fs-16 text-theme3 bg-white ms-n5 py-2 zi-0 rounded-pill ps-5 position-relative border-top border-theme3 border-4 border-bottom border-theme3 border-3">DevOps Enablement</div>
                     </div>
                  </div>
                  <div class="col-12 mt-4">
                     <div class="row align-items-center">
                        ...
                        <div class="col fw-bold fs-md-18 fs-sm-17 fs-16 text-theme3 bg-white ms-n5 py-2 zi-0 rounded-pill ps-5 position-relative border-top border-theme3 border-4 border-bottom border-theme3 border-3">Guaranteed innovation and creativity in the web created</div>
                     </div>
                  </div>
                  <div class="col-12 mt-4">
                     <div class="row align-items-center">
                        ...
                        <div class="col fw-bold fs-md-18 fs-sm-17 fs-16 text-theme3 bg-white ms-n5 py-2 zi-0 rounded-pill ps-5 position-relative border-top border-theme3 border-4 border-bottom border-theme3 border-3">Security and quality adherence</div>
                     </div>
                  </div>
                  <div class="col-12 mt-4">
                     <div class="row align-items-center">
                        ...
                        <div class="col fw-bold fs-md-18 fs-sm-17 fs-16 text-theme3 bg-white ms-n5 py-2 zi-0 rounded-pill ps-5 position-relative border-top border-theme3 border-4 border-bottom border-theme3 border-3">Non-disclosure agreement</div>
                     </div>
                  </div>
                  <div class="col-12 mt-4">
                     <div class="row align-items-center">
                        ...
                        <div class="col fw-bold fs-md-18 fs-sm-17 fs-16 text-theme3 bg-white ms-n5 py-2 zi-0 rounded-pill ps-5 position-relative border-top border-theme3 border-4 border-bottom border-theme3 border-3">Co-development team that produce reliable and efficient results</div>
                     </div>
                  </div>
                  <div class="col-12 mt-4">
                     <div class="row align-items-center">
                        ...
                        <div class="col fw-bold fs-md-18 fs-sm-17 fs-16 text-theme3 bg-white ms-n5 py-2 zi-0 rounded-pill ps-5 position-relative border-top border-theme3 border-4 border-bottom border-theme3 border-3">Transparency and integrity</div>
                     </div>
                  </div>
                  <div class="col-12 mt-4">
                     <div class="row align-items-center">
                        ...
                        <div class="col fw-bold fs-md-18 fs-sm-17 fs-16 text-theme3 bg-white ms-n5 py-2 zi-0 rounded-pill ps-5 position-relative border-top border-theme3 border-4 border-bottom border-theme3 border-3">Result-driven approaches and services</div>
                     </div>
                  </div>
                  <div class="col-12 mt-4">
                     <div class="row align-items-center">
                        ...
                        <div class="col fw-bold fs-md-18 fs-sm-17 fs-16 text-theme3 bg-white ms-n5 py-2 zi-0 rounded-pill ps-5 position-relative border-top border-theme3 border-4 border-bottom border-theme3 border-3">In-depth domain knowledge</div>
                     </div>
                  </div>
               </div>
            </div>
