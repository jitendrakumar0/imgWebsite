...
@push('meta')
   <!--  Title -->
   <title>Mobile App Development Company in Alwar | IMG Global Infotech</title>

   <!-- Required meta tags -->
   <meta name="title" content="Mobile App Development Company in Alwar | IMG Global Infotech" />
   <meta name="description" content="IMG Global Infotech is a leading mobile app development company in Alwar, we build high-quality & user-friendly mobile apps for Android & iOS devices." />

   <!-- Twitter Meta -->
   <meta name="twitter:title" content="Mobile App Development Company in Alwar | IMG Global Infotech">
   <meta name="twitter:description" content="IMG Global Infotech is a leading mobile app development company in Alwar, we build high-quality & user-friendly mobile apps for Android & iOS devices.
">
   <meta name="twitter:image" content="{{asset('/public')}}/assets/img/mobile-app-development-company-in-alwar/mobile-app-development-company-alwar.webp">

   <!-- Facebook Meta -->
   <meta property="og:url" content="{{asset('/')}}mobile-app-development-company-in-alwar.php">
   <meta property="og:title" content="Mobile App Development Company in Alwar | IMG Global Infotech">
   <meta property="og:description" content="IMG Global Infotech is a leading mobile app development company in Alwar, we build high-quality & user-friendly mobile apps for Android & iOS devices.">
   <meta property="og:image" content="{{asset('/public')}}/assets/img/mobile-app-development-company-in-alwar/mobile-app-development-company-alwar.webp">
   <meta property="og:image:secure_url" content="{{asset('/public')}}/assets/img/mobile-app-development-company-in-alwar/mobile-app-development-company-alwar.webp">
   ...
   <link rel="canonical" href="{{asset('/')}}mobile-app-development-company-in-alwar.php" />
   <meta name="robots" content="index, follow" />
@endpush
@push('styles')
   <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/owl/owl.carousel.min.css">
   <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/do-not-edit/css/mobile-app-development-company-in-alwar.min.css">
@endpush
@section('content')
                     ...
                     <div class="row pt-3 text-lg-start text-md-center text-center">
                        <div class="col-12">
                           <div class="row mx-0 pb-2">
                              <h1 class="d-none invisible">cccccc</h1>
                              <div class="col-12 heading fs-md-14 fs-12 left text-white">
							  <span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Mobile App Development <b>Company in Alwar</b></span>
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="col-lg-6 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-lg-end justify-content-md-center justify-content-center">
                        <div class="col-lg-8 col-md-5 col-7 position-relative">
                           <img class="w-100 position-relative tz" style="--tz:90px;" src="{{GETFOLDERPATH()}}/mobile-app-development-company-alwar.webp" alt="Mobile App Development Company Alwar">
            ...
            <div class="col-md-12">
               <nav aria-label="breadcrumb">
                  <ol class="breadcrumb mb-0">
                     ...
                     <li class="breadcrumb-item active fw-600 fs-lg-16 fs-md-15 fs-14 text-dark" aria-current="page">Mobile App Development Company In Alwar</li>
                  </ol>
               </nav>
            </div>
         </div>
               ...
               <div class="row align-items-center">
                  <div class="col-lg-5 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-center">
                        ...
                        <img class="w-100 position-relative" src="{{GETFOLDERPATH()}}/mobile-app-development-services.webp" alt="Mobile App Development Services">
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-7">
   ...
   <div class="container-fluid overflow-hidden why-we-are-section bg-white position-relative">
     ...
     <div class="container-fluid overflow-hidden new-portfolio position-relative">
         <div class="container py-md-5 py-4 position-relative ">
            ...
            <div class="col-lg-12 col-md-12">
                    <div class="portfolioBox ">
                        <img src="{{asset('/public')}}/assets/img/portfolio-section/royal11-project.webp" class="img-fluid w-100 rounded-2 border border-1 p-1" alt="Royal 11" >
                             <div class="portfolioBoxContent">
                            <h4>Royal 11 </h4>
                            <p>Fantasy Sports App</p>
                        </div>
...
@push('scripts')
   ...
   <script src="{{asset('/public')}}/assets/js/mobile-app-development-company-in-alwar.min.js"></script>
