            ...
            <div class="col-md-12">
               <nav aria-label="breadcrumb">
                  <ol class="breadcrumb mb-0">
                     ...
                     <li class="breadcrumb-item"><a class="fw-600 fs-lg-16 fs-md-15 fs-14 text-theme2 text-decoration-none" href="{{asset('/mobile-app-development.php')}}">Industry</a></li>
                     <li class="breadcrumb-item active fw-600 fs-lg-16 fs-md-15 fs-14 text-dark" aria-current="page">Diet and Nutrition App Development</li>
                  </ol>
               </nav>
            </div>
         </div>
                     ...
                     <div class="row">
                        ...
                        <div class="col-12 heading fs-md-14 fs-12 left text-dark">
                           <span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Trusted Fitness Mobile App Development<br><b> Company In India</b></span></div>
                                 ...
                                 <div class="col-12 fw-600 fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-muted text-lg-start text-center mt-3">With years of experience and knowledge of using advanced tools and software, IMG Global Infotech has designed the aptest fitness application.
                                 ...
                                 <div class="col-12 fw-600 fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-muted text-lg-start text-center mt-3">Our app offers personalised workout plans, nutrition tracking, and progress monitoring to help users achieve their physical wellness. 
            ...
            <div class="row d-flex align-items-center ">
                <div class="col-lg-12 col-md-12 col-12 useradmin pt-0 pt-lg-0 pt-md-0 mb-lg-4 d-flex justify-content-center mx-auto p-0">  
                     <ul class="nav nav-tabs border-0">
                           <li class="nav-item ">
                              <a class="nav-link active btn text-dark wave-1 fs-lg-19 fs-md-16 fs-13 fw-bold my-3 py-2 mx-2 pe-lg-4 pe-md-4 pe-2 ps-lg-4 ps-md-4 ps-2" data-bs-toggle="tab" href="#home"> User Name </a>
                           </li>
                           <li class="nav-item">
                              <a class="nav-link btn text-dark fs-lg-19 fs-md-16 fs-13 fw-bold my-3 py-2 mx-2 pe-lg-4 pe-md-4 pe-2 ps-lg-4 ps-md-4 ps-2" data-bs-toggle="tab" href="#menu1"> Doctor App</a>
                           </li>
                           <li class="nav-item">
                              <a class="nav-link btn text-dark fs-lg-19 fs-md-16 fs-13 fw-bold my-3 py-2 mx-2 pe-lg-4 pe-md-4 pe-2 ps-lg-4 ps-md-4 ps-2" data-bs-toggle="tab" href="#menu2"> Admin Panel</a>
                           </li>

                            <li class="nav-item">
                              <a class="nav-link btn text-dark fs-lg-19 fs-md-16 fs-13 fw-bold my-3 py-2 mx-2 pe-lg-4 pe-md-4 pe-2 ps-lg-4 ps-md-4 ps-2" data-bs-toggle="tab" href="#menu3">Additional Features</a>
                           </li>
                     </ul>
                 </div>
                  ...
                  <div class="container banner-cta1 py-lg-4 py-md-4 py-3 py-2 zi-2 position-relative mt-lg-5 mt-md-5 mt-5">
                     <div class="row align-items-center mx-lg-5 mx-md-2 mx-0">
                        <div class="col-lg-6 col-md-6 col-12">
                           <div class="col-lg-12 col-md-12 col-9 fw-600 fs-md-18 fs-lg-28 fs-17 text-dark fw-900 text-md-start">Your Key to Launch an Enticing Doctor Appointment App is Here.</div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-9 d-flex justify-content-lg-start justify-content-md-start justify-content-start py-2">
                               <a href="{{asset('/diet-and-nutrition-app-development.php#contactWithUss')}}" class="btn expert-btn fs-lg-17 fs-md-14 fs-14 fw-bold py-3 px-md-4 px-4 text-white">
                     ...
                     <div class="container py-lg-4 py-2 zi-2 position-relatbive p-0">
                           <div class="row mx-0">
                              ...
                              <div class="col-12 heading fs-md-14 fs-12 center text-dark">
                                 ...
                                 <div class="col-lg-10 col-md-12 col-12 mt-2 fw-bold fs-lg-16 fs-md-16 fs-sm-17 fs-16 text-lg-center text-center mx-auto">We provide a cohesive solution by incorporating 
                                       ...
                                       <div class="development_services_boxss w-100 border border-1 h-100">
                                          <div class="row align-items-center">
                                            <div class="col-lg-3 col-md-12 col-12 text-center mb-lg-0 mb-md-0 mb-2">
                                             ...
                                             <div class="col-lg-9 col-md-12 col-12 text-balck fs-lg-18 fs-md-14 fs-16 lh-normal fw-900 p-0" style="--tz:30px;">Video Tutorials</div>
                                          </div>
                                       <div class="col-12 fw-600 fs-lg-16 fs-md-15 fs-15 text-muted mt-lg-3 mt-md-2 tz" style="--tz:30px;">Offer a variety of workout programmes, such as cardio, strength, yoga, and pilates, that users can access on-demand. </div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-lg-4 col-md-6 col-12 mb-md-4 mb-4">
                                       <div class="development_services_boxss w-100 border border-1 h-100">
                                          <div class="row align-items-center">
                                             ...
                                             <div class="col-lg-9 col-md-12 col-12 text-balck fs-lg-18 fs-md-14 fs-16 lh-normal fw-900 p-0" style="--tz:30px;">Tracking and Analytics</div>
                                          </div>
                                       <div class="col-12 fw-600 fs-lg-16 fs-md-15 fs-15 text-muted mt-lg-3 mt-md-2 tz" style="--tz:30px;">Users can easily track their progress over time, monitor their health, and track calories
                                 ...
                                 <div class="col-lg-4 col-md-6 col-12 mb-md-4 mb-4">
                                       <div class="development_services_boxss w-100 border border-1 h-100">
                                          <div class="row align-items-center">
                                             ...
                                             <div class="col-lg-9 col-md-12 col-12 text-balck fs-lg-18 fs-md-14 fs-16 lh-normal fw-900 p-0" style="--tz:30px;">Wearable Device Integration</div>
                                          </div>
                                       <div class="col-12 fw-600 fs-lg-16 fs-md-15 fs-15 text-muted mt-lg-3 mt-md-2 tz" style="--tz:30px;">Integrate with wearable devices such as fitness trackers and smartwatches to track workouts and provide personalised recommendations.</div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-lg-4 col-md-6 col-12 mb-md-4 mb-4">
                                       <div class="development_services_boxss w-100 border border-1 h-100">
                                          <div class="row align-items-center">
                                             ...
                                             <div class="col-lg-9 col-md-12 col-12 text-balck fs-lg-18 fs-md-14 fs-16 lh-normal fw-900 p-0" style="--tz:30px;">Notifications</div>
                                          </div>
                                       <div class="col-12 fw-600 fs-lg-16 fs-md-15 fs-15 text-muted mt-lg-3 mt-md-2 tz" style="--tz:30px;">Provide users with notifications for upcoming live classes, reminders for scheduled workouts, and progress updates.</div>
                                    </div>
                                 </div>
                                       ...
                                       <div class="development_services_boxss w-100 border border-1 h-100">
                                          <div class="row align-items-center">
                                           <div class="col-lg-3 col-md-12 col-12 text-center mb-lg-0 mb-md-0 mb-2">
                                             ...
                                             <div class="col-lg-9 col-md-12 col-12 text-balck fs-lg-18 fs-md-14 fs-16 lh-normal fw-900 p-0" style="--tz:30px;">Customisation</div>
                                          </div>
                                       <div class="col-12 fw-600 fs-lg-16 fs-md-15 fs-15 text-muted mt-lg-3 mt-md-2 tz" style="--tz:30px;">Allow users to customise their experience by setting workout preferences, creating personalised workout plans, and adjusting the app's settings.</div>
                                    </div>
                                 </div>
                                 ...
                                 <div class="col-lg-4 col-md-6 col-12 mb-md-4 mb-4">
                                       <div class="development_services_boxss w-100 border border-1 h-100">
                                          ...
                                          <div class="col-lg-3 col-md-12 col-12 text-center mb-lg-0 mb-md-0 mb-2">
                                             ...
                                             <div class="col-lg-9 col-md-12 col-12 text-balck fs-lg-18 fs-md-14 fs-16 lh-normal fw-900 p-0" style="--tz:30px;">Support</div>
                                          </div>
                                       <div class="col-12 fw-600 fs-lg-16 fs-md-15 fs-15 text-muted mt-lg-3 mt-md-2 tz" style="--tz:30px;">Offer customer support through chat or email to help users with any technical issues or questions they may have.</div>
                                    </div>
                                 </div>
                            </div>
                         </div>
             ...
             <!-- Nav tabs -->
                     <ul class="nav nav-tabs mx-3 mt-lg-0 mt-md-0 mt-3" role="tablist">
                        <li class="nav-item w-lg-100 w-md-50 w-100">
                           <a class="nav-link active btn text-dark fs-lg-17 fs-md-17 fs-13 fw-bold my-1 py-2 mx-1 pe-lg-2 pe-md-1 pe-2 ps-lg-3 ps-md-1 ps-2 border border-1" data-bs-toggle="tab" href="#home1">Sign-In</a>
                        </li>
                        <li class="nav-item w-lg-100 w-md-50 w-100">
                           <a class="nav-link btn text-dark fs-lg-17 fs-md-17 fs-13 fw-bold my-1 py-2 mx-1 pe-lg-2 pe-md-1 pe-2 ps-lg-3 ps-md-1 ps-2 border border-1" data-bs-toggle="tab" href="#menu122">Video Turtorial</a>
                        </li>
                        <li class="nav-item w-lg-100 w-md-50 w-100">
                           <a class="nav-link btn text-dark fs-lg-17 fs-md-17 fs-13 fw-bold my-1 py-2 mx-1 pe-lg-2 pe-md-1 pe-2 ps-lg-3 ps-md-1 ps-2 border border-1" data-bs-toggle="tab" href="#menu23"> Count Calories</a>
                        </li>
                        <li class="nav-item w-lg-100 w-md-50 w-100">
                           <a class="nav-link btn text-dark fs-lg-17 fs-md-17 fs-13 fw-bold my-1 py-2 mx-1 pe-lg-2 pe-md-1 pe-2 ps-lg-3 ps-md-1 ps-2 border border-1" data-bs-toggle="tab" href="#menu24">Help you connect with Experts</a>
                        </li>
                  ...
                  <div class="tab-content">
                     <div id="home1" class="container tab-pane active p-0">
                          <div class="row align-items-center justify-content-center">
                              ...
                              <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-27 fs-md-25 fs-20 lh-normal fw-900 p-0">Sign-In</div>
                              <div class="col-12 fw-600 fs-lg-17 fs-md-16 fs-16 text-muted mt-lg-2 mt-md-2 tz" style="--tz:30px;">This solution allows users to create their profile and sign 
                     ...
                     <div id="menu122" class="container tab-pane fade p-0">
                         <div class="row align-items-center justify-content-center">
                              ...
                              <div class="col-lg-9 col-md-9 col-sm-12 col-12">
                              <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-27 fs-md-25 fs-20 lh-normal fw-900 p-0">Video Turtorial</div>
                              <div class="col-12 fw-600 fs-lg-17 fs-md-16 fs-16 text-muted mt-lg-2 mt-md-2 tz" style="--tz:30px;">Users will be provided with a bank of videos and live consultancy of professionals that help them in their fat loss journey. The programme is designed for every user, 
                     ...
                     <div id="menu23" class="container tab-pane fade p-0">
                        <div class="row align-items-center justify-content-center">
                           ...
                           <img class="w-md-80 w-80 position-relative border border-3 p-2" src="{{GETFOLDERPATH()}}/count-calories.webp" alt="Count Calories">
                              ...
                              <div class="col-lg-9 col-md-9 col-sm-12 col-12">
                              <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-27 fs-md-25 fs-20 lh-normal fw-900 p-0">Count Calories</div>
                              <div class="col-12 fw-600 fs-lg-17 fs-md-16 fs-16 text-muted mt-lg-2 mt-md-2 tz" style="--tz:30px;">The app will track your steps and burned calories so users can monitor their daily weight loss journey. Additionally, 
                       ...
                       <div id="menu24" class="container tab-pane fade p-0">
                        <div class="row align-items-center justify-content-center">
                            ...
                            <img class="w-md-80 w-80 position-relative border border-3 p-2" src="{{GETFOLDERPATH()}}/help-experts.webp" alt="Help you connect with Experts">
                              ...
                              <div class="col-lg-9 col-md-9 col-sm-12 col-12">
                              <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-27 fs-md-25 fs-20 lh-normal fw-900 p-0">Help you connect with Experts</div>
                              <div class="col-12 fw-600 fs-lg-17 fs-md-16 fs-16 text-muted mt-lg-2 mt-md-2 tz" style="--tz:30px;">Users can virtually connect with the experts and subscribe to a monthly plan for their fitness. A professional can suggest
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mb-lg-0 item">
               <div class="box h-100 flex-column d-flex px-lg-3 px-md-3 px-3 py-lg-4 py-md-4 py-4">
                  <figure>
                     ...
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-20 fs-18 lh-normal fw-900 mb-1 text-white">Grocery App Development</div>
          ...
          <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mb-lg-0 item">
               <div class="box h-100 flex-column d-flex px-3 py-4">
                  <figure>
                     ...
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-20 fs-18 lh-normal fw-900 mb-1  text-white">Jewellery App Development</div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mb-lg-0 item">
               <div class="box h-100 flex-column d-flex px-3 py-4" >
                  <figure>
                     ...
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-20 fs-18 lh-normal fw-900 mb-1 text-white">Food Delivery App Development</div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mb-lg-0 item">
               <div class="box h-100 flex-column d-flex px-3 py-4">
                  <figure>
                     ...
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-20 fs-18 lh-normal fw-900 mb-1  text-white">Healthcare App Development</div>
           ...
           <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mb-lg-0 item">
               <div class="box h-100 flex-column d-flex px-3 py-4">
                  <figure>
                     ...
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-20 fs-18 lh-normal fw-900 mb-1  text-white">Pharmacy App Development</div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mb-lg-0 item">
               <div class="box h-100 flex-column d-flex px-3 py-4">
                  <figure>
                     ...
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-20 fs-18 lh-normal fw-900 mb-1  text-white">Doctor App Development</div>
               ...
               <div class="box h-100 flex-column d-flex px-3 py-4">
                  <figure>
                     ...
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-19 fs-18 lh-normal fw-900 mb-1  text-white">Fashion App Development</div>
