...
@push('meta')
   ...
   <meta property="og:description" content="IMG Global Infotech is a top-rated mobile application development company that provides mobile application development services across the globe.">
   ...
   <meta name="classification" content="app development, mobile app development, mobile application development company, mobile app development services, custom mobile app development, app development agency, android application development company, android development services, android app development company in India, android application development services, android app development in India, best android app development company, android mobile app development company, top android app development company, hire android app developer, hire Android Developers, ios app development in India, iphone app development company, iphone application development company, iphone application development, iphone app development services, iphone app development, ios application development services, ios app development company, ios application development, ios mobile app development, ios app development, ios app development company in India, custom ios app development company" />
...
Offering custom-fit mobile app development services to build high-performing mobility solutions suiting your business requirements. 
...
<img class="w-100 position-relative" src="{{GETFOLDERPATH()}}/mobile-app-development-company.webp" width="100" height="auto" alt="Mobile App Development Services"></div>
@endsection('hero_img')
@include('inner-page-section.hero.index')
            ...
            <div class="col-md-12">
               <nav aria-label="breadcrumb">
                  <ol class="breadcrumb mb-0">
                     ...
                     <li class="breadcrumb-item active fw-l fs-lg-16 fs-md-15 fs-14 text-dark" aria-current="page">Mobile App Development Company</li>
                  </ol>
               </nav>
            </div>
         </div>
   ...
   <div class="container-fluid overflow-hidden best-app-development bg-white position-relative">
      <div class="container pt-lg-5 pt-md-4 py-4 position-relative zi-2">
                  ...
                  <div class="col-lg-5 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-center">
                        <div class="col-lg-10 col-md-5 col-7 position-relative leftside">
                          <img src="{{GETFOLDERPATH()}}/leading-mobile-application-development-company.webp" class="w-100" alt="Leading Mobile Application Development Company" width="100" height="100%">
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-7">
                     <div class="row">
                        <div class="col-12">
                           <div class="row mx-0 pb-2 pt-lg-0 pt-3">
                              ...
                              <div class="col-12 heading fs-md-14 fs-12 left text-lg-start text-md-center"><span class="fs-xl-31 fs-lg-27 fs-md-24 fs-20">Leading Mobile Application <b>  Development Company </b></span></div>
                           </div>
                        </div>
                        <div class="col-12 fw-l fs-lg-16 fs-md-16 fs-sm-16 fs-16 text-muted text-lg-start text-center mt-3">Whether you are looking for native mobile or cross-platform apps, our team of highly skilled mobile app developers will help you transform your innovative app idea into a feature-packed, top-performing mobile app. We aim for a seamless user experience and have successfully delivered 250+ custom-mobile app development projects over time.</div>
                        <div class="col-12 fw-l fs-lg-16 fs-md-16 fs-sm-16 fs-16 text-muted text-lg-start text-center mt-3">Being a leading mobile app development company, we provide a complete range of mobile app development solutions to increase your customer engagement, increase sales, and boost your business growth. We adjust to our client’s needs and develop engaging apps meeting their expectations.</div>
                         ...
                         <div class="col-lg-4 col-md-4 col-12 mb-3 pd-0">     
                              <div class="position-relative border-1 border-end rounded p-1 why-choose">
                                 ...
                                 <div class="col-12 mb-2 text-center">
                                    <img class="position-relative" src="{{GETFOLDERPATH()}}/apps-developed.webp"  alt="Apps Developed" height="38px" width="38px">
                                    </div>
                                    <div class="col-12 text-muted  fs-xl-15 fs-lg-15 text-center mb-0 fw-m">250+ <span class="d-block fw-l">Apps Developed</span></div>
                                 </div>
                              </div>
                            </div>
                            ...
                            <div class="col-lg-4 col-md-4 col-12 mb-3 pd-0">     
                              <div class="position-relative border-1 border-end rounded p-1 why-choose">
                                 <div class="row align-items-center pt-2 pb-2">
                                 <div class="col-12 mb-2 text-center">
                                    <img class="position-relative" src="{{GETFOLDERPATH()}}/talented-squad.webp"  alt="Talented squad"  height="38px" width="38px">
                                    </div>
                                    <div class="col-12 text-muted  fs-xl-15 fs-lg-15 text-center mb-0 fw-m">100+ <span class="d-block fw-l">Talented Squad</span></div>
                                 </div>
                              </div>
                           </div>
                           ...
                           <div class="col-lg-4 col-md-4 col-12 mb-3 pd-0">     
                              <div class="position-relative border-1 rounded p-1 why-choose">
                                 <div class="row align-items-center pt-2 pb-2">
                                 <div class="col-12 mb-2 text-center">
                                    <img class="position-relative" src="{{GETFOLDERPATH()}}/development-experience.webp"  alt="Development Experience"  height="38px" width="38px">
                                    </div>
                                    <div class="col-12 text-muted  fs-xl-15 fs-lg-15 text-center mb-0 fw-m">8+ <span class="d-block fw-l">Development Experience </span></div>
                                 </div>
                              </div>
                           </div>
                    </div>
         ...
         <div class="container banner-cta1 py-lg-5 py-md-5 py-3 py-2 zi-2 position-relative mt-lg-0 mt-md-1 mt-35 mt-lg-0 mb-lg-5 mb-md-5 mb-5" >
               <div class="row align-items-center mx-lg-5 mx-md-2 mx-0">
                  <div class="col-lg-8 col-md-8 col-12">
                     <h3 class="d-none invisible">Schedule a Free Consultation with Our Mobile App Development Experts!</h3>
                 
                     <div class="col-12 fs-lg-28 fs-md-25 fs-17 text-white text-md-start text-center fw-m">Schedule a Free Consultation with Our Mobile App Development Experts!</div>
                   
                  </div>
                     <div class="col-lg-4 col-md-4 col-12 d-flex justify-content-lg-end justify-content-md-end justify-content-center py-2">
                           <a href="#contact-with-us-section" class="btn expert-btn fs-lg-20 fs-md-17 fs-14 fw-m py-3 px-md-4 px-4 bg-white">
    ...
    <!-- Our Mobile App Development Services  -->
                  ...
                  <div class="row">
                     <div class="col-12">
                        <div class="row mx-0 pb-4 pt-lg-0 pt-4">
                           ...
                           <div class="col-12 heading fs-md-14 fs-12 center"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20">Our Mobile App Development <b>  Services </b></span></div>
                           <div class="col-lg-9 col-md-12 col-12 mt-2 fw-l fs-lg-16 fs-md-16 fs-sm-17 fs-16 text-lg-center text-center mx-auto">
                              Our mobile app developers hold years of experience in developing solutions that attain market requirements, strengthen clients' brand identities, and motivate business expansion.</div>
                        </div>
                     </div>
                  </div>
                        ...
                        <div class="col-lg-8 col-md-12 col-12 p-0">
                           <div class="row ">
                                   <div class="col-md-6" id="main1">
                                       <div class="main app-service  bg-white text-left d-flex align-items-start position-relative shadow h-100 rounded rounded-5 px-lg-4 px-md-4 mb-4 pt-lg-3 pt-3 px-3">   
                                          <div class="row d-flex align-items-center justify-content-center">
                                                   <div class="col-lg-7 col-md-7 col-7 p-md-0"> 
                                                      <h4 class="d-none invisible">Native App Development </h4>
                                                         <div class="col-12 text-left fw-m fs-lg-17 fs-md-17 fs-17 mt-0 text-dark">Native  App <span class="d-block">Development </span> </div>
                                                         <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 text-muted mt-1">Transforming your ideas into Intuitive Native app development </div>
                                                   </div>
                                                   <div class="col-lg-5 col-md-5 col-5 text-center position-relative p-md-0"> 
                                                      <div class="services-icons ps-lg-5 ps-3 pt-4 position-relative services-icons pb-lg-3"> 
                                                         <img src="{{GETFOLDERPATH()}}/native-app-development.webp" class="w-lg-100 w-md-100 w-90 over-icon pt-2 pe-3"  height="auto" width="100"  alt="Native App Development">
                                                            
                                                      </div>
                                                      <a href="#0" class="text-decoration-none mt-md-5 mt-4 col-12 fs-14 link-btn ">Read More <i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i> </a>
                                                </div>
                                          </div>
                                       </div>  
                                     </div>
                                     ...
                                     <div class="col-md-6 mb-lg-0 mb-4" id="main2">
                                     <div class="main app-service  bg-white text-left d-flex align-items-start position-relative shadow h-100 rounded rounded-5 px-lg-4 px-md-4 mb-4 pt-lg-3 pt-3 px-3 mt-lg-0 mt-3"> 
                                          <div class="row d-flex align-items-center justify-content-center">
                                                   <div class="col-lg-7 col-md-7 col-7 p-md-0"> 
                                                      <h4 class="d-none invisible">Cross-platform App Development</h4>
                                                         <div class="col-12 text-left fw-m fs-lg-17 fs-md-17 fs-17 mt-0 text-dark">Cross-platform App  <span class="d-block">Development </span> </div>
                                                         <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 text-muted mt-1">Elevating your brand with cross-platform app development  </div>
                                                   </div>
                                                   <div class="col-lg-5 col-md-5 col-5 text-center position-relative p-md-0"> 
                                                       <div class="services-icons ps-lg-5 ps-3 pt-4 position-relative services-icons pb-lg-3"> 
                                                         <img src="{{GETFOLDERPATH()}}/crossplatform.webp" class="w-lg-100 w-md-100 w-90 over-icon pt-2 pe-3"  width="100"  alt="Cross Platform App Development">
                                                      </div>
                                                      <a href="#0" class="text-decoration-none mt-md-5 mt-4 col-12 fs-14 link-btn ">Read More <i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i> </a>
                                                </div>
                                          </div>
                                    ...
                                    <div class="container p-0 mt-lg-4 mt-md-3 mt-sm-2 mt-2" id="box1" style="display:none;"> 
                                          <div class="row d-flex align-items-center justify-content-center p-0">
                                             <div class="col-lg-4 col-md-6 col-12"> 
                                                <div class="app-service p-lg-4 p-md-4 p-3 bg-white text-left d-flex align-items-start position-relative shadow h-100 rounded rounded-5 p-md-4 mb-2">   
                                                
                                                <div class="row ">
                                                      <div class="col-lg-7 col-md-7 col-7 p-md-0"> 
                                                      <h4 class="d-none invisible">Android App Development </h4>
                                                            <div class="col-12 text-left fw-m fs-lg-17 fs-md-17 fs-17 mt-0 text-dark">Android App <span class="d-block">Development </span> </div>
                                                            <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 text-muted mt-1 ">Using in-demand and advanced technologies along with our industry expertise, our team of full-stack app developers builds successful Android apps that may help you engage more customers and drive increased ROI.  </div>
                                                      </div>
                                                      <div class="col-lg-5 col-md-5 col-5 text-center position-relative p-md-0"> 
                                                       <div class="services-icons ps-lg-5 ps-3 pt-4 position-relative services-icons pb-lg-3"> 
                                                         <img src="{{GETFOLDERPATH()}}/android.webp" class="w-lg-100 w-md-100 w-90 over-icon pt-2 pe-3" height="auto" width="100"  alt="Android App Development">
                                                      </div>
                                                      <a href="{{asset('/android-application-development.php')}}" class="text-decoration-none mt-md-5 mt-4 col-12 fs-14 link-btn ">Click Now <i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i> </a>
                                                </div>
                                                </div>
                                             </div>
                                         </div>
                                         ...
                                         <div class="col-lg-4 col-md-6 col-12"> 
                                                ...
                                                <div class="row ">
                                                      <div class="col-lg-7 col-md-7 col-7 p-md-0"> 
                                                      <h4 class="d-none invisible">iOS App Development </h4>
                                                            <div class="col-12 text-left fw-m fs-lg-17 fs-md-17 fs-17 mt-0 text-dark">iOS App  <span class="d-block">Development </span> </div>
                                                            <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 text-muted mt-1">Our team of professionals has been offering iOS app development services to clients worldwide, building stable, fully-fledged, and scalable apps, and attained a wealth of proficiency across varied industries. </div>
                                                      </div>
                                                      <div class="col-lg-5 col-md-5 col-5 text-center position-relative p-md-0"> 
                                                       <div class="services-icons ps-lg-5 ps-3 pt-4 position-relative services-icons pb-lg-3"> 
                                                         <img src="{{GETFOLDERPATH()}}/ios.webp" class="w-lg-100 w-md-100 w-90 over-icon pt-2 pe-3" height="auto" width="100"  alt="iOS App Development">
                                                      </div>
                                                      <a href="{{asset('/ios-app-development.php')}}" class="text-decoration-none mt-md-5 mt-4 col-12 fs-14 link-btn ">Click Now<i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i> </a>
                                                </div>
                                                </div>
                                             </div>
                                         </div>
                                         ...
                                         {{-- <div class="col-lg-4 col-md-6 col-12"> 
                                                <div class="app-service p-lg-4 p-md-4 p-3 bg-white text-left d-flex align-items-start position-relative shadow h-100 rounded rounded-5 p-md-4 mb-2">   
                                                   <div class="row ">
                                                      <div class="col-lg-7 col-md-7 col-7 p-md-0"> 
                                                      <h4 class="d-none invisible">iPad App Development </h4>
                                                            <div class="col-12 text-left fw-m fs-lg-17 fs-md-17 fs-17 mt-0 text-dark">iPad App  <span class="d-block">Development </span> </div>
                                                            <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 text-muted mt-1">Holding a deep understanding and skills in native iPad app development services, IMG Global Infotech's talented app developers create the best iPad applications that add value to client’s businesses. </div>
                                                      </div>
                                                      <div class="col-lg-5 col-md-5 col-5 text-center position-relative p-md-0"> 
                                                       <div class="services-icons ps-lg-5 ps-3 pt-4 position-relative services-icons pb-lg-3"> 
                                                         <img src="{{GETFOLDERPATH()}}/ipadapp-development.webp" class="w-lg-100 w-md-100 w-90 over-icon pt-2 pe-3" height="auto" width="100"  alt="iPad App Development">
                                                      </div>
                                                      <a href="#0" class="text-decoration-none mt-md-5 mt-4 col-12 fs-14 link-btn ">Visit Now <i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i> </a>
                                                </div>
                                                </div>
                                             </div>
                                         </div> --}}
                                   ...
                                   <div class="container p-0 mt-lg-4 mt-md-3 mt-sm-2 mt-1 " id="box2" style="display:none;"> 
                                       <div class="row d-flex align-items-center justify-content-center p-0">
                                             <div class="col-lg-4 col-md-6 col-12"> 
                                                <div class="app-service p-lg-4 p-md-4 p-3 bg-white text-left d-flex align-items-start position-relative shadow h-100 rounded rounded-5 p-md-4 mb-2">   
                                                ...
                                                <div class="row ">
                                                      <div class="col-lg-7 col-md-7 col-7 p-md-0"> 
                                                      <h4 class="d-none invisible">React Native App Development </h4>
                                                            <div class="col-12 text-left fw-m fs-lg-17 fs-md-17 fs-17 mt-0 text-dark">React Native App <span class="d-block">Development </span> </div>
                                                            <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 text-muted mt-1">IMG Global Infotech is skilled at developing secure, top-performing, intuitive, and secure native apps for iOS and Android platforms. We assist our clients in boosting their conversion rates and increasing customer loyalty.  </div>
                                                      </div>
                                                      <div class="col-lg-5 col-md-5 col-5 text-center position-relative p-md-0"> 
                                                       <div class="services-icons ps-lg-5 ps-3 pt-4 position-relative services-icons pb-lg-3"> 
                                                         <img src="{{GETFOLDERPATH()}}/reactnative.webp" class="w-lg-100 w-md-100 w-90 over-icon pt-2 pe-3" height="auto" width="100"  alt="React Native App Development">
                                                      </div>
                                                      <a href="#0" class="text-decoration-none mt-md-5 mt-4 col-12 fs-14 link-btn ">Visit Now <i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i> </a>
                                                </div>
                                                </div>
                                         ...
                                         <div class="col-lg-4 col-md-6 col-12"> 
                                                <div class="app-service p-lg-4 p-md-4 p-3 bg-white text-left d-flex align-items-start position-relative shadow h-100 rounded rounded-5 p-md-4 mb-2">   
                                                   <div class="row ">
                                                      <div class="col-lg-7 col-md-7 col-7 p-md-0"> 
                                                      <h4 class="d-none invisible">Flutter App Development  </h4>
                                                            <div class="col-12 text-left fw-600 fs-lg-17 fs-md-17 fs-17 mt-0 text-dark">                                                     
                                                                <h4 class="d-none invisible">Flutter App Development  </h4>   </div>
                                                                <div class="col-12 text-left fw-m fs-lg-17 fs-md-17 fs-17 mt-0 text-dark">Flutter App  <span class="d-block">Development </span> </div>
                                                            <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 text-muted mt-1">IMG Global Infotech is a leading mobile and web app development company that delivers customized app development services using Google's innovative framework, Flutter. We help you design, build, test, and roll out full-fledged Flutter apps. </div>
                                                      </div>
                                                      <div class="col-lg-5 col-md-5 col-5 text-center position-relative p-md-0"> 
                                                       <div class="services-icons ps-lg-5 ps-3 pt-4 position-relative services-icons pb-lg-3"> 
                                                         <img src="{{GETFOLDERPATH()}}/flutter.webp" class="w-lg-100 w-md-100 w-90 over-icon pt-2 pe-3" alt="Flutter App Development  " height="auto" width="100">
                                                      </div>
                                                      <a href="#0" class="text-decoration-none mt-md-5 mt-4 col-12 fs-14 link-btn ">Visit Now <i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i> </a>
                                                </div>
                                                </div>
                        ...
                        <div class="row d-flex align-items-center justify-content-center">
                              <div class="col-12">
                                 <div class="row d-flex align-items-center justify-content-center mx-0 pb-3">
                                       ...
                                       <div class="col-12 heading fs-md-14 fs-12 center text-dark"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20">Mobile App <b> Development Workflow </b></span></div>
                                         <div class="col-lg-10 col-md-11 col-12">
                                          <div class="row d-flex align-items-center justify-content-center">                              
                                             <div class="col-12 fs-md-17 fs-sm-15 fs-14 text-dark py-4 text-md-center text-center fw-l"> We believe that our employees are our biggest strength, we can not achieve our goals if your team is not on board. That is why we put our team first in everything.</div>
                                       </div>
                                    </div>
                                 </div>
                              </div>
                           ...
                           <div class="row d-flex align-items-center justify-content-center mt-md-4">
                              <div class="col-xl-11 col-lg-11 col-12">
                                 <div class="row">
                                    ...
                                    <div class="love-working-boxs position-relative">
                                          <div class="arrow-left"></div>
                                          <div class="row love-working py-2 h-100">
                                             <div class="col-md-3 col-12 love-icons">
                                             <span><img class="w-100 hover-img0" src="{{GETFOLDERPATH()}}/requirementdocumentation.webp" alt="Requirement Documentation"></span> 
                                             <span><img class="w-100 hover-img1" src="{{GETFOLDERPATH()}}/requirementdocumentation-white.webp" alt="Requirement Documentation"></span> 
                                          </div>
                                          <div class="col-md-9 col-12 position-relative ps-md-0 ps3">
                                             <div class="col-auto count position-absolute right-15px top-n15px">01</div>
                                             <h4 class="d-none invisible">Requirement Documentation</h4>
                                                <div class="col-12 fw-m fs-lg-20 fs-md-20 fs-20 text-capitalize flow-head"> Requirement Documentation</div>
                                                <div class="row"><div class="col-1"> <i class="imgd img-long-arrow-right position-relative me-2 text-muted"></i></div><div class="col-11 fw-l fs-lg-15 fs-md-15 fs-15 text-muted justify ps-lg-0 ps-md-0 ps-2">Requirements gathering and analysis</div></div>
                                                <div class="row"><div class="col-1"> <i class="imgd img-long-arrow-right position-relative me-2 text-muted"></i></div><div class="col-11 fw-l fs-lg-15 fs-md-15 fs-15 text-muted justify ps-lg-0 ps-md-0 ps-2">Outline project scope, user needs, features, and functionalities</div></div>
                                                <div class="row"><div class="col-1"> <i class="imgd img-long-arrow-right position-relative me-2 text-muted"></i></div><div class="col-11 fw-l fs-lg-15 fs-md-15 fs-15 text-muted justify ps-lg-0 ps-md-0 ps-2">Recommend suitable and latest solutions.</div></div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-12 overflow2 position-relative ">
                                       <div class="love-working-boxs position-relative">
                                          ...
                                          <div class="row love-working py-lg-4 py-md-4 py-2 h-100">
                                             <div class="col-md-3 col-12 love-icons">
                                             <span><img class="w-100 hover-img0" src="{{GETFOLDERPATH()}}/wireframing.webp" alt="Wireframing"></span> 
                                             <span><img class="w-100 hover-img2" src="{{GETFOLDERPATH()}}/wireframing-white.webp" alt="Wireframing"></span> 
                                          </div>
                                          <div class="col-md-9 col-12 position-relative ps-md-0 ps-3">
                                             <div class="col-auto count position-absolute right-15px top-n25px">02</div>
                                             <h4 class="d-none invisible">Wireframing</h4>
                                                <div class="col-12 fw-m fs-lg-20 fs-md-20 fs-20 text-capitalize"> Wireframing </div>
                                                <div class="row"><div class="col-1"> <i class="imgd img-long-arrow-right position-relative me-2 text-muted"></i></div><div class="col-11 fw-l fs-lg-15 fs-md-15 fs-15 text-muted justify ps-lg-0 ps-md-0 ps-2">Create a visual representation of the app's layout and user interface.</div></div>
                                                <div class="row"><div class="col-1"> <i class="imgd img-long-arrow-right position-relative me-2 text-muted"></i></div><div class="col-11 fw-l fs-lg-15 fs-md-15 fs-15 text-muted justify ps-lg-0 ps-md-0 ps-2">Include app flow and navigation.</div></div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-12 mt-40">
                                       <div class="love-working-boxs position-relative">
                                          ...
                                          <div class="row love-working py-lg-4 py-md-4 py-2 h-100">
                                             <div class="col-md-3 col-12 love-icons">
                                             <span><img class="w-100 hover-img0" src="{{GETFOLDERPATH()}}/resource-planning.webp" alt="Eesource Planning"></span> 
                                             <span><img class="w-100 hover-img3" src="{{GETFOLDERPATH()}}/resource-planning-white.webp" alt="Resource Planning "></span> 
                                          </div>
                                          <div class="col-md-9 col-12 position-relative ps-md-0 ps-3">
                                             <div class="col-auto count position-absolute right-15px top-n20px">03</div>
                                             <h4 class="d-none invisible">Resource Planning</h4>
                                                <div class="col-12 fw-m fs-lg-20 fs-md-20 fs-20 text-capitalize"> Resource Planning  </div>
                                                <div class="row"><div class="col-1"> <i class="imgd img-long-arrow-right position-relative me-2 text-muted"></i></div><div class="col-11 fw-l fs-lg-15 fs-md-15 fs-15 text-muted justify ps-lg-0 ps-md-0 ps-2">Identify resources required for the project, such as hardware and software.</div></div>
                                                <div class="row"><div class="col-1"> <i class="imgd img-long-arrow-right position-relative me-2 text-muted"></i></div><div class="col-11 fw-l fs-lg-15 fs-md-15 fs-15 text-muted justify ps-lg-0 ps-md-0 ps-2">Create a plan for finding resources and managing them well.</div></div>
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-12 overflow3">
                                       <div class="love-working-boxs position-relative">
                                          ...
                                          <div class="row love-working py-2 h-100">
                                             <div class="col-md-3 col-12 love-icons">
                                             <span><img class="w-100 hover-img0" src="{{GETFOLDERPATH()}}/design-and-prototyping.webp" alt="Design and Prototyping"></span> 
                                             <span><img class="w-100 hover-img4" src="{{GETFOLDERPATH()}}/design-and-prototyping-white.webp" alt="Design and Prototyping"></span> 
                                          </div>
                                          <div class="col-md-9 col-12 position-relative ps-md-0 ps-3">
                                             <div class="col-auto count position-absolute right-15px top-n15px">04</div>
                                             <h4 class="d-none invisible">Design And Prototyping</h4>
                                                <div class="col-12 fw-m fs-lg-20 fs-md-20 fs-20 text-capitalize"> Design And Prototyping </div>
                                                <div class="row"><div class="col-1"> <i class="imgd img-long-arrow-right position-relative me-2 text-muted"></i></div><div class="col-11 fw-l fs-lg-15 fs-md-15 fs-15 text-muted justify ps-lg-0 ps-md-0 ps-2">Craft a design for the mobile app, including UI, color schemes, etc.</div></div>
                                                <div class="row"><div class="col-1"> <i class="imgd img-long-arrow-right position-relative me-2 text-muted"></i></div><div class="col-11 fw-l fs-lg-15 fs-md-15 fs-15 text-muted justify ps-lg-0 ps-md-0 ps-2">Create a functional prototype of the app using advanced tools.</div></div>
                                                <div class="row"><div class="col-1"> <i class="imgd img-long-arrow-right position-relative me-2 text-muted"></i></div><div class="col-11 fw-l fs-lg-15 fs-md-15 fs-15 text-muted justify ps-lg-0 ps-md-0 ps-2">Share prototype for approval before development.</div></div>
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-12 mt-40">
                                       <div class="love-working-boxs position-relative">
                                          ...
                                          <div class="row love-working py-lg-4 py-md-4 py-2 h-100">
                                             <div class="col-md-3 col-12 love-icons ">
                                             <span><img class="w-100 hover-img0" src="{{GETFOLDERPATH()}}/databace-architecture-blue.webp" alt="Database Architecture"></span>
                                             <span><img class="w-100 hover-img5" src="{{GETFOLDERPATH()}}/databace-architecture-white.webp" alt="Database Architecture "></span>  
                                          </div>
                                          <div class="col-md-9 col-12 position-relative ps-md-0 ps-3 py-lg-4 py-md-3 py-3">
                                             <div class="col-auto count position-absolute right-15px top-n20px">05</div>
                                             <h4 class="d-none invisible">Database Architecture</h4>
                                                <div class="col-12 fw-m fs-lg-20 fs-md-20 fs-20 text-capitalize">Database Architecture </div>
                                                <div class="row"><div class="col-1"> <i class="imgd img-long-arrow-right position-relative me-2 text-muted"></i></div><div class="col-11 fw-l fs-lg-15 fs-md-15 fs-15 text-muted justify ps-lg-0 ps-md-0 ps-2">Design and set up a database for storing app data.</div></div>
                                             </div>
                                          </div>
                                       </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-12 overflow4">
                                       <div class="love-working-boxs position-relative">
                                          ...
                                          <div class="row love-working py-2 h-100">
                                             <div class="col-md-3 col-12 love-icons ">
                                             <span><img class="w-100 hover-img0" src="{{GETFOLDERPATH()}}/development.webp" alt="Development"></span> 
                                             <span><img class="w-100 hover-img6" src="{{GETFOLDERPATH()}}/development-white.webp" alt="Development "></span> 
                                          </div>
                                          <div class="col-md-9 col-12 position-relative ps-md-0 ps-3">
                                             <div class="col-auto count position-absolute right-15px top-n20px">06</div>
                                             <h4 class="d-none invisible">Development</h4>
                                                <div class="col-12 fw-m fs-lg-20 fs-md-20 fs-20 text-capitalize"> Development  </div>
                                                <div class="row"><div class="col-1"> <i class="imgd img-long-arrow-right position-relative me-2 text-muted"></i></div><div class="col-11 fw-l fs-lg-15 fs-md-15 fs-15 text-muted justify ps-lg-0 ps-md-0 ps-2">Write code for the app.</div></div>
                                                <div class="row"><div class="col-1"> <i class="imgd img-long-arrow-right position-relative me-2 text-muted"></i></div><div class="col-11 fw-l fs-lg-15 fs-md-15 fs-15 text-muted justify ps-lg-0 ps-md-0 ps-2">Implement app features and functionalities.</div></div>
                                                <div class="row"><div class="col-1"> <i class="imgd img-long-arrow-right position-relative me-2 text-muted"></i></div><div class="col-11 fw-l fs-lg-15 fs-md-15 fs-15 text-muted justify ps-lg-0 ps-md-0 ps-2">Tools and technology implementation to boost functionality.</div></div>
                                                <div class="row"><div class="col-1"> <i class="imgd img-long-arrow-right position-relative me-2 text-muted"></i></div><div class="col-11 fw-l fs-lg-15 fs-md-15 fs-15 text-muted justify ps-lg-0 ps-md-0 ps-2">Share ahead to receive feedback.</div></div>
                                             </div>
                                          </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-12 mt-40">
                                       <div class="love-working-boxs position-relative">
                                          ...
                                          <div class="row love-working py-2 h-100">
                                           <div class="col-md-3 col-12 love-icons ">
                                             <img class="w-lg-75 w-md-75 w-sm-30 w-30 hover-img0" src="{{GETFOLDERPATH()}}/uat.webp" alt="Uat">
                                             <img class="w-lg-75 w-md-75 w-sm-30 w-30 hover-img6" src="{{GETFOLDERPATH()}}/uat-white.webp" alt="Uat">
                                          </div>
                                          <div class="col-md-9 col-12 position-relative py-lg-2 py-md-2 py-0 ps-md-0 ps-3">
                                             <div class="col-auto count position-absolute right-15px top-n20px">07</div>
                                             <h4 class="d-none invisible">UAT</h4>
                                                <div class="col-12 fw-m fs-lg-20 fs-md-20 fs-20 text-capitalize"> UAT  </div>
                                                <div class="row"><div class="col-1"> <i class="imgd img-long-arrow-right position-relative me-2 text-muted"></i></div><div class="col-11 fw-l fs-lg-15 fs-md-15 fs-15 text-muted justify ps-lg-0 ps-md-0 ps-2">Conduct app testing to ensure it meets the needs and performs as expected.</div></div>
                                                <div class="row"><div class="col-1"> <i class="imgd img-long-arrow-right position-relative me-2 text-muted"></i></div><div class="col-11 fw-l fs-lg-15 fs-md-15 fs-15 text-muted justify ps-lg-0 ps-md-0 ps-2">Address and resolve issues (if any).</div></div>
                                                <div class="row"><div class="col-1"> <i class="imgd img-long-arrow-right position-relative me-2 text-muted"></i></div><div class="col-11 fw-l fs-lg-15 fs-md-15 fs-15 text-muted justify ps-lg-0 ps-md-0 ps-2">Move ahead with final approval from clients</div></div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-12 overflow4">
                                       <div class="love-working-boxs position-relative">
                                          ...
                                          <div class="row love-working py-lg-4 py-md-4 py-2 h-100">
                                             <div class="col-md-3 col-12 love-icons">
                                             <img class="w-lg-75 w-md-75 w-sm-30 w-30 hover-img0" src="{{GETFOLDERPATH()}}/deployment-and-live-blue.webp" alt="Deployment and Live"> 
                                            <img class="w-lg-75 w-md-75 w-sm-30 w-30 hover-img6" src="{{GETFOLDERPATH()}}/deployment-live.webp" alt="Deployment and Live"> 
                                          </div>
                                          <div class="col-md-9 col-12 position-relative py-lg-3 py-md-3 py-3 ps-md-0 ps-3">
                                             <div class="col-auto count position-absolute right-15px top-n20px">08</div>
                                             <h4 class="d-none invisible">Deployment And Live</h4>
                                                <div class="col-12 fw-m fs-lg-20 fs-md-20 fs-20 text-capitalize">Deployment And Live  </div>
                                                <div class="row"><div class="col-1"> <i class="imgd img-long-arrow-right position-relative me-2 text-muted"></i></div><div class="col-11 fw-l fs-lg-15 fs-md-15 fs-15 text-muted justify ps-lg-0 ps-md-0 ps-2">Deploy the app to an app store or distribution platform.</div></div>
                                             <div class="row"><div class="col-1"> <i class="imgd img-long-arrow-right position-relative me-2 text-muted"></i></div><div class="col-11 fw-l fs-lg-15 fs-md-15 fs-15 text-muted justify ps-lg-0 ps-md-0 ps-2">Make the app available to users.</div></div>
                                             </div>
                                          </div>
                                        </div>
                                      </div>
                                    ...
                                    <div class="col-xl-6 col-lg-6 col-12 mt-40">
                                       <div class="love-working-boxs position-relative ">
                                          <div class="row love-working py-2 h-100">
                                             <div class="col-md-3 col-12 love-icons">
                                             <span><img class="w-100 hover-img0" src="{{GETFOLDERPATH()}}/maintenance-and-updates.webp" alt="Maintenance and Updates"></span> 
                                             <span><img class="w-100 hover-img7" src="{{GETFOLDERPATH()}}/maintenance-and-updateswhite.webp" alt="Maintenance and Updates"></span> 
                                          </div>
                                           <div class="col-md-9 col-12 position-relative ps-md-0 ps-3">
                                             <div class="col-auto count position-absolute right-15px top-n20px">09</div>
                                             <h4 class="d-none invisible"> Maintenance And Updates</h4>
                                                <div class="col-12 fw-m fs-lg-20 fs-md-20 fs-20 text-capitalize"> Maintenance And Updates  </div>
                                                <div class="row"><div class="col-1"> <i class="imgd img-long-arrow-right position-relative me-2 text-muted"></i></div><div class="col-11 fw-l fs-lg-15 fs-md-15 fs-15 text-muted justify ps-lg-0 ps-md-0 ps-2">Maintain and update the app.</div></div>
                                                <div class="row"><div class="col-1"> <i class="imgd img-long-arrow-right position-relative me-2 text-muted"></i></div><div class="col-11 fw-l fs-lg-15 fs-md-15 fs-15 text-muted justify ps-lg-0 ps-md-0 ps-2">Provide ongoing support with regular checks and inspections.</div></div>
                                                <div class="row"><div class="col-1"> <i class="imgd img-long-arrow-right position-relative me-2 text-muted"></i></div><div class="col-11 fw-l fs-lg-15 fs-md-15 fs-15 text-muted justify ps-lg-0 ps-md-0 ps-2">Ensure app compatibility with operating systems and new devices.</div></div>
         ...
         <div class="container-fluid overflow-hidden hire-developer-section position-relative py-4">
            <div class="container py-lg-4 py-md-0 py-0 position-relative zi-2">
                  <div class="row d-flex align-items-center justify-content-center">
                        <div class="col-lg-12 col-md-12 col-12">
                              <div class="row align-items-center">
                                  
                         <div class="col-lg-8 col-md-7 ps-lg-5 pe-lg-5 mt-md-0 mt-0">
                              <div class="col-12 fs-md-14 fs-12 ">
                              <h3 class="d-none invisible">Looking To Hire Mobile App Developers</h3>
                                <span class="fs-xl-32 fs-lg-32 fs-md-18 fs-20 fw-m text-white"> Looking To Hire Mobile App Developers</span>
                              </div>
                              <div class="fw-500 fs-lg-17 fs-md-17 fs-15 mb-0 text-white">Feel Free to Get In Touch With Us.</div>
                                      
                           </div>

                           <div class="col-lg-4 col-md-5 mt-lg-0 mt-md-0 mt-3">
                               <div class="col-12 pt-1">
                                       <a href="tel:+91-9694097245" class="btn btn-theme3 fs-lg-14 fs-md-10 fs-13 fw-m hero_read_more_btn py-2 px-lg-4 px-md-3 px-3" style="transform-style: preserve-3d;" data-tilt="" data-tilt-max="3" data-tilt-speed="400" data-tilt-perspective="2500">
               ...
               <div class="container py-md-5 py-4 position-relative ">
                  <div class="row">
                     ...
                     <h2 class="d-none invisible">Our Recent Projects</h2>
                        <div class="col-12 heading fs-md-14 fs-12"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20">Our Recent<b> Projects</b> </span></div>
                     </div>
                  </div>
   ...
   <div class="container-fluid whyChooseUsSection">
      <div class="container py-lg-5 py-md-4 py-4 position-relative zi-2">
         <div class="row mx-0 pb-5">
            <h3 class="d-none invisible">Why Choose IMG Global Infotech As A Mobile App Development Company ?</h3>
            <div class="col-12 heading fs-md-14 fs-12 text-white"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20">Why Choose IMG Global Infotech As A  <b class="d-block">  Mobile App Development Company? </b></span></div>
         </div>
         <div class="row">
            <div class="col-12">
               <div class="row justify-content-center gy-md-5 gy-3 gx-4 items">
                  <div class="col-lg-5 col-md-12 item">
                     <div class="row justify-content-md-start text-md-start justify-content-center text-center inners">
                        <div class="col-sm-auto icons">
                           <img class="h-md-70px h-60px" src="{{GETFOLDERPATH()}}/modernuiux.webp" alt="Modern UI/UX">
                        </div>
                        <div class="col-sm">
                           <div class="row">
                              <div class="col-12 text-white fw-m mb-1 fs-md-17 fs-15 titles">Modern UI/UX</div>
                              <div class="col-12 text-white fs-md-15 fs-14 descriptions">We have a team of experienced and skilled designers and developers who hold the caliber to build an engaging and user-friendly mobile app meeting in-trend design standards.</div>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-5 col-md-12 item">
                     <div class="row justify-content-md-start text-md-start justify-content-center text-center inners">
                        <div class="col-sm-auto icons">
                           <img class="h-md-70px h-60px" src="{{GETFOLDERPATH()}}/agilemethodology.webp" alt="Agile Methodology">
                        </div>
                        <div class="col-sm">
                           <div class="row">
                              <div class="col-12 text-white fw-m mb-1 fs-md-17 fs-15 titles">Agile Methodology</div>
                              <div class="col-12 text-white fs-md-15 fs-14 descriptions">Our experts have performed exceptionally following agile methodologies that ensure the app delivers on time and within budget.</div>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-5 col-md-12 item">
                     <div class="row justify-content-md-start text-md-start justify-content-center text-center inners">
                        <div class="col-sm-auto icons">
                           <img class="h-md-70px h-60px" src="{{GETFOLDERPATH()}}/right-team-allocation.webp" alt=">Right Team Allocation">
                        </div>
                        <div class="col-sm">
                           <div class="row">
                              <div class="col-12 text-white fw-m mb-1 fs-md-17 fs-15 titles">Right Team Allocation</div>
                              <div class="col-12 text-white fs-md-15 fs-14 descriptions">We provide our clients with the right team of designers, developers, testers, and project managers to ensure you get the best app built to the highest standards. </div>
                           </div>
                        </div>
                     </div>
                  </div>
                  <div class="col-lg-5 col-md-12 item">
                     <div class="row justify-content-md-start text-md-start justify-content-center text-center inners">
                        <div class="col-sm-auto icons">
                           <img class="h-md-70px h-60px" src="{{GETFOLDERPATH()}}/extended-support.webp" alt="Extended Support">
                        </div>
                        <div class="col-sm">
                           <div class="row">
                              <div class="col-12 text-white fw-m mb-1 fs-md-17 fs-15 titles">Extended Support</div>
                              <div class="col-12 text-white fs-md-15 fs-14 descriptions">Our job doesn’t end at the app delivery as we offer extended support and maintenance services also to ensure your app performs accurately and attains your users’ tailoring needs. </div>
                           </div>
                        </div>
                     </div>
                  </div>
                 ...
                 {{-- <div class="col-lg-5 col-md-12 item">
                     <div class="row justify-content-md-start text-md-start justify-content-center text-center inners">
                        <div class="col-sm-auto icons">
                           <img class="h-md-70px h-60px" src="{{GETFOLDERPATH()}}/certified-experts.webp" alt="Certified Experts">
                        </div>
                        <div class="col-sm">
                           <div class="row">
                              <div class="col-12 text-white fw-m mb-1 fs-md-17 fs-15 titles">No Hidden Costs</div>
                              <div class="col-12 text-white fs-md-15 fs-14 descriptions">When it comes to costs, we are transparent and don’t have any hidden charges or fees.  </div>
                           </div>
                        </div>
                     </div>
                  </div> --}}
                        ...
                        <ul class="tabs wework-tab owl-carousel" id="navMenus">
                            <li class="tab-link current active" data-tab="demo1">
                              <div class="text-center">
                                 ...
                                 <div class="col-12 text-uppercase fw-m fs-lg-15 fs-md-15 fs-15 mb-0 text-dark text-decoration-none">Fantasy Sports</div>
                              </div>
                            </li>
                            ...
                            <li class="tab-link" data-tab="demo2">
                               <div class="text-center">
                                 <div class="col-12 pe-0 mb-2">
                                    <img class="w-md-60px w-50px mx-auto" src="{{GETFOLDERPATH()}}/BankingandFinance.webp" alt="Banking and Finance">
                                 </div>
                                 <div class="col-12 text-uppercase fw-m fs-lg-15 fs-md-15 fs-15 mb-0 text-dark text-decoration-none">Banking and Finance</div>
                              </div>
                            </li>
                            ...
                            <div class="text-center">
                                 ...
                                 <div class="col-12 text-uppercase fw-m fs-lg-15 fs-md-15 fs-15 mb-0 text-dark text-decoration-none">E-commerce</div>
                              </div>
                            </li>
                            ...
                            <li class="tab-link" data-tab="demo4">
                             <div class="text-center">
                                 ...
                                 <div class="col-12 text-uppercase fw-m fs-lg-15 fs-md-15 fs-15 mb-0 text-dark text-decoration-none">On-demand Delivery</div>
                              </div>
                            </li>
                            ...
                            <li class="tab-link" data-tab="demo5">
                              <div class="text-center">
                                 ...
                                 <div class="col-12 text-uppercase fw-m fs-lg-15 fs-md-15 fs-15 mb-0 text-dark text-decoration-none">Real Estate</div>
                              </div>
                            </li>
                            ...
                            <div class="text-center">
                                 ...
                                 <div class="col-12 text-uppercase fw-m fs-lg-15 fs-md-15 fs-15 mb-0 text-dark text-decoration-none">Fashion</div>
                              </div>
                            </li>
                            ...
                            <div class="text-center">
                                 ...
                                 <div class="col-12 text-uppercase fw-m fs-lg-15 fs-md-15 fs-15 mb-0 text-dark text-decoration-none">Healthcare</div>
                              </div>
                            </li>
                            ...
                            <div class="text-center">
                                 ...
                                 <div class="col-12 text-uppercase fw-m fs-lg-15 fs-md-15 fs-15 mb-0 text-dark text-decoration-none">Social Networking</div>
                              </div>
                            </li>
                            ...
                            <div class="text-center">
                                 ...
                                 <div class="col-12 text-uppercase fw-m fs-lg-15 fs-md-15 fs-15 mb-0 text-dark text-decoration-none">Tourism</div>
                              </div>
                            </li>
                            ...
                            <li class="tab-link" data-tab="demo10">
                              <div class="text-center">
                                 ...
                                 <div class="col-12 text-uppercase fw-m fs-lg-15 fs-md-15 fs-15 mb-0 text-dark text-decoration-none">Media and Entertainment</div>
                              </div>
                            </li>
                            ...
                            <li class="tab-link" data-tab="demo11">
                              <div class="text-center">
                                 ...
                                 <div class="col-12 text-uppercase fw-m fs-lg-15 fs-md-15 fs-15 mb-0 text-dark text-decoration-none">Ed Tech</div>
                              </div>
                            </li>
                            ...
                            <li class="tab-link" data-tab="demo12">
                              <div class="text-center">
                                 <div class="col-12 pe-0 mb-2">
                                    <img class="w-md-60px w-50px mx-auto" src="{{GETFOLDERPATH()}}/blogchain.webp" alt="Blockchain/NFTs">
                                 </div>
                                 <div class="col-12 text-uppercase fw-m fs-lg-15 fs-md-15 fs-15 mb-0 text-dark text-decoration-none">Blockchain NFTs</div>
                              </div>
                            </li>
                        </ul>
                     </div>
                                          ...
                                          <div class="col-lg-6 p-md-0 mt-lg-3 mt-md-3 mt-3  mb-md-3 mb-3">
                                             <div class="ol-12 case-outer">
                                                <div class="col-12 text-align-lg-start text-align-md-center text-align-center position-relative">  
                                                   ...
                                                   <div class="col-12 fs-md-12 fs-12 headings"><span class="col-12 text-capitalize fw-m fs-md-30 fs-sm-18 fs-16 lh-normal mt-2">Fantasy Sports</span></div>
                                                      <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 py-3"> We develop mobile apps that facilitate users to easily compete in fantasy sports leagues and track their real-time performance,
                                                    ...
                                                    <div class="col-12 pt-3 pb-3 text-lg-start text-center">
                                                      <a href="tel:+91-9694097245" class="btn btn-theme1 text-white fs-md-11 fs-10 fw-m py-2 px-4">
                                              ...
                                              <div class="col-lg-6 text-center">
                                               <div class="row justify-content-md-center justify-content-md-center justify-content-center mt-lg-3 mt-md-4 mt-4 leftside d-lg-block d-md-none d-none">
                                                <img class="w-lg-60 w-md-50 w-80 position-relative " src="{{GETFOLDERPATH()}}/fantasyapp.webp" alt="Fantasy App">
                                          </div>
                                       </div>   
                                    </div>
                                 </div>
                               ...
                               <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                       <div class="row d-flex align-items-center justify-content-center ps-lg-4 ps-md-4 border border-1 shadow boxs">
                                          <div class="col-lg-6 p-md-0 mt-lg-3 mt-md-3 mt-3  mb-md-3 mb-3">
                                             <div class="ol-12 case-outer">
                                                <div class="col-12 text-align-lg-start text-align-md-center text-align-center position-relative">  
                                                      <img class="w-lg-80px w-md-80px w-50px" src="{{GETFOLDERPATH()}}/bankingandFinance.webp" alt="Banking and Finance">
                                                </div>
                                                   <div class="col-12 case-inner pd-3 pt-3">
                                                   <div class="col-12 fs-md-12 fs-12 headings"><span class="col-12 text-capitalize fw-m fs-md-30 fs-sm-18 fs-16 lh-normal mt-2">Banking and Finance</span></div>
                                                      <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 py-3"> Our team of experienced mobile app developers offers top-quality mobility solutions that may facilitate users to make payments, 
                                              ...
                                              <div class="col-lg-6 text-center">
                                               <div class="row justify-content-md-center justify-content-md-center justify-content-center mt-lg-3 mt-md-4 mt-4 leftside d-lg-block d-md-none d-none">
                                                <img class="w-lg-60 w-md-50 w-80 position-relative " src="{{GETFOLDERPATH()}}/bankingandfinance-app.webp" alt="Banking and Finance">
                                          </div>
                                       </div>   
                                    </div>
                                 </div>
                                          ...
                                          <div class="col-lg-6 p-md-0 mt-lg-3 mt-md-3 mt-3  mb-md-3 mb-3">
                                             <div class="ol-12 case-outer">
                                                <div class="col-12 text-align-lg-start text-align-md-center text-align-center position-relative">  
                                                   ...
                                                   <div class="col-12 case-inner pd-3 pt-3">
                                                   <div class="col-12 fs-md-12 fs-12 headings"><span class="col-12 text-capitalize fw-m fs-md-30 fs-sm-18 fs-16 lh-normal mt-2">E-commerce </span></div>
                                                      <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 py-3">We know that mobile apps need to be user-friendly and engaging to attract users and boost sales. So, we develop visually appealing online stores to boost your online sales. </div>
                                                ...
                                                <div class="col-lg-6 p-md-0 mt-lg-3 mt-md-3 mt-3  mb-md-3 mb-3">
                                                   <div class="ol-12 case-outer">
                                                      <div class="col-12 text-align-lg-start text-align-md-center text-align-center position-relative">  
                                                         ...
                                                         <div class="col-12 case-inner pd-3 pt-3">
                                                         <div class="col-12 fs-md-12 fs-12 headings"><span class="col-12 text-capitalize fw-m fs-md-30 fs-sm-18 fs-16 lh-normal mt-2">On-demand Delivery </span></div>
                                                            <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 py-3">Our professionals create robust on-demand delivery applications to meet emerging demands and facilitate users to order products, track their real-time delivery status, and get them to their doorsteps. </div>
                                                   ...
                                                   <div class="col-lg-6 text-center">
                                                   <div class="row justify-content-md-center justify-content-md-center justify-content-center mt-lg-3 mt-md-4 mt-4 leftside d-lg-block d-md-none d-none">
                                                      <img class="w-lg-60 w-md-50 w-80 position-relative " src="{{GETFOLDERPATH()}}/demandondelivery.webp" alt="On-demand Delivery">
                                                </div>
                                             </div>   
                                          </div>
                                       </div>
                                                ...
                                                <div class="col-lg-6 p-md-0 mt-lg-3 mt-md-3 mt-3  mb-md-3 mb-3">
                                                   <div class="ol-12 case-outer">
                                                      <div class="col-12 text-align-lg-start text-align-md-center text-align-center position-relative">  
                                                         ...
                                                         <div class="col-12 case-inner pd-3 pt-3">
                                                         <div class="col-12 fs-md-12 fs-12 headings"><span class="col-12 text-capitalize fw-m fs-md-30 fs-sm-18 fs-16 lh-normal mt-2">Real Estate </span></div>
                                                            <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 py-3">Our team of expert developers delivers custom real estate app development solutions to let users view property listings,
                                                   ...
                                                   <div class="col-lg-6 text-center">
                                                   <div class="row justify-content-md-center justify-content-md-center justify-content-center mt-lg-3 mt-md-4 mt-4 leftside d-lg-block d-md-none d-none">
                                                      <img class="w-lg-60 w-md-50 w-80 position-relative " src="{{GETFOLDERPATH()}}/realEstateApp.webp" alt="Real Estate">
                                                </div>
                                             </div>   
                                          </div>
                                       </div>
                                                ...
                                                <div class="col-lg-6 p-md-0 mt-lg-3 mt-md-3 mt-3  mb-md-3 mb-3">
                                                   <div class="ol-12 case-outer">
                                                      <div class="col-12 text-align-lg-start text-align-md-center text-align-center position-relative">  
                                                         ...
                                                         <div class="col-12 case-inner pd-3 pt-3">
                                                         <div class="col-12 fs-md-12 fs-12 headings"><span class="col-12 text-capitalize fw-m fs-md-30 fs-sm-18 fs-16 lh-normal mt-2">Fashion</span></div>
                                                            <div class="col-12 fw-5l fs-md-16 fs-sm-15 fs-14 py-3">To meet your online fashion business requirements, our skilled developers build mobile apps that may allow users to
                                                   ...
                                                   <div class="col-lg-6 text-center">
                                                   <div class="row justify-content-md-center justify-content-md-center justify-content-center mt-lg-3 mt-md-4 mt-4 leftside d-lg-block d-md-none d-none">
                                                      <img class="w-lg-60 w-md-50 w-80 position-relative " src="{{GETFOLDERPATH()}}/fashionApp.webp" alt="Fashion">
                                                </div>
                                             </div>   
                                          </div>
                                       </div>
                                                ...
                                                <div class="col-lg-6 p-md-0 mt-lg-3 mt-md-3 mt-3  mb-md-3 mb-3">
                                                   <div class="ol-12 case-outer">
                                                      <div class="col-12 text-align-lg-start text-align-md-center text-align-center position-relative">  
                                                         ...
                                                         <div class="col-12 case-inner pd-3 pt-3">
                                                         <div class="col-12 fs-md-12 fs-12 headings"><span class="col-12 text-capitalize fw-m fs-md-30 fs-sm-18 fs-16 lh-normal mt-2">Healthcare</span></div>
                                                            <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 py-3">The healthcare mobile apps we develop let the users/patients book their doctors' appointments,
                                                   ...
                                                   <div class="col-lg-6 text-center">
                                                   <div class="row justify-content-md-center justify-content-md-center justify-content-center mt-lg-3 mt-md-4 mt-4 leftside d-lg-block d-md-none d-none">
                                                      <img class="w-lg-60 w-md-50 w-80 position-relative " src="{{GETFOLDERPATH()}}/healthcareapp.webp" alt="Healthcare">
                                                </div>
                                             </div>   
                                          </div>
                                       </div>
                                                ...
                                                <div class="col-lg-6 p-md-0 mt-lg-3 mt-md-3 mt-3  mb-md-3 mb-3">
                                                   <div class="ol-12 case-outer">
                                                      <div class="col-12 text-align-lg-start text-align-md-center text-align-center position-relative">  
                                                         ...
                                                         <div class="col-12 case-inner pd-3 pt-3">
                                                         <div class="col-12 fs-md-12 fs-12 headings"><span class="col-12 text-capitalize fw-m fs-md-30 fs-sm-18 fs-16 lh-normal mt-2">Social Networking </span></div>
                                                            <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 py-3">Today, when social networking apps are expanding worldwide, we develop apps that may let users 
                                                   ...
                                                   <div class="col-lg-6 text-center">
                                                   <div class="row justify-content-md-center justify-content-md-center justify-content-center mt-lg-3 mt-md-4 mt-4 leftside d-lg-block d-md-none d-none">
                                                      <img class="w-lg-60 w-md-50 w-80 position-relative " src="{{GETFOLDERPATH()}}/social-networking-app.webp" alt="Social Networking">
                                                </div>
                                             </div>   
                                          </div>
                                       </div>
                                                ...
                                                <div class="col-lg-6 p-md-0 mt-lg-3 mt-md-3 mt-3  mb-md-3 mb-3">
                                                   <div class="ol-12 case-outer">
                                                      <div class="col-12 text-align-lg-start text-align-md-center text-align-center position-relative">  
                                                         ...
                                                         <div class="col-12 case-inner pd-3 pt-3">
                                                         <div class="col-12 fs-md-12 fs-12 headings"><span class="col-12 text-capitalize fw-m fs-md-30 fs-sm-18 fs-16 lh-normal mt-2">Tourism </span></div>
                                                            <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 py-3">We provide tourism mobile apps to our clients looking for mobility solutions with content for travel destinations, options for flight and hotel booking filtering per needs, pay online, and more.</div>
                                                   ...
                                                   <div class="col-lg-6 text-center">
                                                   <div class="row justify-content-md-center justify-content-md-center justify-content-center mt-lg-3 mt-md-4 mt-4 leftside d-lg-block d-md-none d-none">
                                                      <img class="w-lg-60 w-md-50 w-80 position-relative " src="{{GETFOLDERPATH()}}/travelapp.webp" alt="Travel App">
                                                </div>
                                             </div>   
                                          </div>
                                       </div>
                           ...
                           <div class="col-lg-12">
                              ...
                              <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                    ...
                                    <div class="col-lg-6 p-md-0 mt-lg-3 mt-md-3 mt-3  mb-md-3 mb-3">
                                       <div class="ol-12 case-outer">
                                          <div class="col-12 text-align-lg-start text-align-md-center text-align-center position-relative">  
                                                <img class="w-lg-80px w-md-80px w-50px" src="{{GETFOLDERPATH()}}/media-and-entertainment.webp" alt="Media & Entertainment">
                                          </div>
                                             <div class="col-12 case-inner pd-3 pt-3">
                                             <div class="col-12 fs-md-12 fs-12 headings"><span class="col-12 text-capitalize fw-m fs-md-30 fs-sm-18 fs-16 lh-normal mt-2">Media and Entertainment </span></div>
                                                <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 py-3">Our team of professional app developers builds mobile apps that may permit users to watch TV shows, web series, the latest movies, audio tracks, video tracks, and a lot more with just a few clicks. </div>
                                       ...
                                       <div class="col-lg-6 text-center">
                                       <div class="row justify-content-md-center justify-content-md-center justify-content-center mt-lg-3 mt-md-4 mt-4 leftside d-lg-block d-md-none d-none">
                                          <img class="w-lg-60 w-md-50 w-80 position-relative " src="{{GETFOLDERPATH()}}/entertainmentApp.webp" alt="Media & Entertainment">
                                    </div>
                                 </div>   
                              </div>
                           </div>
                                    ...
                                    <div class="col-lg-6 p-md-0 mt-lg-3 mt-md-3 mt-3  mb-md-3 mb-3">
                                       <div class="ol-12 case-outer">
                                          <div class="col-12 text-align-lg-start text-align-md-center text-align-center position-relative">  
                                             ...
                                             <div class="col-12 case-inner pd-3 pt-3">
                                             <div class="col-12 fs-md-12 fs-12 headings"><span class="col-12 text-capitalize fw-m fs-md-30 fs-sm-18 fs-16 lh-normal mt-2">Ed-Tech </span></div>
                                                <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 py-3">Educational mobile apps we develop target attaining user needs, like access to education content, guides, videos,
                                       ...
                                       <div class="col-lg-6 text-center">
                                       <div class="row justify-content-md-center justify-content-md-center justify-content-center mt-lg-3 mt-md-4 mt-4 leftside d-lg-block d-md-none d-none">
                                          <img class="w-lg-60 w-md-50 w-80 position-relative " src="{{GETFOLDERPATH()}}/educationtechnology.webp" alt="Ed Tech">
                                    </div>
                                 </div>   
                              </div>
                           </div>
                                 ...
                                 <div id="demo12" class="tab-content">
                                       <div class="col-lg-12 col-md-12 col-sm-12 col-12">
                                          ...
                                          <div class="col-lg-6 p-md-0 mt-lg-3 mt-md-3 mt-3  mb-md-3 mb-3">
                                             <div class="ol-12 case-outer">
                                                <div class="col-12 text-align-lg-start text-align-md-center text-align-center position-relative">  
                                                      <img class="w-lg-80px w-md-80px w-50px" src="{{GETFOLDERPATH()}}/blogchain.webp" alt="Blockchain NFTs">
                                                </div>
                                                   <div class="col-12 case-inner pd-3 pt-3">
                                                   <div class="col-12 fs-md-12 fs-12 headings"><span class="col-12 text-capitalize fw-m fs-md-30 fs-sm-18 fs-16 lh-normal mt-2">Blockchain/NFTs </span></div>
                                                      <div class="col-12 fw-l fs-md-16 fs-sm-15 fs-14 py-3">Our engaging and useful Blockchain app development services are popular worldwide that let users in digital assets management, track portfolio, and buy and sell NFTs.   </div>
                                             ...
                                             <div class="col-lg-6 text-center">
                                             <div class="row justify-content-md-center justify-content-md-center justify-content-center mt-lg-3 mt-md-4 mt-4 leftside d-lg-block d-md-none d-none">
                                                <img class="w-lg-60 w-md-50 w-80 position-relative " src="{{GETFOLDERPATH()}}/block-chain.webp" alt="Blockchain NFTs">
                                          </div>
                                       </div>   
                                    </div>
                                 </div>
                        ...
                        <div class="accordion" id="accordionExample">
                           <div class="accordion-item mb-4 position-relative zi-2">
                                    <div class="accordion-header" id="headingOne">
                                       <button class="accordion-button fw-m fs-lg-15 fs-md-13 fs-13 fs-lg-14 fs-md-13 fs-13 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="false" aria-controls="collapseOne">
                           ...
                           <div class="accordion-item mb-4 position-relative zi-2">
                              <div class="accordion-header" id="headingTwo">
                                 <button class="accordion-button fw-m fs-lg-15 fs-md-13 fs-13 fs-lg-14 fs-md-13 fs-13 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo">
                           ...
                           <div class="accordion-item mb-4 position-relative zi-2">
                              <div class="accordion-header" id="headingThree">
                                 <button class="accordion-button fw-m fs-lg-15 fs-md-13 fs-13 fs-lg-14 fs-md-13 fs-13 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree">
                           ...
                           <div class="accordion-item mb-4 position-relative zi-2">
                              <div class="accordion-header" id="headingfour">
                                 <button class="accordion-button fw-m fs-lg-15 fs-md-13 fs-13 fs-lg-14 fs-md-13 fs-13 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapsefour" aria-expanded="false" aria-controls="collapsefour">
                           ...
                           <div class="accordion-item mb-4 position-relative zi-2">
                              <div class="accordion-header" id="headingfive">
                                 <button class="accordion-button fw-m fs-lg-15 fs-md-13 fs-13 fs-lg-14 fs-md-13 fs-13 collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#collapsefive" aria-expanded="false" aria-controls="collapsefive">
...
<script src="{{asset('/public')}}/assets/js/mobile-app-development-company.min.js"></script>
...
<script>
const nextArrow= '<img src="public/assets/img/mobile-app-development/nextfeature.svg" alt="right arrow" width="30">';
