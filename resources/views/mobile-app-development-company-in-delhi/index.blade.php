...
@push('meta')
   <!--  Title -->
   <title>Mobile App Development Company in delhi | IMG Global Infotech</title>

   <!-- Required meta tags -->
   <meta name="title" content="Mobile App Development Company in delhi | IMG Global Infotech" />
   <meta name="description" content="IMG Global Infotech is a leading mobile app development company in delhi, we build high-quality & user-friendly mobile apps for Android & iOS devices." />

   <!-- Twitter Meta -->
   <meta name="twitter:title" content="Mobile App Development Company in delhi | IMG Global Infotech">
   <meta name="twitter:description" content="IMG Global Infotech is a leading mobile app development company in delhi, we build high-quality & user-friendly mobile apps for Android & iOS devices.
">
   <meta name="twitter:image" content="{{asset('/public')}}/assets/img/mobile-app-development-company-in-delhi/mobile-app-development-company-delhi.webp">

   <!-- Facebook Meta -->
   <meta property="og:url" content="{{asset('/')}}mobile-app-development-company-in-delhi.php">
   <meta property="og:title" content="Mobile App Development Company in delhi | IMG Global Infotech">
   <meta property="og:description" content="IMG Global Infotech is a leading mobile app development company in delhi, we build high-quality & user-friendly mobile apps for Android & iOS devices.">
   <meta property="og:image" content="{{asset('/public')}}/assets/img/mobile-app-development-company-in-delhi/mobile-app-development-company-delhi.webp">
   <meta property="og:image:secure_url" content="{{asset('/public')}}/assets/img/mobile-app-development-company-in-delhi/mobile-app-development-company-delhi.webp">
   ...
   <link rel="canonical" href="{{asset('/')}}mobile-app-development-company-in-delhi.php" />
   <meta name="robots" content="index, follow" />
@endpush
@push('styles')
   <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/owl/owl.carousel.min.css">
   <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/do-not-edit/css/mobile-app-development-company-in-dehli.min.css">
@endpush
@section('content')
                     ...
                     <div class="row pt-3 text-lg-start text-md-center text-center">
                        <div class="col-12">
                           <div class="row mx-0 pb-2">
                              <h1 class="d-none invisible">Mobile App Development Company in Dehli</h1>
                              <div class="col-12 heading fs-md-14 fs-12 left text-white">
							  <span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Mobile App Development <b>Company in Dehli</b></span>
                              </div>
                           </div>
                        </div>
                  ...
                  <div class="col-lg-6 pe-lg-5 top_banner-left-part">
                     <div class="row justify-content-lg-end justify-content-md-center justify-content-center">
                        <div class="col-lg-8 col-md-5 col-7 position-relative">
                           <img class="w-100 position-relative tz" style="--tz:90px;" src="{{GETFOLDERPATH()}}/mobile-app-development-company-delhi.webp" alt="Mobile App Development Company Delhi">
            ...
            <div class="col-md-12">
               <nav aria-label="breadcrumb">
                  <ol class="breadcrumb mb-0">
                     ...
                     <li class="breadcrumb-item active fw-l fs-lg-16 fs-md-15 fs-14 text-dark" aria-current="page">Mobile App Development Company In Dehli</li>
                  </ol>
               </nav>
            </div>
         </div>
   ...
   <div class="container-fluid overflow-hidden get-porposal position-relative web-design-services-section-5">
      <div class="container zi-2 py-5 position-relative">
         <div class="row f-flex align-items-center justify-content-center">
            ...
            <div class="col-12 fw-m fs-md-16 fs-sm-15 fs-14 text-light mt-3 text-center">If you are looking out for a company that delivers innovative solutions for your mobile app development requirement then your search ends with us. We are one of the leading mobile app development company that provide mobile apps from scratch based on your customer's requirements. Some of the industries that we worked with are news, social networking, education, travelling, socialising, shopping, Retail Industry and many others.</div>
...
@push('scripts')
   ...
   <script src="{{asset('/public')}}/assets/js/mobile-app-development-company-in-dehli.min.js"></script>
