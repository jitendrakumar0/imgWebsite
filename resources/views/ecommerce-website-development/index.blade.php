...
@push('meta')
   <!--  Title -->
   <title>Responsive Website Design Company in India, Responsive Web Design Services - IMG Global Infotech</title>

   <!-- Required meta tags -->
   <meta name="title" content="Responsive Website Design Company in India, Responsive Web Design Services - IMG Global Infotech" />
   <meta name="description" content="IMG Global Infotech is a top-notch eCommerce web development company in India that builds excellent eCommerce portals with great features and interfaces." />
   ...
   <!-- Twitter Meta -->
   <meta name="twitter:title" content="Responsive Website Design Company in India, Responsive Web Design Services - IMG Global Infotech">
   <meta name="twitter:description" content="IMG Global Infotech is a top-notch eCommerce web development company in India that builds excellent eCommerce portals with great features and interfaces.">
   ...
   <meta property="og:title" content="Responsive Website Design Company in India, Responsive Web Design Services - IMG Global Infotech">
   <meta property="og:description" content="IMG Global Infotech is a top-notch eCommerce web development company in India that builds excellent eCommerce portals with great features and interfaces.">
            ...
            <div class="col-md-12">
               <nav aria-label="breadcrumb">
                  <ol class="breadcrumb mb-0">
                     ...
                     <li class="breadcrumb-item active fw-600 fs-lg-16 fs-md-15 fs-14 text-dark" aria-current="page">ECommerce Development</li>
                  </ol>
               </nav>
            </div>
         </div>
                  ...
                  <div class="col-lg-7">
                     <div class="row">
                        ...
                        <div class="col-12 pt-3 text-md-start text-center">
                           <a href="{{asset('#ourLatestWork')}}" class="btn btn-theme3 text-white fs-xxl-13 fs-11 fw-bold py-xxl-2 py-1 px-lg-4 px-3 mb-xl-0 mb-3">
         ...
         <div class="row justify-content-center">
            <div class="col-md-2 col-6 mb-md-5 mb-4">
               <div class="ecommerce_platforms_box row mx-0 justify-content-center">
                  ...
                  <div class="col-12 fw-bold fs-md-17 fs-15 lh-normal text-light text-center pt-3">Multiple Payment options</div>
               </div>
            </div>
            <div class="col-md-2 col-6 mb-md-5 mb-4">
               <div class="ecommerce_platforms_box row mx-0 justify-content-center">
                  ...
                  <div class="col-12 fw-bold fs-md-17 fs-15 lh-normal text-light text-center pt-3">User Engaging Experience</div>
               </div>
            </div>
            <div class="col-md-2 col-6 mb-md-5 mb-4">
               <div class="ecommerce_platforms_box row mx-0 justify-content-center">
                  ...
                  <div class="col-12 fw-bold fs-md-17 fs-15 lh-normal text-light text-center pt-3">Mobile friendly Features</div>
               </div>
            </div>
            <div class="col-md-2 col-6 mb-md-5 mb-4">
               <div class="ecommerce_platforms_box row mx-0 justify-content-center">
                  ...
                  <div class="col-12 fw-bold fs-md-17 fs-15 lh-normal text-light text-center pt-3">Extensive Product Listing</div>
               </div>
            </div>
            <div class="col-md-2 col-6 mb-md-5 mb-4">
               <div class="ecommerce_platforms_box row mx-0 justify-content-center">
                  ...
                  <div class="col-12 fw-bold fs-md-17 fs-15 lh-normal text-light text-center pt-3">User Review</div>
               </div>
            </div>
            ...
            <div class="col-md-2 col-6 mb-md-5 mb-4">
               <div class="ecommerce_platforms_box row mx-0 justify-content-center">
                  ...
                  <div class="col-12 fw-bold fs-md-17 fs-15 lh-normal text-light text-center pt-3">All Time Customer Service</div>
               </div>
            </div>
            <div class="col-md-2 col-6 mb-md-5 mb-4">
               <div class="ecommerce_platforms_box row mx-0 justify-content-center">
                  ...
                  <div class="col-12 fw-bold fs-md-17 fs-15 lh-normal text-light text-center pt-3">User Discount</div>
               </div>
            </div>
            <div class="col-md-2 col-6 mb-md-5 mb-4">
               <div class="ecommerce_platforms_box row mx-0 justify-content-center">
                  ...
                  <div class="col-12 fw-bold fs-md-17 fs-15 lh-normal text-light text-center pt-3">Rich- experience Features</div>
               </div>
            </div>
         </div>
      </div>
      ...
      <div class="container py-5 zi-2 position-relative">
         <div class="row mx-0 align-items-center gy-md-0 gy-4">
            ...
            <div class="col-lg-auto col-12 text-center">
               <a href="tel:919694097245" class="btn btn-theme3 fs-md-14 fs-13 fw-bold py-2 px-md-4 px-3">
   ...
   <div class="container-fluid ecommerce_services overflow-hidden">
      <div class="container py-5 position-relative zi-9">
         <div class="row mx-0 pb-5">
            ...
            <div class="col-12 fw-600 fs-md-16 fs-sm-15 fs-14 text-white text-center mt-4">Eager to know about our industry collaboration, we are building great connections in various sectors by proffering exclusive and innovative solutions. Explore unlimited possibilities with us by expanding and growing. Now, let's have a look at the industries with whom we worked for.</div>
         </div>
         <div class="row">
            <div class="col-12 col-sm-6 col-md-4 mb-4 d-flex align-items-stretch">
               <div class="service-box text-center w-100 rounded shadow">
                  ...
                  <div class="col-12 fw-900 text-theme1 fs-md-19 fs-sm-18 fs-17 lh-normal tz" style="--tz:30px;">Jewellery & Gemstone</div>
                  <div class="col-12 fw-600 fs-md-16 fs-sm-15 fs-14 text-muted mt-2 tz" style="--tz:30px;">We give the best ecommerce jewellery design solution with a view to expand the reach of your business. The supplier and maker of your industry can put faith in us for fulfilling their ecommerce website development needs.</div>
               </div>
            </div>
            <div class="col-12 col-sm-6 col-md-4 mb-4 d-flex align-items-stretch">
               <div class="service-box text-center w-100 rounded shadow">
                  ...
                  <div class="col-12 fw-900 text-theme1 fs-md-19 fs-sm-18 fs-17 lh-normal tz" style="--tz:30px;">Grocery, Fruits and Vegetables</div>
                  <div class="col-12 fw-600 fs-md-16 fs-sm-15 fs-14 text-muted mt-2 tz" style="--tz:30px;">There is a huge demand for online grocery and it has become more convenient to go for. We pledge to deliver innovative ecommerce website designing for our customers so that they can increase visibility of their business.</div>
               </div>
            </div>
            <div class="col-12 col-sm-6 col-md-4 mb-4 d-flex align-items-stretch">
               <div class="service-box text-center w-100 rounded shadow">
                  ...
                  <div class="col-12 fw-900 text-theme1 fs-md-19 fs-sm-18 fs-17 lh-normal tz" style="--tz:30px;">Garments & Clothing</div>
                  <div class="col-12 fw-600 fs-md-16 fs-sm-15 fs-14 text-muted mt-2 tz" style="--tz:30px;">We build agile and exclusive website design specialised for garments manufacturing. To succeed in the online industry, you need to get the best ecommerce garments website design and that you can get by associating with us.</div>
               </div>
            </div>
         </div>
      </div>
