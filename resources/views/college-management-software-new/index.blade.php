...
@push('meta')
<!--  Title -->
<title>college Software in India, college Management Software in India</title>

<!-- Required meta tags -->
<meta name="title" content="college Software in India, college Management Software in India" />
<meta name="description" content="Manage your college easily and perfectly with our college Management Software. Our comprehensive college ERP Software modules are specially designed to offer you a flexible and user-friendly experience." />
...
<!-- Twitter Meta -->
<meta name="twitter:title" content="college Software in India, college Management Software in India">
<meta name="twitter:description" content="Manage your college easily and perfectly with our college Management Software. Our comprehensive college ERP Software modules are specially designed to offer you a flexible and user-friendly experience.">
...
<meta property="og:title" content="college Software in India, college Management Software in India">
<meta property="og:description" content="Manage your college easily and perfectly with our college Management Software. Our comprehensive college ERP Software modules are specially designed to offer you a flexible and user-friendly experience.">
...
<link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/do-not-edit/css/college-management-software-new.min.css">
@endpush
@section('content')

<!-- SEO Headding -->
<h1 class="d-none"> college-management-software</h1>
   <!-- top banner section -->
                   ...
                   <div class="row pt-3 text-lg-start text-md-center text-center position-relative">
                           ...
                           <div class="col-12 ">
                               <div class="row mx-0 pb-2 justify-content-lg-start text-center justify-content-center">
                                   ...
                                   <h1 class="d-none invisible">College Management Software </h1>
                                   <div class="col-12 heading fs-md-14 fs-12 left text-white text-lg-start text-center">
                                       <span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> College Management <b> Software</b></span>
                                   </div>
                               </div>
                           </div>
      ...
      <div class="image-layer"></div>
       <div class="container py-lg-5 py-md-3 py-4 zi-2 position-relative">
          <div class="col-12 mx-0 pb-md-4 pb-2 pb-lg-4 pb-md-4">
             ...
             <div class="col-12 heading fs-md-14 fs-20 center text-black"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> College Management App Development:  <b> The Pivotal Feature </b></span></div>
   ...
   <div class="container-fluid moduleSection  py-lg-5 py-md-4 py-3">
      <div class="container">
         <div class="row">
            <div class="col-12 mx-0 pb-md-4 pb-2 pb-lg-4 pb-md-4">
               <h3 class="d-none invisible">On-demand Grocery App Features</h3>
               <div class="col-12 heading fs-md-14 fs-20 center text-black"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Module of College Mangement  <b> System Software </b></span></div>
            </div>
            <div class="col-12">
               <div class="col-12">
                  <div class="row g-3">
   ...
   <div class="container-fluid py-lg-5 py-md-4 py-3 benefitsCardSection">
      <div class="container">
         <div class="row gap-3">
            <div class="col-12 mx-0 pb-md-4 pb-2 pb-lg-4 pb-md-4">
               <h3 class="d-none invisible">On-demand Grocery App Features</h3>
               <div class="col-12 heading fs-md-14 fs-20 center text-black"><span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20"> Benefits Of Our  College  <b> Mangement Software </b></span></div>
               <div class="cpl-12 col-md-10 fw-l fs-md-16 fs-sm-15 fs-14 text-dark text-center mt-3 px-0 mx-auto">
                 Lorem ipsum, dolor sit amet consectetur adipisicing elit. Minus eos id quam sint aut illo repellendus porro soluta laborum tempore impedit, ut exercitationem dolorem, deserunt obcaecati reprehenderit, vitae praesentium labore.
               </div>
            </div>
