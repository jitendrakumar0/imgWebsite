...
<title>503 Service Unavailable</title>
  ...
  <meta name="discrption" content="503 Service Unavailable" />
  ...
  <meta name="classification" content="503 Service Unavailable" />
    ...
    <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/do-not-edit/css/503.min.css">
...
<main class="main-scrollbar errors-section">
   ...
   <div class="containerss">
      ...
      <div class="caveman">
         ...
         <div class="head">
            <div class="eye">
               <div class="nose">
                  <img src="{{asset('/public')}}/assets/img/logos/favicon-original.webp" class="w-15px position-absolute top-n23px left-n8px" alt="favicon">
               </div>
            </div>
            <div class="mouth"></div>
         </div>
   ...
   <div class="row mx-0 w-100 position-absolute start-0 end-0 bottom-md-8 bottom-auto top-md-auto top-60 mt-md-0 mt-4">
      <div class="col-12 fw-900 text-theme3 fs-lg-90 fs-md-70 fs-sm-50 fs-30 text-center">Service Unavailable</div>

      <a class="col-12 text-decoration-none fs-20 text-white fw-900 text-center" href="{{asset('/')}}">
         Back to Home
      </a>
   </div>
</main>
...
<script src="{{asset('/public')}}/assets/js/errors/503.js"></script>
