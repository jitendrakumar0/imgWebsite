...
<title>419 Page Expired</title>
  ...
  <!-- Required meta tags -->
  <meta name="title" content="419 Page Expired" />
  <meta name="discrption" content="419 Page Expired" />
  ...
  <meta name="classification" content="419 Page Expired" />
    ...
    <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/do-not-edit/css/419.min.css">
...
<main class="main-scrollbar errors-section">
    ...
    <div class="error text-md-start text-center">
       <div class="error__title fw-900">419</div>
       <div class="error__subtitle fw-900 mt-md-0 mt-n4">Oh... Page Expired</div>
       <a href="{{asset('/')}}" class="error__button error__button--active mt-1 text-decoration-none fw-bold mt-3 d-inline-block">Back to Home</a>
    </div>
    ...
    <div class="astronaut">
       ...
       <div class="astronaut__body__chest">
          <img src="{{asset('/public')}}/assets/img/logos/favicon-original.webp" class="position-absolute w-20px left-0 right-0 m-auto top-0 bottom-0" alt="">
       </div>
...
<script src="{{asset('/public')}}/assets/js/errors/419.js"></script>
