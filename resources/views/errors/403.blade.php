...
<title>403 Forbidden</title>
  ...
  <meta name="discrption" content="403 Forbidden" />
  ...
  <meta name="classification" content="403 Forbidden" />
    ...
    <link rel="stylesheet" href="{{asset('/public')}}/assets/plugins/do-not-edit/css/403.min.css">
...
<main class="main-scrollbar errors-section">
   <h1 class="text mt-n5"><span>403</span></h1>
   <div class="row mx-0 w-100 position-absolute start-0 end-0 bottom-md-8 bottom-auto top-md-auto top-60 pt-5">
      <div class="col-12 fw-900 text-white fs-lg-90 fs-md-70 fs-sm-50 fs-30 text-center">Forbidden</div>
...
<script src="{{asset('/public')}}/assets/js/errors/403.js"></script>
