            ...
            <div class="col-md-12">
               <nav aria-label="breadcrumb">
                  <ol class="breadcrumb mb-0">
                     ...
                     <li class="breadcrumb-item"><a class="fw-600 fs-lg-16 fs-md-15 fs-14 text-theme2 text-decoration-none" href="{{asset('/mobile-app-development.php')}}">Mobile App Development Services</a></li>
                     <li class="breadcrumb-item active fw-600 fs-lg-16 fs-md-15 fs-14 text-dark" aria-current="page">HealthCare App Development Company </li>
                  </ol>
               </nav>
            </div>
         </div>
               ...
               <div class="row align-items-center">
                 ...
                 <div class="col-lg-7">
                     <div class="row">
                        ...
                        <div class="col-12 fw-600 fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-muted text-lg-start text-center mt-3">In today's digital world, top-notch app development services have become essential to people's lives, and businesses are looking for ways to reach their customers through mobile apps. If you want to increase your business revenue, it's important to adapt to this trend. Hiring a remote app developer from a mobile app development agency can be a great way to accomplish this. At IMG Global Infotech, we offer flexible hiring options, allowing you to hire a mobile developer for the duration of your project, whether it's for days, weeks, or months. You can choose to hire our developers on a full-time, part-time, or hourly basis to meet your project needs.</div>
                        <div class="col-12 fw-600 fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-muted text-lg-start text-center mt-3">We specialize in developing cutting-edge digital solutions that connect patients in a safe and convenient manner. Our medical app developers have extensive experience in healthcare web application development and healthcare mobile application development, allowing us to integrate new digital solutions into your healthcare strategy seamlessly. We bring unique capabilities to the table, leveraging our rich healthcare domain knowledge:</div>
                        <div class="col-12">
                           <ul class="row fw-600 fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-muted text-lg-start text-center mt-3">
                     ...
                     <div class="col-12 pt-3 text-lg-start text-md-center text-center mt-md-1">
                           <a href="#formScroll" class="btn btn-theme3 text-white fs-xxl-13 fs-11 fw-bold py-xxl-2 py-1 px-lg-4 px-3 mb-xl-0 mb-3">
                  ...
                  <div class="container-fluid features_mobile_apppp position-relative">
                     <div class="container py-5 zi-2 position-relative">
                        <div class="row mx-0 pb-5">
                           ...
                           <div class="col-12 fw-600 fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-white text-center mt-3">A healthcare app can offer numerous benefits to your business, including</div>
                        </div>
                        <div class="row develop-boxes justify-content-center">
                           <div class="col-lg-4 col-md-6 text-center d-flex align-items-stretch">
                              <div class="features_mobile_apppp_boxx w-100 shadow">
                                 ...
                                 <div class="col-12 fw-900 text-theme1 fs-md-18 fs-sm-17 fs-16 lh-normal">Increased Patient Engagement</div>
                                 <div class="col-12 fw-600 fs-md-16 fs-sm-15 fs-14 text-muted mt-3">A healthcare app allows you to engage with your patients more effectively, by offering features like appointment scheduling, medication reminders, and personalized health tips.</div>
                              </div>
                           </div>
                           <div class="col-lg-4 col-md-6 text-center d-flex align-items-stretch">
                              <div class="features_mobile_apppp_boxx w-100 shadow">
                                 ...
                                 <div class="col-12 fw-900 text-theme1 fs-md-18 fs-sm-17 fs-16 lh-normal">Improved Patient Outcomes</div>
                                 <div class="col-12 fw-600 fs-md-16 fs-sm-15 fs-14 text-muted mt-3">With a healthcare app, patients can access their health information and track their progress, leading to improved outcomes and better health management.</div>
                              </div>
                           </div>
                           <div class="col-lg-4 col-md-6 text-center d-flex align-items-stretch">
                              <div class="features_mobile_apppp_boxx w-100 shadow">
                                 ...
                                 <div class="col-12 fw-900 text-theme1 fs-md-18 fs-sm-17 fs-16 lh-normal">Streamlined Processes</div>
                                 <div class="col-12 fw-600 fs-md-16 fs-sm-15 fs-14 text-muted mt-3">A healthcare app can help streamline processes like appointment scheduling, prescription management, and billing, reducing administrative burden and improving efficiency.</div>
                              </div>
                           </div>
                           <div class="col-lg-4 col-md-6 text-center d-flex align-items-stretch">
                              <div class="features_mobile_apppp_boxx w-100 shadow">
                                 ...
                                 <div class="col-12 fw-900 text-theme1 fs-md-18 fs-sm-17 fs-16 lh-normal">Increased Revenue</div>
                                 <div class="col-12 fw-600 fs-md-16 fs-sm-15 fs-14 text-muted mt-3">By offering additional services like telemedicine consultations and online medication management, healthcare apps can increase your revenue and expand your customer base.</div>
                              </div>
                           </div>
                           <div class="col-lg-4 col-md-6 text-center d-flex align-items-stretch">
                              <div class="features_mobile_apppp_boxx w-100 shadow">
                                 ...
                                 <div class="col-12 fw-900 text-theme1 fs-md-18 fs-sm-17 fs-16 lh-normal">Competitive Advantage</div>
                                 <div class="col-12 fw-600 fs-md-16 fs-sm-15 fs-14 text-muted mt-3">In today's digital age, having a healthcare app can give you a competitive advantage over other healthcare providers by offering a more modern and convenient way of accessing healthcare services.</div>
                              </div>
                           </div>
                           <div class="col-lg-4 col-md-6 text-center d-flex align-items-stretch">
                              <div class="features_mobile_apppp_boxx w-100 shadow">
                                 ...
                                 <div class="col-12 fw-900 text-theme1 fs-md-18 fs-sm-17 fs-16 lh-normal">Enhanced Brand Image</div>
                                 <div class="col-12 fw-600 fs-md-16 fs-sm-15 fs-14 text-muted mt-3">By offering a healthcare app, you can enhance your brand image and reputation by demonstrating your commitment to patient care and innovation in healthcare.</div>
                              </div>
                           </div>
                        </div>
                     </div>
                  ...
                  <div class="col-lg-4 col-md-6 text-start d-flex align-items-stretch">
                     <div class="features_mobile_app_box mx-0 shadow row py-3 align-items-center px-2 even-bg">
                        ...
                        <div class="col">
                           ...
                           <div class="col-12 text-start fw-900 text-white fs-md-24 fs-sm-17 fs-16 lh-normal">Online payment</div>
                           <div class="col-12 text-start fw-600 fs-md-15 fs-sm-14 fs-13 text-white mt-2">As a premier medical app development provider, we deliver top-notch payment gateway integration services. Users of the medical app can pay for doctor appointments using a variety of payment gateways.</div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-lg-4 col-md-6 text-start d-flex align-items-stretch">
                     <div class="features_mobile_app_box mx-0 shadow row py-3 align-items-center px-2 odd-bg">
                        ...
                        <div class="col">
                           ...
                           <div class="col-12 text-start fw-900 text-dark fs-md-24 fs-sm-17 fs-16 lh-normal">Insights & Analytics</div>
                           <div class="col-12 text-start fw-600 fs-md-15 fs-sm-14 fs-13 text-dark mt-2">To track the patient's health, we make sure to include this feature in our mobile healthcare software development services. It is useful to anticipate health difficulties based on the data that has been collected and to treat and diagnose diseases as soon as possible.</div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-lg-4 col-md-6 text-start d-flex align-items-stretch">
                     <div class="features_mobile_app_box mx-0 shadow row py-3 align-items-center px-2 even-bg">
                        ...
                        <div class="col">
                           ...
                           <div class="col-12 text-start fw-900 text-white fs-md-24 fs-sm-17 fs-16 lh-normal">Online Chat</div>
                           <div class="col-12 text-start fw-600 fs-md-15 fs-sm-14 fs-13 text-white mt-2">As a top healthcare app development firm, we include this function in healthcare applications to keep doctors and patients informed about forthcoming appointments or other pertinent medical information.</div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-lg-4 col-md-6 text-start d-flex align-items-stretch">
                     <div class="features_mobile_app_box mx-0 shadow row py-3 align-items-center px-2 odd-bg">
                        ...
                        <div class="col">
                           ...
                           <div class="col-12 text-start fw-900 text-dark fs-md-24 fs-sm-17 fs-16 lh-normal">Online Appointment</div>
                           <div class="col-12 text-start fw-600 fs-md-15 fs-sm-14 fs-13 text-dark mt-2">Patients can search for the doctor and make an appointment online in the most practical manner. In order for the doctor to be ready before the patient arrives, it also collects any additional information about the patient.</div>
                        </div>
                     </div>
                  </div>
                  ...
                  <div class="col-lg-4 col-md-6 text-start d-flex align-items-stretch">
                     <div class="features_mobile_app_box mx-0 shadow row py-3 align-items-center px-2 even-bg">
                        ...
                        <div class="col">
                           ...
                           <div class="col-12 text-start fw-900 text-white fs-md-24 fs-sm-17 fs-16 lh-normal">Automatic Method</div>
                           <div class="col-12 text-start fw-600 fs-md-15 fs-sm-14 fs-13 text-white mt-2">To help health professionals better monitor patients and deliver services like better patient management, increased efficiency, quicker billing, and recovery of patient data, our mHealth app developers integrated this feature.</div>
                        </div>
                     </div>
                  </div>
     ...
     <div class="image-layer"></div>
      <div class="container py-lg-5 py-md-3 py-4 zi-2 position-relative">
         <div class="col-12 mx-0 pb-md-4 pb-2 pb-lg-4 pb-md-4">
            ...
            <div class="cpl-12 col-md-10 fw-600 fs-md-16 fs-sm-15 fs-14 text-dark text-center mt-3 px-0 mx-auto">Our app solution has a user-friendly interface and things that keep you on edge to schedule your appointment in no time.</div>
         </div>
            <div class="row d-flex align-items-center ">
                <div class="col-lg-8 col-md-12 col-12 useradmin pt-0 pt-lg-0 pt-md-0 mb-lg-4 d-flex justify-content-center mx-auto p-0">  
                     <ul class="nav nav-tabs border-0">
                           <li class="nav-item">
                              <a class="nav-link active btn text-black fs-lg-19 fs-md-19 fs-13 fw-bold my-3 py-2 pe-lg-4 pe-md-4 pe-2 ps-lg-4 ps-md-4 ps-2" data-bs-toggle="tab" href="#home"> Patient App</a>
                           </li>
                           <li class="nav-item">
                              <a class="nav-link btn text-black fs-lg-19 fs-md-19 fs-13  fw-bold my-3 py-2 mx-1 p-lg-2 p-md-2 p-3" data-bs-toggle="tab" href="#menu1">Doctors App</a>
                           </li>
                           <li class="nav-item">
                              <a class="nav-link btn text-black fs-lg-19 fs-md-19 fs-13  fw-bold my-3 py-2 mx-1 p-lg-2 p-md-2 p-3" data-bs-toggle="tab" href="#menu2">Admin Panel</a>
                           </li>
                     </ul>
                </div>
                                 ...
                                 <div class="col-lg-3 col-md-3 col-6 mb-3">             
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Profile</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">          
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Find a doctor</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">    
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Book appointment</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">       
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Audio/video chat services</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">         
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Medical history</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">      
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">In-App payments</div>
                                          </div>
                                    </div>
                              </div>
                           </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">    
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Appointment management</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">       
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Patient’s medical records</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">          
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Prescription</div>
                                          </div>
                                    </div>
                              </div>
                                 ...
                                 <div class="col-lg-3 col-md-3 col-6 mb-3">           
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Analytics and transactions</div>
                                          </div>
                                    </div>
                              </div>
                           </div>
                            ...
                            <div class="col-lg-3 col-md-3 col-6 mb-3">     
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Dashboard</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">         
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Appointments management</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">                
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Doctor management</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">                  
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Clinic administration</div>
                                          </div>
                                    </div>
                              </div>
                              ...
                              <div class="col-lg-3 col-md-3 col-6 mb-3">               
                                    <div class="w-100 feature-block-one position-relative">
                                       <div class="col-12 inner-boxp-3 pe-2">
                                          ...
                                          <div class="col-12 text-dark fw-900 fs-xl-18 fs-lg-16 fs-13 text-center mt-3">Payout administration</div>
                                          </div>
                                    </div>
                              </div>
                           </div>
                   ...
                   <div class="container">
                     <div class="row align-items-center mx-lg-5 mx-md-2 mx-0">
                        <div class="col-lg-12 col-md-12 col-12">
                           ...
                           <div class="col-12 fw-600 fs-md-33 fs-lg-33 fs-24 text-white fw-900 text-center mb-3"> Ready to Hire the Healthcare App Development Company</div>
                           <div class="col-12 fw-600 fs-md-18 fs-lg-18 fs-16 text-white text-center">Partner with IMG Global Infotech — the best healthcare app development company in India. Add new capabilities with technology-enabled healthcare solutions developed exclusively by our expert healthcare mobile app developers.</div>
                        </div>
                           <div class="col-lg-12 col-md-12 col-12 d-flex justify-content-center py-3">
                              <a href="#formScroll" class="btn expert-btn fs-lg-15 fs-md-15 fs-14 fw-bold py-3 px-md-4 px-4 bg-white">
         ...
         <div class="row py-lg-4 py-3 items fantasy-cricket-sldier owl-carousel">
               ...
               <div class="box h-100 flex-column d-flex px-lg-3 px-md-3 px-3 py-lg-4 py-md-4 py-4">
                  <figure>
                     <picture class="d-flex justify-content-center">
                        <img src="{{GETFOLDERPATH()}}/grocery-app.png" class="w-lg-80 w-md-50 w-50" alt="food">
                     </picture>
                  </figure>
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-19 fs-md-20 fs-18 lh-normal fw-900 mb-1 text-white">Grocery App Development</div>
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-15 flex-fill fs-15 lh-normal text-white">At IMG, we aim to provide high-quality online grocery app development services.</div>
                        <div class="col-lg-12 col-md-12 col-12 d-flex justify-content-lg-start justify-content-md-start justify-content-start pt-3">
                           <a href="{{asset('/grocery-app-development.php')}}" class="btn expert-btn fs-lg-13 fs-md-13 fs-14 fw-bold py-2 px-md-3 px-3 bg-white">
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mb-lg-0 item">
               <div class="box h-100 flex-column d-flex px-3 py-4">
                  <figure>
                     <picture class="d-flex justify-content-center">
                        <img src="{{GETFOLDERPATH()}}/jewellery-app.png" class="w-lg-75 w-md-50 w-50" alt="jewellery app">
                     </picture>
                  </figure>
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-19 fs-md-20 fs-18 lh-normal fw-900 mb-1  text-white">Jewellery App Development</div>
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-15 flex-fill fs-15 lh-normal  text-white">Get a custom jewellery mobile app/website for easy jewellery shopping.</div>
                        <div class="col-lg-12 col-md-12 col-12 d-flex justify-content-lg-start justify-content-md-start justify-content-start pt-3">
                           <a href="{{asset('/jewellery-app-development.php')}}" class="btn expert-btn fs-lg-13 fs-md-13 fs-14 fw-bold py-2 px-md-3 px-3 bg-white  text-dark">
                           <span class="d-block"><span>Read More</span> <i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i></span>
                        </a>
                     </div>
                  </div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mb-lg-0 item">
               <div class="box h-100 flex-column d-flex px-3 py-4" >
                  <figure>
                     <picture class="d-flex justify-content-center">
                        <img src="{{GETFOLDERPATH()}}/food-delivery-app.png" class="w-lg-75 w-md-50 w-50" alt="food delivery app">
                     </picture>
                  </figure>
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-18 fs-md-20 fs-18 lh-normal fw-900 mb-1 text-white">Food Delivery App Development</div>
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-15 flex-fill fs-15 lh-normal text-white">IMG is the best Food delivery app development company holding years of experience serving</div>
                        <div class="col-lg-12 col-md-12 col-12 d-flex justify-content-lg-start justify-content-md-start justify-content-start pt-3">
                           <a href="{{asset('/food-delivery-app-development.php')}}" class="btn expert-btn fs-lg-13 fs-md-13 fs-14 fw-bold py-2 px-md-3 px-3 text-dark bg-white">
                           <span class="d-block"><span>Read More</span> <i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i></span>
                        </a>
                     </div>
                  </div>
            ...
            {{--  <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mb-lg-0 item">
               <div class="box h-100 flex-column d-flex px-3 py-4">
                  <figure>
                        <picture class="d-flex justify-content-center">
                        <img src="{{GETFOLDERPATH()}}/health-care.png" class="w-lg-75 w-md-50 w-50" alt="health care">
                     </picture>
                  </figure>
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-19 fs-md-20 fs-18 lh-normal fw-900 mb-1  text-white">Healthcare App Development</div>
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-15 flex-fill fs-15 lh-normal  text-white">Delivering world-class healthcare application services to enhance medical care.</div>
                        <div class="col-lg-12 col-md-12 col-12 d-flex justify-content-lg-start justify-content-md-start justify-content-start pt-3">
                           <a href="{{asset('/healthcare-app-development.php')}}" class="btn expert-btn fs-lg-13 fs-md-13 fs-14 fw-bold py-2 px-md-3 px-3 bg-white" >
                           <span class="d-block"><span>Read More</span> <i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i></span>
                        </a>
                     </div>
                  </div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mb-lg-0 item">
               <div class="box h-100 flex-column d-flex px-3 py-4">
                  <figure>
                     <picture class="d-flex justify-content-center">
                        <img src="{{GETFOLDERPATH()}}/medicine-app.png" class="w-lg-75 w-md-50 w-50" alt="medicine app">
                     </picture>
                  </figure>
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-19 fs-md-20 fs-18 lh-normal fw-900 mb-1  text-white">Medicine App Development</div>
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-15 flex-fill fs-15 lh-normal  text-white">We are experts in mobile app development for pharmacy and pharma related business.</div>
                        <div class="col-lg-12 col-md-12 col-12 d-flex justify-content-lg-start justify-content-md-start justify-content-start pt-3">
                           <a href="{{asset('/pharmacy-app-development.php')}}" class="btn expert-btn fs-lg-13 fs-md-13 fs-14 fw-bold py-2 px-md-3 px-3 bg-white  text-dark">
                           <span class="d-block"><span>Read More</span> <i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i></span>
                        </a>
                     </div>
                  </div>
            ...
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mb-lg-0 item">
               <div class="box h-100 flex-column d-flex px-3 py-4">
                  <figure>
                     <picture class="d-flex justify-content-center">
                        <img src="{{GETFOLDERPATH()}}/doctor-app.png" class="w-lg-75 w-md-50 w-50" alt="doctor app">
                     </picture>
                  </figure>
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-19 fs-md-20 fs-18 lh-normal fw-900 mb-1  text-white">Doctor App Development</div>
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-15 flex-fill fs-15 lh-normal  text-white">IMG develops online doctor appointment applications for hospitals, clinics, and individual doctors.</div>
                        <div class="col-lg-12 col-md-12 col-12 d-flex justify-content-lg-start justify-content-md-start justify-content-start pt-3">
                           <a href="{{asset('/doctor-on-demand-app-development.php')}}" class="btn expert-btn fs-lg-13 fs-md-13 fs-14 fw-bold py-2 px-md-3 px-3 bg-white  text-dark">
                           <span class="d-block"><span>Read More</span> <i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i></span>
                        </a>
                     </div>
                  </div>
           ...
           <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12 mb-3 mb-lg-0 item">
               <div class="box h-100 flex-column d-flex px-3 py-4">
                  <figure>
                     <picture class="d-flex justify-content-center">
                        <img src="{{GETFOLDERPATH()}}/clothing-app.png" class="w-lg-75 w-md-50 w-50" alt="clothing app">
                     </picture>
                  </figure>
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-20 fs-md-19 fs-18 lh-normal fw-900 mb-1  text-white">Clothing App Development</div>
                     <div class="col-lg-12 col-md-12 col-12 text-balck fs-lg-16 fs-md-15 flex-fill fs-15 lh-normal  text-white">Build an enterprise-grade app for your clothing store and take your business to new heights.</div>
                        <div class="col-lg-12 col-md-12 col-12 d-flex justify-content-lg-start justify-content-md-start justify-content-start pt-3">
                           <a href="{{asset('/fashion-app-development.php')}}" class="btn expert-btn fs-lg-13 fs-md-13 fs-14 fw-bold py-2 px-md-3 px-3 bg-white  text-dark">
                           <span class="d-block"><span>Read More</span> <i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i></span>
                        </a>
                     </div>
                  </div>
      ...
      <div class="container py-5 position-relative p-0">
         <div class="row mx-0 pb-2">
            ...
            <h3 class="d-none invisible">Looking for Other Services?</h3>
               <div class="col-12 fs-xl-35 fs-lg-35 fs-md-24 fs-25 text-center text-white fw-900 p-0"> Looking for Other Services?</div>
               <div class="col-12 fw-600 fs-md-18 fs-lg-18 fs-18 text-white text-md-center text-center py-lg-2 py-md-2 py-2">Explore our other related services to enhance the performance of your digital product.</div>
         </div>
      </div>
    </div>
