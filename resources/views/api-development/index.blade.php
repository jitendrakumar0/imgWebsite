...
@push('meta')
   <!--  Title -->
   <title>API Development Company in India, API Integration Services - IMG Global Infotech</title>

   <!-- Required meta tags -->
   <meta name="title" content="API Development Company in India, API Integration Services - IMG Global Infotech" />
   <meta name="description" content="IMG Global Infotech is a top rated API Development company in India assisting various businesses to create powerful APIs with the help of latest tools aiming to deliver greatest outcomes." />
   ...
   <!-- Twitter Meta -->
   <meta name="twitter:title" content="API Development Company in India, API Integration Services - IMG Global Infotech">
   <meta name="twitter:description" content="IMG Global Infotech is a top rated API Development company in India assisting various businesses to create powerful APIs with the help of latest tools aiming to deliver greatest outcomes.">
   ...
   <meta property="og:title" content="API Development Company in India, API Integration Services - IMG Global Infotech">
   <meta property="og:description" content="IMG Global Infotech is a top rated API Development company in India assisting various businesses to create powerful APIs with the help of latest tools aiming to deliver greatest outcomes.">
            ...
            <div class="col-md-12">
               <nav aria-label="breadcrumb">
                  <ol class="breadcrumb mb-0">
                     ...
                     <li class="breadcrumb-item active fw-600 fs-lg-16 fs-md-15 fs-14 text-dark" aria-current="page">API Development</li>
                  </ol>
               </nav>
            </div>
         </div>
               ...
               <div class="row align-items-center">
                  ...
                  <div class="col-lg-7">
                     <div class="row">
                        ...
                        <div class="col-12 fw-600 fs-lg-16 fs-md-16 fs-sm-15 fs-14 text-muted text-start mt-3">Our experienced and professional API development team not only knows about the technologies behind API, but also masters the end-to-end process of rolling out, managing, monitoring and monetizing APIs. As a leading IT Development company, we have assisted clients to strategize, expose, manage and run efficient high-performance API programs to meet their business goals.</div>
                        <div class="col-lg-4 col-md-4 col-12 mt-4 d-flex align-items-stretch">
                           <div class="row align-items-center w-100 h-100 mx-0">
                              <div class="col fs-14 lh-normal text-theme1 bg-white py-1 zi-0 rounded shadow pb-2 position-relative border-top border-theme1 border-2 border-bottom border-theme1 border-2 text-center pt-2">
                                 ...
                                 <strong class="d-block fw-bold text-theme1 fs-13 lh-normal">User Engagement : </strong>
                        ...
                        <div class="col-lg-4 col-md-4 col-12 mt-4 d-flex align-items-stretch">
                           <div class="row align-items-center w-100 h-100 mx-0">
                              ...
                              <div class="col fs-14 lh-normal text-theme1 bg-white py-1 zi-0 rounded shadow pb-2 position-relative border-top border-theme1 border-2 border-bottom border-theme1 border-2 text-center pt-2">
                                 ...
                                 <strong class="d-block fw-bold text-theme1 fs-13 lh-normal">Build : </strong>
                        ...
                        <div class="col-lg-4 col-md-4 col-12 mt-4 d-flex align-items-stretch">
                           <div class="row align-items-center w-100 h-100 mx-0">
                              ...
                              <div class="col fs-14 lh-normal text-theme1 bg-white py-1 zi-0 rounded shadow pb-2 position-relative border-top border-theme1 border-2 border-bottom border-theme1 border-2 text-center pt-2">
                                 ...
                                 <strong class="d-block fw-bold text-theme1 fs-13 lh-normal">Monitor : </strong>
                        ...
                        <div class="col-lg-4 col-md-4 col-12 mt-4 d-flex align-items-stretch">
                           <div class="row align-items-center w-100 h-100 mx-0">
                              ...
                              <div class="col fs-14 lh-normal text-theme1 bg-white py-1 zi-0 rounded shadow pb-2 position-relative border-top border-theme1 border-2 border-bottom border-theme1 border-2 text-center pt-2">
                                 ...
                                 <strong class="d-block fw-bold text-theme1 fs-13 lh-normal">Secure : </strong>
         ...
         <div class="row">
            <div class="col-md-4 mt-lg-5 mt-md-4 mt-0 mb-md-0 mb-4">
               <div class="api_benifits text-center">
                  ...
                  <div class="col-12 fw-900 text-theme1 fs-xxl-20 fs-xl-20 fs-lg-18 fs-md-17 fs-16 lh-normal mt-lg-4 mt-md-3 mt-2 tz" style="--tz:30px;">Smart Interaction</div>
                  <div class="col-12 fw-600 fs-xxl-18 fs-xl-18 fs-lg-16 fs-md-15 fs-15 text-muted mt-2 tz" style="--tz:30px;">Delivering APIs that drive innovative interactions with clients and shareholders.</div>
            ...
            <div class="col-md-4 mt-lg-5 mt-md-4 mt-0 mb-md-0 mb-4">
               <div class="api_benifits text-center">
                  ...
                  <div class="col-12 fw-900 text-theme1 fs-xxl-20 fs-xl-20 fs-lg-18 fs-md-17 fs-16 lh-normal mt-lg-4 mt-md-3 mt-2 tz" style="--tz:30px;">Enhanced Brand</div>
                  <div class="col-12 fw-600 fs-xxl-18 fs-xl-18 fs-lg-16 fs-md-15 fs-15 text-muted mt-2 tz" style="--tz:30px;">Seamless API development that connects your brand with diverse platforms</div>
                  <div class="col-12 pt-4">
                     <!-- <a class="btn btn-theme1 fs-md-12 fs-12 fw-bold hero_read_more_btn py-2 px-md-2 px-2" style="transform-style: preserve-3d;" data-tilt data-tilt-max="3" data-tilt-speed="400" data-tilt-perspective="2500">
                        <span class="d-block"><span>Read More</span> <i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i></span>
                     </a> -->
            ...
            <div class="col-md-4 mt-lg-5 mt-md-4 mt-0 mb-md-0 mb-0">
               <div class="api_benifits text-center">
                  ...
                  <div class="col-12 fw-900 text-theme1 fs-xxl-20 fs-xl-20 fs-lg-18 fs-md-17 fs-16 lh-normal mt-lg-4 mt-md-3 mt-2 tz" style="--tz:30px;">Security</div>
                  <div class="col-12 fw-600 fs-xxl-18 fs-xl-18 fs-lg-16 fs-md-15 fs-15 text-muted mt-2 tz" style="--tz:30px;">Adheres to strict security standards for API development without hampering accessibility</div>
                  <div class="col-12 pt-4">
                     <!-- <a class="btn btn-theme1 fs-md-12 fs-12 fw-bold hero_read_more_btn py-2 px-md-2 px-2" style="transform-style: preserve-3d;" data-tilt data-tilt-max="3" data-tilt-speed="400" data-tilt-perspective="2500">
                        <span class="d-block"><span>Read More</span> <i class="imgd img-long-arrow-right position-relative bottom-n2px ms-2"></i></span>
                     </a> -->
                         ...
                         <div class="row">
                              <div class="col-5 pe-0">
                                  ...
                                  <div class="col-7 ps-0">
                                       <div class="form-floating">
                                        <input type="tel" name="tel" minlength="10" maxlength="10" oninput="this.value=this.value.replace(/[^0-9]/g,'');" class="form-control rounded-0 border border-0 fs-md-16 fs-14 " id="phoneNumber" placeholder="Enter Phone Number" required>
