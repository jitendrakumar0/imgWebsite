...
<div>This is only testing</div>
    {{-- <h1 class="d-none invisible">Website and Mobile App Development Company in India</h1> --}}
    {{-- <h6 class=""> <br><br><br>
        Website and Mobile App Development Company in India</h6> --}}
    <!-- hero section -->
                        ...
                        <div class="col-lg-6 col-md-5 hero_logo_section position-relative order-md-2 order-1 pt-4">
                            <div class="row hero_image_toggles2 align-items-center justify-content-center">
                                <div class="col-xxl-11 col-md-9 col-sm-7 col-10 hero_img_toggles2_inner p-5">
                                    <img class="hero_img2_step1" src="{{asset('/public')}}/assets/img/hero-section/slide2/fantasy-sports-app.webp" alt="fantasy-sports-app" width="365" height="365">
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="col-lg-6 col-md-5 hero_logo_section position-relative order-md-2 order-1 pt-4 pb-4">
                            <div class="row hero_image_toggles2 align-items-center justify-content-center">
                                <div class="col-xxl-11 col-md-9 col-sm-7 col-10 hero_img_toggles2_inner">
                                    <img class="hero_img2_step1" src="{{asset('/public')}}/assets/img/hero-section/slide3/hire-developer.webp" alt="hire-developer" width="365" height="365">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container h-100 position-relative zi-1 py-lg-0 py-md-5 pt-5 pb-0">
                    <div class="row h-100 align-items-md-center justify-content-around">
                        ...
                        <div class="col-lg-6 col-md-5 hero_logo_section position-relative order-md-2 order-1 pt-4">
                            <div class="row hero_image_toggles2 align-items-center justify-content-center">
                                <div class="col-xxl-11 col-md-9 col-sm-7 col-10 hero_img_toggles2_inner">
                                    <img class="hero_img2_step1" src="{{asset('/public')}}/assets/img/hero-section/slide3/mobileappdevelopment.webp" alt="mobileappdevelopment" width="365" height="365">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container h-100 position-relative zi-1 py-lg-0 py-md-5 pt-5 pb-0">
                    <div class="row h-100 align-items-md-center justify-content-around">
                        ...
                        <div class="col-lg-6 col-md-5 hero_logo_section position-relative order-md-2 order-1 pt-4">
                            <div class="row hero_image_toggles2 align-items-center justify-content-center">
                                <div class="col-xxl-11 col-md-9 col-sm-7 col-10 hero_img_toggles2_inner">
                                    <img class="hero_img2_step1" src="{{asset('/public')}}/assets/img/hero-section/slide1/web-development.webp" alt="web-development" width="365" height="365">
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="container h-100 position-relative zi-1 py-lg-0 py-md-5 pt-5 pb-0">
                    <div class="row h-100 align-items-md-center justify-content-around">
                        ...
                        <div class="col-lg-6 col-md-5 hero_logo_section position-relative order-md-2 order-1 pt-4">
                            <div class="row hero_image_toggles2 align-items-center justify-content-center">
                                <div class="col-xxl-11 col-md-9 col-sm-7 col-10 hero_img_toggles2_inner">
                                    <img class="hero_img2_step1" src="{{asset('/public')}}/assets/img/hero-section/slide4/mlm-software.webp" alt="mlm" width="365" height="365">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container py-4">
            <div class="row align-items-center">
                            ...
                            <div class="row countBoxOuter mx-0 g-3 text-center me-lg-n4">
                                <div class="col-sm-3 col-6">
                                    <div class="countBox" style="--d: 0s">
                                        ...
                                        <div class="fs-xxl-16 fs-xl-15 fs-lg-14 fs-sm-13 fs-12 lh-normal text-dark fw-900">Successful <br>Projects</div>
                                    </div>
                                </div>
                                <div class="col-sm-3 col-6">
                                    <div class="countBox" style="--d: 1s">
                                        <div class="aboutNumberText">98%</div>
                                        <div class="fs-xxl-16 fs-xl-15 fs-lg-14 fs-sm-13 fs-12 lh-normal text-dark fw-900">Success <br>Ratio</div>
                                    </div>
                                </div>
                                <div class="col-sm-3 col-6">
                                    <div class="countBox" style="--d: 2s">
                                        <div class="aboutNumberText">100+</div>
                                        <div class="fs-xxl-16 fs-xl-15 fs-lg-14 fs-sm-13 fs-12 lh-normal text-dark fw-900">Team <br>Members</div>
                                    </div>
                                </div>
                                <div class="col-sm-3 col-6">
                                    <div class="countBox" style="--d: 3s">
                                        <div class="aboutNumberText">8+</div>
                                        <div class="fs-xxl-16 fs-xl-15 fs-lg-14 fs-sm-13 fs-12 lh-normal text-dark fw-900">Years in <br>Industry</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-auto text-center text-md-left px-0 mt-4">
                            <a href="#portfolioTarget" class="btn btn-theme1 text-white fs-lg-14 fs-12 fw-bold my-3 px-lg-4 py-2 px-3 ms-md-2">
                ...
                <div class="col-lg-6 col-xxl-7 order-1 order-lg-2">
                    <img src="{{asset('/public')}}/assets/img/about-us-new/aboutNew2.png" class="w-100 h-auto" width="746" height="632" alt="service-layer1">
                        ...
                        <div class="col-12">
                            <div class="row ">
                                        ...
                                        <div class="col-12 py-3">
                                            <div class="row row-cols-lg-2 g-3 row-cols-md-1 row-cols-2">
                                                <div class="col d-flex">
                                                    <a href="https://www.imgglobalinfotech.com/android-application-development.php" class="serivcesLinks fs-md-15 fs-13 w-md-100 w-lg-auto w-100 w-sm-auto mx-sm-auto ms-lg-0 justify-content-sm-center justify-content-md-start">
                                                        <div class="imgOuter">
                                                ...
                                                <div class="col d-flex">
                                                    <a href="https://www.imgglobalinfotech.com/ios-app-development.php" class="serivcesLinks fs-md-15 fs-13 w-md-100 w-lg-auto w-100 w-sm-auto mx-sm-auto ms-lg-0 justify-content-sm-center justify-content-md-start">
                                                        <div class="imgOuter">
                                                ...
                                                <div class="col d-flex">
                                                    <a href="http://imgglobalinfotech.com/flutter-app-development.php" class="serivcesLinks fs-md-15 fs-13 w-md-100 w-lg-auto w-100 w-sm-auto mx-sm-auto ms-lg-0 justify-content-sm-center justify-content-md-start">
                                                        <div class="imgOuter">
                                                ...
                                                <div class="col d-flex">
                                                    <a href="https://www.imgglobalinfotech.com/react-native-app-development.php" class="serivcesLinks fs-md-15 fs-13 w-md-100 w-lg-auto w-100 w-sm-auto mx-sm-auto ms-lg-0 justify-content-sm-center justify-content-md-start">
                                                        <div class="imgOuter">
                                ...
                                <div class="col-lg-6 col-md-7 col-12 rightPart">
                                    <div class="imgOuter">
                                        <img src="{{asset('/public')}}/assets/img/new-services/mobile-application-development.webp" width="512" height="516" alt="Talk to our Experts">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="row flex-row-reverse">
                                <div class="col-lg-6 col-md-5 col-12 leftPart p-xxl-4 p-2">
                                    <div class="row">
                                        ...
                                        <div class="col-12 py-3">
                                            <div class="row row-cols-lg-2 g-3 row-cols-md-1 row-cols-2">
                                                <div class="col d-flex">
                                                    <a href="http://imgglobalinfotech.com/parallax-web-designing-services.php" class="serivcesLinks fs-md-15 fs-13 w-md-100 w-lg-auto w-100 w-sm-auto mx-sm-auto ms-lg-0 justify-content-sm-center justify-content-md-start">
                                                        <div class="imgOuter">
                                                ...
                                                <div class="col d-flex">
                                                    <a href="http://imgglobalinfotech.com/dynamic-website-designing-services.php" class="serivcesLinks fs-md-15 fs-13 w-md-100 w-lg-auto w-100 w-sm-auto mx-sm-auto ms-lg-0 justify-content-sm-center justify-content-md-start">
                                                        <div class="imgOuter">
                                                ...
                                                <div class="col d-flex">
                                                    <a href="https://www.imgglobalinfotech.com/responsive-web-designing-services.php" class="serivcesLinks fs-md-15 fs-13 w-md-100 w-lg-auto w-100 w-sm-auto mx-sm-auto ms-lg-0 justify-content-sm-center justify-content-md-start">
                                                        <div class="imgOuter">
                                                ...
                                                <div class="col d-flex">
                                                    <a href="https://www.imgglobalinfotech.com/website-redesigning-services.php" class="serivcesLinks fs-md-15 fs-13 w-md-100 w-lg-auto w-100 w-sm-auto mx-sm-auto ms-lg-0 justify-content-sm-center justify-content-md-start">
                                                        <div class="imgOuter">
                                ...
                                <div class="col-lg-6 col-md-7 col-12 rightPart">
                                    <div class="imgOuter">
                                        <img src="{{asset('/public')}}/assets/img/new-services/website-designing.webp" width="624" height="365" alt="Talk to our Experts">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="row ">
                                ...
                                <div class="col-lg-6 col-md-7 col-12 rightPart">
                                    <div class="imgOuter">
                                        <img src="{{asset('/public')}}/assets/img/new-services/website-development.webp" width="583" height="432" alt="Talk to our Experts">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="row flex-row-reverse">
                                <div class="col-lg-6 col-md-5 col-12 leftPart p-xxl-4 p-2">
                                    <div class="row">
                                        ...
                                        <div class="col-12 py-3">
                                            <div class="row row-cols-lg-2 g-3 row-cols-md-1 row-cols-2">
                                                <div class="col d-flex">
                                                    <a href="http://imgglobalinfotech.com/school-management-software.php" class="serivcesLinks fs-md-15 fs-13 w-md-100 w-lg-auto w-100 w-sm-auto mx-sm-auto ms-lg-0 justify-content-sm-center justify-content-md-start">
                                                        <div class="imgOuter">
                                                ...
                                                <div class="col d-flex">
                                                    <a href="http://imgglobalinfotech.com/mlm-software-development-company.php" class="serivcesLinks fs-md-15 fs-13 w-md-100 w-lg-auto w-100 w-sm-auto mx-sm-auto ms-lg-0 justify-content-sm-center justify-content-md-start">
                                                        <div class="imgOuter">
                                                ...
                                                <div class="col d-flex">
                                                    <a href="http://imgglobalinfotech.com/online-exam-management-software.php" class="serivcesLinks fs-md-15 fs-13 w-md-100 w-lg-auto w-100 w-sm-auto mx-sm-auto ms-lg-0 justify-content-sm-center justify-content-md-start">
                                                        <div class="imgOuter">
                                ...
                                <div class="col-lg-6 col-md-7 col-12 rightPart">
                                    <div class="imgOuter">
                                        <img src="{{asset('/public')}}/assets/img/new-services/custome-erp.webp" width="610" height="420" alt="Talk to our Experts">
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="row ">
                                <div class="col-lg-6 col-md-5 col-12 leftPart p-xxl-4 p-2">
                                    <div class="row">
                                        <div class="col-12 fs-md-22 fs-sm-20 fs-18 text-theme1 fw-900 text-md-start text-center">MVP Startups</div>
                                ...
                                <div class="col-lg-6 col-md-7 col-12 rightPart">
                                    <div class="imgOuter">
                                        <img src="{{asset('/public')}}/assets/img/new-services/mvp-development.png" width="583" height="432" alt="Talk to our Experts">
                                    </div>
                                </div>
                            </div>
                        </div>
                ...
                <div class="col-lg-6 mb-4 pb-5 mb-lg-0 pb-lg-0">
                    <div class="row mx-0">
                        ...
                        <div class="col-12 text-md-start text-center d-none d-lg-block px-0 mt-2">
                            <a href="{{asset('/mobile-app-development.php')}}" class="btn btn-theme1 fs-xxl-13 fs-11 fw-bold py-xxl-2 py-1 px-4">
                            ...
                            <div class="animateCardWrapper d-flex align-items-center justify-content-center position-relative">
                                <div class="animateCardOuter position-relative">
                                    <a href="https://www.imgglobalinfotech.com/food-delivery-app-development.php" class="animateCard position-absolute top-0 start-0 zi-2 bg-white overflow-hidden w-100 h-100 text-decoration-none" style="--i:1; --j:12s">
                                        <div class="animateCardInner row mx-0 shadow-none rounded-0 p-0 position-relative w-100 bg-white overflow-hidden">
                                            <div class="col-12 animateImg position-relative d-flex align-items-center justify-content-center">
                                                <img width="300" height="200" src="{{asset('/public')}}/assets/img/success-story-new/Food-Delivery-App.webp" class="mw-100" alt="service-layer1">
                                            </div>
                                            <div class="col-12">
                                                <div class="row animateDetailBox">
                                                    <div class="col-12 animateHeading fs-md-20 fs-sm-20 fs-18 fw-bold lh-normal text-center text-md-start">Food Delivery app</div>
                                                    ...
                                                    <div class="col-12 text-md-start text-center mt-2">
                                                        <button class="btn btn-theme1 fs-xxl-12 fs-11 fw-bold py-xxl-2 py-1 px-3">
                                    ...
                                    <a href="https://www.imgglobalinfotech.com/grocery-app-development.php" class="animateCard position-absolute top-0 start-0 zi-2 bg-white overflow-hidden w-100 h-100 text-decoration-none" style="--i:2; --j:12s">
                                        <div class="animateCardInner row mx-0 shadow-none rounded-0 p-0 position-relative w-100 bg-white overflow-hidden">
                                            <div class="col-12 animateImg position-relative d-flex align-items-center justify-content-center">
                                                <img width="300" height="200" src="{{asset('/public')}}/assets/img/success-story-new/grocerry-app2.webp" class="mw-100" alt="service-layer1">
                                            </div>
                                            <div class="col-12">
                                                <div class="row animateDetailBox">
                                                    <div class="col-12 animateHeading fs-md-20 fs-sm-20 fs-18 fw-bold lh-normal text-center text-md-start">Grocery App</div>
                                    ...
                                    <a href="https://www.imgglobalinfotech.com/pharmacy-app-development.php" class="animateCard position-absolute top-0 start-0 zi-2 bg-white overflow-hidden w-100 h-100 text-decoration-none" style="--i:3; --j:12s">
                                        <div class="animateCardInner row mx-0 shadow-none rounded-0 p-0 position-relative w-100 bg-white overflow-hidden">
                                            <div class="col-12 animateImg position-relative d-flex align-items-center justify-content-center">
                                                <img width="300" height="200" src="{{asset('/public')}}/assets/img/success-story-new/Medicine-Delivery-App.webp" class="mw-100" alt="service-layer1">
                                            </div>
                                            <div class="col-12">
                                                <div class="row animateDetailBox">
                                                    <div class="col-12 animateHeading fs-md-20 fs-sm-20 fs-18 fw-bold lh-normal text-center text-md-start">Medicine Delivery App</div>
                                    ...
                                    <a href="https://www.imgglobalinfotech.com/taxi-app-development-company.php" class="animateCard position-absolute top-0 start-0 zi-2 bg-white overflow-hidden w-100 h-100 text-decoration-none" style="--i:4; --j:12s">
                                        <div class="animateCardInner row mx-0 shadow-none rounded-0 p-0 position-relative w-100 bg-white overflow-hidden">
                                            <div class="col-12 animateImg position-relative d-flex align-items-center justify-content-center">
                                                <img width="300" height="200" src="{{asset('/public')}}/assets/img/success-story-new/Taxi-Booking-App.webp" class="mw-100" alt="service-layer1">
                                            </div>
                                            <div class="col-12">
                                                <div class="row animateDetailBox">
                                                    <div class="col-12 animateHeading fs-md-20 fs-sm-20 fs-18 fw-bold lh-normal text-center text-md-start">Taxi Booking App</div>
                                    ...
                                    <a href="https://www.imgglobalinfotech.com/elearning-app-development.php" class="animateCard position-absolute top-0 start-0 zi-2 bg-white overflow-hidden w-100 h-100 text-decoration-none" style="--i:5; --j:12s">
                                        <div class="animateCardInner row mx-0 shadow-none rounded-0 p-0 position-relative w-100 bg-white overflow-hidden">
                                            <div class="col-12 animateImg position-relative d-flex align-items-center justify-content-center">
                                                <img width="300" height="200" src="{{asset('/public')}}/assets/img/success-story-new/E-learning-App.webp" class="mw-100" alt="service-layer1">
                                            </div>
                                            <div class="col-12">
                                                <div class="row animateDetailBox">
                                                    <div class="col-12 animateHeading fs-md-20 fs-sm-20 fs-18 fw-bold lh-normal text-center text-md-start">eLearning App</div>
                                    ...
                                    <a href="https://www.imgglobalinfotech.com/online-exam-app-development.php" class="animateCard position-absolute top-0 start-0 zi-2 bg-white overflow-hidden w-100 h-100 text-decoration-none" style="--i:6; --j:12s">
                                        <div class="animateCardInner row mx-0 shadow-none rounded-0 p-0 position-relative w-100 bg-white overflow-hidden">
                                            <div class="col-12 animateImg position-relative d-flex align-items-center justify-content-center">
                                                <img width="300" height="200" src="{{asset('/public')}}/assets/img/success-story-new/Online-Classes-App.webp" class="mw-100" alt="service-layer1">
                                            </div>
                                            <div class="col-12">
                                                <div class="row animateDetailBox">
                                                    <div class="col-12 animateHeading fs-md-20 fs-sm-20 fs-18 fw-bold lh-normal text-center text-md-start">Online Classes App</div>
                ...
                <div class="col-12 ctaCardSection">
                    <div class="row">
                        <div class="col-xl-9 col-12 mx-auto">
                            <div class="row">
                                <div class="col-12 fs-lg-38 fs-md-34 fs-sm-28 fs-20 fw-bold text-white mb-4 text-center">
        ...
        <div class="container py-4 pb-lg-5 pt-0">
            <div class="row justify-content-center">
                <div class="col-10 col-sm-12 col-lg-10">
                    <img src="{{asset('/public')}}/assets/img/process-flow/process-flow.webp" width="1076" height="793" class="w-100 h-auto d-none d-sm-block" alt="process flow">
                    <img src="{{asset('/public')}}/assets/img/process-flow/mobileprocess.webp" width="323" height="691" class="w-100 h-auto d-sm-none" alt="process flow">
                </div>
            </div>
        </div>
    </div> --}}
                            ...
                            <a href="javascript:;" class="card">
                                <div class="card-body row mx-0">
                                    <div class="col-12 px-0 imgMiddal">
                                        <div class="imgOuter">
                                            <img width="54" height="54" src="{{asset('/public')}}/assets/img/new-industries/fantacy-sports.svg" class="w-100 h-auto" alt="Fantasy Sports">
                                        </div>
                                    </div>
                        ...
                        <div class="col-md col-sm-7 col-auto">
                            <a href="javascript:;" class="card">
                                <div class="card-body row mx-0">
                                    <div class="col-12 px-0 imgMiddal">
                                        <div class="imgOuter">
                                            <img width="54" height="54" src="{{asset('/public')}}/assets/img/new-industries/health-care.svg" class="w-100 h-auto" alt="Healthcare">
                                        </div>
                                    </div>
                                    <div class="col-12 text-muted pt-2 fw-900 fs-xl-17 fs-lg-15 fs-14 text-center">
                                        Healthcare
                        ...
                        <div class="col-md col-sm-7 col-auto">
                            <a href="javascript:;" class="card">
                                <div class="card-body row mx-0">
                                    <div class="col-12 px-0 imgMiddal">
                                        <div class="imgOuter">
                                            <img width="54" height="54" src="{{asset('/public')}}/assets/img/new-industries/banking-and-finance.svg" class="w-100 h-auto" alt="Banking and Finance">
                                        </div>
                                    </div>
                                    <div class="col-12 text-muted pt-2 fw-900 fs-xl-17 fs-lg-15 fs-14 text-center">
                                        Banking and Finance
                        ...
                        <div class="col-md col-sm-7 col-auto">
                            <a href="javascript:;" class="card">
                                <div class="card-body row mx-0">
                                    <div class="col-12 px-0 imgMiddal">
                                        <div class="imgOuter">
                                            <img width="54" height="54" src="{{asset('/public')}}/assets/img/new-industries/travel-and-tourism.svg" class="w-100 h-auto" alt="Travel and Tourism">
                                        </div>
                                    </div>
                                    <div class="col-12 text-muted pt-2 fw-900 fs-xl-17 fs-lg-15 fs-14 text-center">
                                        Travel and Tourism
                        ...
                        <div class="col-md col-sm-7 col-auto">
                            <a href="javascript:;" class="card">
                                <div class="card-body row mx-0">
                                    <div class="col-12 px-0 imgMiddal">
                                        <div class="imgOuter">
                                            <img width="54" height="54" src="{{asset('/public')}}/assets/img/new-industries/edtech-solution.svg" class="w-100 h-auto" alt="Edtech Solution">
                                        </div>
                                    </div>
                                    <div class="col-12 text-muted pt-2 fw-900 fs-xl-17 fs-lg-15 fs-14 text-center">
                                        Edtech Solution
                        ...
                        <div class="col-md col-sm-7 col-auto">
                            <a href="javascript:;" class="card">
                                <div class="card-body row mx-0">
                                    <div class="col-12 px-0 imgMiddal">
                                        <div class="imgOuter">
                                            <img width="54" height="54" src="{{asset('/public')}}/assets/img/new-industries/logistic-services-app.svg" class="w-100 h-auto" alt="Logistic Services Apps">
                                        </div>
                                    </div>
                                    <div class="col-12 text-muted pt-2 fw-900 fs-xl-17 fs-lg-15 fs-14 text-center">
                        ...
                        <div class="col-md col-sm-7 col-auto">
                            <a href="javascript:;" class="card">
                                <div class="card-body row mx-0">
                                    <div class="col-12 px-0 imgMiddal">
                                        <div class="imgOuter">
                                            <img width="54" height="54" src="{{asset('/public')}}/assets/img/new-industries/media and entertainment.svg" class="w-100 h-auto" alt="Media and Entertainment">
                                        </div>
                                    </div>
                                    <div class="col-12 text-muted pt-2 fw-900 fs-xl-17 fs-lg-15 fs-14 text-center">
                        ...
                        <div class="col-md col-sm-7 col-auto">
                            <a href="javascript:;" class="card">
                                <div class="card-body row mx-0">
                                    <div class="col-12 px-0 imgMiddal">
                                        <div class="imgOuter">
                                            <img width="54" height="54" src="{{asset('/public')}}/assets/img/new-industries/retails-and-ecommerce.svg" class="w-100 h-auto" alt="Retails and Ecommerce Apps">
                                        </div>
                                    </div>
                                    <div class="col-12 text-muted pt-2 fw-900 fs-xl-17 fs-lg-15 fs-14 text-center">
                        ...
                        <div class="col-md col-sm-7 col-auto">
                            <a href="javascript:;" class="card">
                                <div class="card-body row mx-0">
                                    <div class="col-12 px-0 imgMiddal">
                                        <div class="imgOuter">
                                            <img width="54" height="54" src="{{asset('/public')}}/assets/img/new-industries/social-apps.svg" class="w-100 h-auto" alt="Social Apps">
                                        </div>
                                    </div>
                                    <div class="col-12 text-muted pt-2 fw-900 fs-xl-17 fs-lg-15 fs-14 text-center">
                                        Social Apps
                        ...
                        <div class="col-md col-sm-7 col-auto">
                            <a href="javascript:;" class="card">
                                <div class="card-body row mx-0">
                                    <div class="col-12 px-0 imgMiddal">
                                        <div class="imgOuter">
                                            <img width="54" height="54" src="{{asset('/public')}}/assets/img/new-industries/auto-mobile.svg" class="w-100 h-auto" alt="Automobile">
                                        </div>
                                    </div>
                                    <div class="col-12 text-muted pt-2 fw-900 fs-xl-17 fs-lg-15 fs-14 text-center">
                                        Automobile
    ...
    {{-- <div class="container-fluid hireDeveloperSection px-lg-0 py-4 py-md-5">
        <div class="row mx-0">
            <div class="col-auto letImgOuter px-0">
                <div class="leftImg">
                    <img src="{{asset('/public')}}/assets/img/new-hire-developers/hire-developer.png" width="459" height="603" class="w-100" alt="hire-developer">
                </div>
            </div>
                                ...
                                <div class="row flex-column">
                                    <div class="col-auto text-center">
                                        <div class="heading fs-md-14 fs-12 left d-none d-md-block">
                                            <span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20 fw-bold lh-1 pt-0"> Hire Remote <br><b class="fs-xxl-56 fs-xl-46 fs-md-36 fs-26 fw-900 lh-sm">Developer</b></span>
                                        </div>
                                        <div class="heading fs-md-14 fs-12 text-center d-md-none">
                                            <span class="fs-xl-32 fs-lg-28 fs-md-24 fs-20 fw-bold lh-1 pt-0"> Hire Remote <b class="fs-xxl-56 fs-xl-46 fs-md-36 fs-26 fw-900 lh-sm">Developer</b></span>
                                        </div>
                                    </div>
                                    <div class="col-auto pt-4 fs-xl-18 fs-md-16 fs-14 text-dark fw-600 text-md-start text-center me-lg-5 pe-lg-5">We are offering a dedicated team model that consists of developers and team members who hold the best industry experience along with strong technical knowledge and expertise.</div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="row row-cols-xxl-5 justify-content-center justify-content-lg-start  row-cols-lg-4 row-cols-lg-2 row-cols-md-4 row-cols-sm-3 row-cols-2 g-sm-4 g-2">
                            <div class="col">
                                <a href="{{ asset('hire-android-app-developers.php') }}" class="card">
                                    <div class="card-body">
                                        <div class="imgOuter">
                                            <img width="50" height="67" src="{{asset('/public')}}/assets/img/new-hire-developers/android.png" alt="Hire Android Developer">
                                        </div>
                                        <strong class="text-dark fs-15 d-block fw-bold">Hire Android Developer </strong>
                                    </div>
                                </a>
                            </div>
                            <div class="col">
                                <a href="{{ asset('hire-android-app-developers.php') }}" class="card">
                                    <div class="card-body">
                                        <div class="imgOuter">
                                            <img width="50" height="67" src="{{asset('/public')}}/assets/img/new-hire-developers/java.png" alt="Hire Java Developer">
                                        </div>
                                        <strong class="text-dark fs-15 d-block fw-bold">Hire Java Developer </strong>
                                    </div>
                                </a>
                            </div>
                            <div class="col">
                                <a href="{{ asset('hire-node-js-developers.php') }}" class="card">
                                    <div class="card-body">
                                        <div class="imgOuter">
                                            <img width="50" height="67" src="{{asset('/public')}}/assets/img/new-hire-developers/node-js.png" alt="Hire Node.JS Developer">
                                        </div>
                                        <strong class="text-dark fs-15 d-block fw-bold">Hire Node.JS Developer </strong>
                                    </div>
                                </a>
                            </div>
                            <div class="col">
                                <a href="{{ asset('hire-react-native-app-developers.php') }}" class="card">
                                    <div class="card-body">
                                        <div class="imgOuter">
                                            <img width="50" height="67" src="{{asset('/public')}}/assets/img/new-hire-developers/react-native.png" alt="Hire React Native Developer">
                                        </div>
                                        <strong class="text-dark fs-15 d-block fw-bold">Hire React Native Developer </strong>
                                    </div>
                                </a>
                            </div>
                            <div class="col">
                                <a href="{{ asset('hire-flutter-app-developers.php') }}" class="card">
                                    <div class="card-body">
                                        <div class="imgOuter">
                                            <img width="50" height="67" src="{{asset('/public')}}/assets/img/new-hire-developers/flutter.png" alt="Hire Flutter Developer">
                                        </div>
                                        <strong class="text-dark fs-15 d-block fw-bold">Hire Flutter Developer </strong>
                                    </div>
                                </a>
                            </div>
                            <div class="col">
                                <a href="{{ asset('hire-react-js-developers.php') }}" class="card">
                                    <div class="card-body">
                                        <div class="imgOuter">
                                            <img width="50" height="67" src="{{asset('/public')}}/assets/img/new-hire-developers/reactsvg.png" alt="Hire React.JS Developer">
                                        </div>
                                        <strong class="text-dark fs-15 d-block fw-bold">Hire React.JS Developer </strong>
                                    </div>
                                </a>
                            </div>
                            <div class="col">
                                <a href="{{ asset('hire-web-desginers.php') }}" class="card">
                                    <div class="card-body">
                                        <div class="imgOuter">
                                            <img width="50" height="67" src="{{asset('/public')}}/assets/img/new-hire-developers/webdesign.png" alt="Hire Web Designer">
                                        </div>
                                        <strong class="text-dark fs-15 d-block fw-bold"> Hire Web Designer </strong>
                                    </div>
                                </a>
                            </div>
                            <div class="col">
                                <a href="{{ asset('hire-php-developers.php') }}" class="card">
                                    <div class="card-body">
                                        <div class="imgOuter">
                                            <img width="50" height="67" src="{{asset('/public')}}/assets/img/new-hire-developers/Php.png" alt="Hire php Developer">
                                        </div>
                                        <strong class="text-dark fs-15 d-block fw-bold">Hire php Developer </strong>
                                    </div>
                                </a>
                            </div>
                            <div class="col">
                                <a href="{{ asset('hire-angular-developers.php') }}" class="card">
                                    <div class="card-body">
                                        <div class="imgOuter">
                                            <img width="50" height="67" src="{{asset('/public')}}/assets/img/new-hire-developers/angular.png" alt="Hire Angular Developer">
                                        </div>
                                        <strong class="text-dark fs-15 d-block fw-bold">Hire Angular Developer </strong>
                                    </div>
                                </a>
                            </div>
                            <div class="col">
                                <a href="{{ asset('offshore-web-development-india.php') }}" class="card customBg p-1">
                                    <div class="card-body d-flex align-items-center py-4 justify-content-center flex-column text-white">
                                        ...
                                        <strong class="fs-md-15 fs-14 d-block text-uppercase text-center fw-900">Let's Connect</strong>
                                    </div>
                                </a>
                            </div>
                        </div>
                        ...
                        <div class="col-12 trandingTabs">
                            <ul class="nav nav-tabs" id="myTab" role="tablist">
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link active customNavBtn card" id="arVr-tab" data-bs-toggle="tab" data-bs-target="#arVr-tab-pane" type="button" role="tab" aria-controls="arVr-tab-pane" aria-selected="true">
                                        <div class="card-body">
                                            <div class="imgOuter">
                                                <img width="50" height="50" src="{{asset('/public')}}/assets/img/new-tranding/ar-vr.svg" class="w-100 h-auto" alt="AR & VR">
                                            </div>
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link customNavBtn card" id="wireableApp-tab" data-bs-toggle="tab" data-bs-target="#wireableApp-tab-pane" type="button" role="tab" aria-controls="wireableApp-tab-pane" aria-selected="false">
                                        <div class="card-body">
                                            <div class="imgOuter">
                                                <img width="50" height="50" src="{{asset('/public')}}/assets/img/new-tranding/wearable.svg" class="w-100 h-auto" alt="Wearable App">
                                            </div>
                                ...
                                <li class="nav-item" role="presentation">
                                    <button class="nav-link customNavBtn card" id="iotApp-tab" data-bs-toggle="tab" data-bs-target="#iotApp-tab-pane" type="button" role="tab" aria-controls="iotApp-tab-pane" aria-selected="false">
                                        <div class="card-body">
                                            <div class="imgOuter">
                                                <img width="50" height="50" src="{{asset('/public')}}/assets/img/new-tranding/iot.svg" class="w-100 h-auto" alt="IOT Apps">
                                            </div>
                            ...
                            <div class="tab-content" id="myTabContent">
                                <div class="tab-pane fade show active" id="arVr-tab-pane" role="tabpanel" aria-labelledby="arVr-tab" tabindex="0">
                                    <div class="row">
                                        <div class="col-lg-5 col-12 mb-4 mb-lg-0 leftSide">
                                            <div class="row">
                                                <div class="col-12 fs-md-22 fs-sm-20 fs-18 text-theme3 fw-900 text-lg-start text-center">AR/VR App Development</div>
                                                ...
                                                <div class="col-12 pt-4 d-none d-lg-block">
                                                    <a href="{{asset('/contact-us.php')}}" class="btn btn-theme3 fs-xxl-13 fs-11 fw-bold py-xxl-2 py-1 px-4">
                                        ...
                                        <div class="col-lg-7 col-12 rightSide">
                                            <div class="norImg">
                                                <img src="{{asset('/public')}}/assets/img/new-tranding/AR-VR-App-Development.webp" width="746" height="501" alt="AR-VR-App-Development">
                                            </div>
                                        </div>
                                ...
                                <div class="tab-pane fade" id="wireableApp-tab-pane" role="tabpanel" aria-labelledby="wireableApp-tab" tabindex="0">
                                    <div class="row">
                                        <div class="col-lg-5 col-12 mb-4 mb-lg-0 leftSide">
                                            <div class="row">
                                                <div class="col-12 fs-md-22 fs-sm-20 fs-18 text-theme3 fw-900 text-lg-start text-center">Wearable App Development</div>
                                                <div class="col-12 fs-lg-17 fs-md-16 fs-14 my-md-4 mb-2 mt-1 service_content text-lg-start text-center">
                                        ...
                                        <div class="col-lg-7 col-12 rightSide">
                                            <div class="norImg">
                                                <img src="{{asset('/public')}}/assets/img/new-tranding/Wearable-App.webp" width="746" height="501" alt="Wearable-App">
                                            </div>
                                        </div>
                                        <div class="col-12 mt-5 text-center d-lg-none">
                                            <a href="{{asset('/contact-us.php')}}" class="btn btn-theme3 fs-xxl-13 fs-11 fw-bold py-xxl-2 py-1 px-4">
                                ...
                                <div class="tab-pane fade" id="iotApp-tab-pane" role="tabpanel" aria-labelledby="contact-tab" tabindex="0">
                                    <div class="row">
                                        <div class="col-lg-5 col-12 mb-4 mb-lg-0 leftSide">
                                            <div class="row">
                                                <div class="col-12 fs-md-22 fs-sm-20 fs-18 text-theme3 fw-900 text-lg-start text-center">IoT App Development</div>
                                        ...
                                        <div class="col-lg-7 col-12 rightSide">
                                            <div class="norImg">
                                                <img src="{{asset('/public')}}/assets/img/new-tranding/IOT-App-development.webp" width="746" height="501" alt="IOT-App-development">
                                            </div>
                                        </div>
                                        <div class="col-12 mt-5 text-center d-lg-none">
                                            <a href="{{asset('/contact-us.php')}}" class="btn btn-theme3 fs-xxl-13 fs-11 fw-bold py-xxl-2 py-1 px-4">
        ...
        <div class="container py-4 position-relative ">
            ...
            <div class="row align-items-center justify-content-center owl-portfolio-slider owl-carousel mx-0">
                ...
                <div class="portfolioBox ">
                    <img width="415" height="519" src="{{asset('/public')}}/assets/img/portfolio-section/blank-image.webp" class="lazy-image img-fluid w-100 rounded-2 border border-1 p-1" 
                    ...
                    <div class="row g-4">
                            ...
                            <div class="card caseCard">
                                <div class="card-body row mx-0">
                                    <div class="col-12 imgOuter p-0">
                                        <img src="{{asset('/public')}}/assets/img/new-case-study/myfab11-casestudy.webp" width="636" height="461" alt="MyFab11">
                                    </div>
                                    <div class="col-12 cardTextSection p-lg-4 p-3">
                                        <div class="row mx-0">
                                            <div class="col-12 fs-lg-20 fs-18 fw-900 text-center text-dark">
                                                MyFab11
                                            </div>
                                            <div class="col-12 px-0 pt-lg-3 pt-2">
                                                <div class="row mx-0 align-items-center justify-content-center gap-3">
                                                    <a href="https://apk.myfab11.com/myfab11.apk" class="col-auto cardBtn text-decoration-none" target="_blank">
                                                        <div class="row g-2 align-items-center">
                                                            <div class="col-auto iconOuter">
                                                                <img src="{{asset('/public')}}/assets/img/new-case-study/tagiconandroid.svg" width="12" height="20" alt="Android">
                                                            </div>
                                                            <div class="col-auto fs-lg-16 fs-15 fw-900 cardBtnText">
                                                                Android
                                                            </div>
                                                        </div>
                                                    </a>
                                                    <a href="https://myfab11.com/" class="col-auto cardBtn text-decoration-none" target="_blank">
                                                        <div class="row g-2 align-items-center">
                                                            <div class="col-auto iconOuter">
                                                                <img src="{{asset('/public')}}/assets/img/new-case-study/tagiconwebsite.svg" width="12" height="20" alt="Website">
                                                            </div>
                                                            <div class="col-auto fs-lg-16 fs-15 fw-900 text-theme1">
                                                                Website
                                                            </div>
                                                        </div>
                                                    </a>
                        ...
                        <div class="col-md-6 col-12">
                            <div class="card caseCard">
                                <div class="card-body row mx-0">
                                    <div class="col-12 imgOuter p-0">
                                        <img src="{{asset('/public')}}/assets/img/new-case-study/propira-casestudy.png" width="636" height="461" alt="Propia">
                                    </div>
                                    <div class="col-12 cardTextSection p-lg-4 p-3">
                                        <div class="row mx-0">
                                            <div class="col-12 fs-lg-20 fs-18 fw-900 text-center text-dark">
                                                ...
                                                <div class="row blog_slider owl-carousel">
                                                  ...
                                                  <a href="https://www.imgglobalinfotech.com/blog/fantasy-cricket-app-development-for-ipl-2023" class="col-lg-3 col-md-6 col-12 text-dark text-decoration-none my-md-3 my-2 blog-items">
                                                    ...
                                                    <a href="https://www.imgglobalinfotech.com/blog/fantasy-sports-app-development-for-wpl-2023" class="col-lg-3 col-md-6 col-12 text-dark text-decoration-none my-md-3 my-2 blog-items">
                                                        <div class="row mx-1 py-3 bg-white rounded">
                                                            <div class="col-12 position-relative overflow-hidden blog-img-hvr">
                                                             <img src="{{asset('/public')}}/assets/img/blog-section/blog-shape.avif" class="lazy-image"  
                                                             data-src="{{asset('/public')}}/assets/img/blog-section/Fantasy-Sports-App-Development-for-Womens-Premier-League-2023.avif" class="img-fluid" alt="Fantasy-Sports-App-Development-for-Womens-Premier-League-2023" width="298" height="170" >
                                                             </div>
                                                            <div class="col-12 fs-14 text-muted fw-bold py-2">
                                                  ...
                                                  <a href="https://www.imgglobalinfotech.com/blog/top-10-restaurant-app-development-companies-in-india-2023" class="col-lg-3 col-md-6 col-12 text-dark text-decoration-none my-md-3 my-2 blog-items">
                                                        <div class="row mx-1 py-3 bg-white rounded">
                                                            <div class="col-12 position-relative overflow-hidden blog-img-hvr">
                                                             <img src="{{asset('/public')}}/assets/img/blog-section/blog-shape.avif" class="lazy-image"  
                                                             data-src="{{asset('/public')}}/assets/img/blog-section/Top-10-Restaurant-App-Development-Companies-in-India-2023-Cost-and-Key-Features.avif" class="img-fluid" alt="Top-10-Restaurant-App-Development-Companies-in-India-2023-Cost-and-Key-Features" width="298" height="170" >
                                                             </div>
                                                            <div class="col-12 fs-14 text-muted fw-bold py-2">
