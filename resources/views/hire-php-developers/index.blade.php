...
@push('meta')
   <!--  Title -->
   <title>Hire PHP Developers from India | PHP Web Development Company</title>

   <!-- Required meta tags -->
   <meta name="title" content="Hire PHP Developers from India | PHP Web Development Company" />
   <meta name="description" content="Looking to hire dedicated PHP developers for your project? Our team of skilled PHP developers can provide customized solutions to meet your specific needs. " />
   <meta name="keywords" content="" />

   <!-- Twitter Meta -->
   <meta name="twitter:title" content="Hire PHP Developers from India | PHP Web Development Company">
   <meta name="twitter:description" content="Looking to hire dedicated PHP developers for your project? Our team of skilled PHP developers can provide customized solutions to meet your specific needs. ">
   ...
   <meta property="og:title" content="Hire PHP Developers from India | PHP Web Development Company">
   <meta property="og:description" content="Looking to hire dedicated PHP developers for your project? Our team of skilled PHP developers can provide customized solutions to meet your specific needs. ">
            ...
            <div class="col-md-12">
               <nav aria-label="breadcrumb">
                  <ol class="breadcrumb mb-0">
                     ...
                     <li class="breadcrumb-item active fw-600 fs-lg-16 fs-md-15 fs-14 text-dark" aria-current="page">Hire Php Developers </li>
                  </ol>
               </nav>
            </div>
         </div>
                     ...
                     <div class="row align-items-center mx-lg-5 mx-md-2 mx-0">
                        <div class="col-lg-8 col-md-8 col-12">
                           ...
                           <div class="col-lg-4 col-md-4 col-12 d-flex justify-content-lg-end justify-content-md-end justify-content-center py-2">
                               <a href="{{asset('/hire-php-developers.php#contactWithUss')}}" class="btn expert-btn fs-lg-20 fs-md-17 fs-14 fw-bold py-3 px-md-4 px-4 bg-white">
                  ...
                  <div class="container-fluid hire-section white py-lg-5 py-md-5 py-5 position-relative">
                           ...
                           <div class="container">
                              <div class="row align-items-lg-end align-items-md-center justify-content-lg-end justify-content-md-center">
                                 <div class="col-xl-6 col-lg-6 col-md-12 ps-lg-5 ps-md-0">
                                    <div class="col-12 fw-900 fs-lg-32 fs-md-38 fs-sm-22 fs-22 text-white text-lg-start text-center ">Prior to Hiring an Indian Expert PHP Developer </div>
                   ...
                   <div class="container banner-cta2 py-lg-5 py-md-5 py-3 py-2 zi-2 position-relative mt-lg-5 mt-md-5 mt-5 mb-5">
                     <div class="row align-items-center mx-lg-2 mx-md-2 mx-0">
                        <div class="row align-items-center">
                           <div class="col-lg-8 col-md-8 col-12 fw-600 fs-md-25 fs-lg-25 fs-20 text-white fw-900 text-md-center text-center">Want to hire dedicated Php developer for your project?</div>
                           ...
                           <div class="col-lg-4 col-md-12 col-12 d-flex justify-content-lg-center justify-content-md-center justify-content-center py-2">
                               <a href="{{asset('/hire-php-developers.php#contactWithUss')}}" class="btn expert-btn fs-lg-16 fs-md-16 fs-14 fw-bold py-3 px-md-4 px-4 bg-white">
