                ...
                <div class="col-lg-12 col-md-12 col-12 useradmin pt-0 pt-lg-0 pt-md-0 mb-lg-4 d-flex justify-content-center mx-auto p-0">  
                     <ul class="nav nav-tabs border-0">
                           ...
                           <li class="nav-item">
                            ...
                            <li class="nav-item">
                              <a class="nav-link btn text-dark fs-lg-19 fs-md-16 fs-13 fw-bold my-3 py-2 mx-2 pe-lg-4 pe-md-4 pe-2 ps-lg-4 ps-md-4 ps-2" data-bs-toggle="tab" href="#menu3">Additional</a>
                           </li>
                     </ul>
                 </div>
                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                           <div class="col-lg-12 col-md-12 col-9 fw-600 fs-md-18 fs-lg-28 fs-17 text-dark fw-900 text-md-start">Your Key to Launch an Enticing Doctor Appointment App is Here.</div>
                            <div class="col-lg-12 col-md-12 col-sm-12 col-9 d-flex justify-content-lg-start justify-content-md-start justify-content-start py-2">
                               <a href="{{asset('/fitness-app-development.php#contactWithUss')}}" class="btn expert-btn fs-lg-17 fs-md-14 fs-14 fw-bold py-3 px-md-4 px-4 text-white">
                     ...
                     <div class="container py-lg-4 py-2 zi-2 position-relatbive p-0">
                           <div class="row mx-0">
                              ...
                              <div class="col-12 heading fs-md-14 fs-12 center text-dark">
                                 ...
                                 <div class="col-lg-10 col-md-12 col-12 mt-2 fw-bold fs-lg-16 fs-md-16 fs-sm-17 fs-16 text-lg-center text-center mx-auto"> We provide a cohesive solution by incorporating all the features and tools to make
                                       ...
                                       <div class="development_services_boxss w-100 border border-1 h-100">
                                          <div class="row align-items-center">
                                            <div class="col-lg-3 col-md-3 col-12 text-center mb-lg-0 mb-md-0 mb-2 ">
                                             ...
                                             <div class="col-lg-9 col-md-9 col-12 text-balck fs-lg-18 fs-md-14 fs-16 lh-normal fw-900 p-0 text-left" style="--tz:30px;">Video Tutorials</div>
                                          </div>
                                 ...
                                 <div class="col-lg-4 col-md-6 col-12 mb-md-4 mb-4">
                                       <div class="development_services_boxss w-100 border border-1 h-100">
                                          ...
                                          <img class="w-lg-70 w-md-20 w-sm-15 w-20 position-relative" src="{{GETFOLDERPATH()}}/tracking-analytics.webp" alt="Tracking and Analytics">
                                             ...
                                             <div class="col-lg-9 col-md-9 col-12 text-balck fs-lg-18 fs-md-14 fs-16 lh-normal fw-900 p-0 text-left" style="--tz:30px;">Tracking and Analytics</div>
                                          </div>
                                 ...
                                 <div class="col-lg-4 col-md-6 col-12 mb-md-4 mb-4">
                                       <div class="development_services_boxss w-100 border border-1 h-100">
                                          ...
                                          <img class="w-lg-70 w-md-20 w-sm-15 w-20 position-relative" src="{{GETFOLDERPATH()}}/wearable-Integration.webp" alt="Wearable Device Integration">
                                             ...
                                             <div class="col-lg-9 col-md-9 col-12 text-balck fs-lg-18 fs-md-14 fs-16 lh-normal fw-900 p-0 text-left" style="--tz:30px;">Wearable Device Integration</div>
                                          </div>
                                 ...
                                 <div class="col-lg-4 col-md-6 col-12 mb-md-4 mb-4">
                                       <div class="development_services_boxss w-100 border border-1 h-100">
                                          ...
                                          <img class="w-lg-70 w-md-20 w-sm-15 w-20 position-relative" src="{{GETFOLDERPATH()}}/notifications.webp" alt="Notifications">
                                             ...
                                             <div class="col-lg-9 col-md-9 col-12 text-balck fs-lg-18 fs-md-14 fs-16 lh-normal fw-900 p-0 text-left" style="--tz:30px;">Notifications</div>
                                          </div>
                                 ...
                                 <div class="col-lg-4 col-md-6 col-12 mb-md-4 mb-4">
                                       <div class="development_services_boxss w-100 border border-1 h-100">
                                          ...
                                          <img class="w-lg-70 w-md-20 w-sm-15 w-20 position-relative" src="{{GETFOLDERPATH()}}/customisation.webp" alt="Customization">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-12 text-balck fs-lg-18 fs-md-14 fs-16 lh-normal fw-900 p-0 text-left" style="--tz:30px;">Customization</div>
                                          </div>
                                       <div class="col-12 fw-600 fs-lg-16 fs-md-15 fs-15 text-muted mt-lg-3 mt-md-2 tz" style="--tz:30px;">Allow users to customise their experience by setting workout preferences, 
                                 ...
                                 <div class="col-lg-4 col-md-6 col-12 mb-md-4 mb-4">
                                       <div class="development_services_boxss w-100 border border-1 h-100">
                                          ...
                                          <img class="w-lg-70 w-md-20 w-sm-15 w-20 position-relative" src="{{GETFOLDERPATH()}}/supoort.webp" alt="Support">
                                                ...
                                                <div class="col-lg-9 col-md-9 col-12 text-balck fs-lg-18 fs-md-14 fs-16 lh-normal fw-900 p-0 text-left" style="--tz:30px;">Support</div>
                     ...
                     <div id="menu23" class="container tab-pane fade p-0">
                        <div class="row align-items-center justify-content-center">
                           ...
                           <img class="w-md-80 w-80 position-relative border border-3 p-2" src="{{GETFOLDERPATH()}}/count-calories.webp" alt="Count Calories">
                              ...
                              <div class="col-12 fw-600 fs-lg-17 fs-md-16 fs-16 text-muted mt-lg-2 mt-md-2 tz" style="--tz:30px;">The app will track your steps and burned calories so users can monitor their daily weight loss journey. Additionally, the app can also provide personalised meal plans and nutrition tips to help users achieve their weight loss goals effectively. 
                       ...
                       <div id="menu24" class="container tab-pane fade p-0">
                        <div class="row align-items-center justify-content-center">
                            ...
                            <img class="w-md-80 w-80 position-relative border border-3 p-2" src="{{GETFOLDERPATH()}}/help-experts.webp" alt="Help you connect with Experts">
                              ...
                              <div class="col-12 fw-600 fs-lg-17 fs-md-16 fs-16 text-muted mt-lg-2 mt-md-2 tz" style="--tz:30px;">Users can virtually connect with the experts and subscribe to a monthly plan for their fitness.
